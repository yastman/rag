...
COLLECTION_NAME = "contextual_bulgaria_voyage4"  ***REMOVED*** Production collection!
ID_OFFSET = 900000  ***REMOVED*** Start IDs from 900000 to avoid conflicts
        ...
        points.append(
            PointStruct(
                ...
                payload={
                    ...
                    "is_test_data": True,  ***REMOVED*** Mark as test data for easy cleanup
                },
            )
        )
