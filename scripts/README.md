...
| **Benchmarks** | `benchmark_*.py`, `benchmark/contextualized_ab.py`, `benchmark/quantization_ab.py`, `benchmark/quantization_int8_vs_binary.py`, `benchmark/search_quality.py` | A/B and throughput comparisons |
...
| **Ops** | `probe/release_health_vps.sh`, `probe/bot_health.sh`, `smoke-zoo.sh` | Deployment and health checks |
