...
```bash
COLLECTION_NAME="contextual_rag_criminal_code_v1"  ***REMOVED*** collection to backup
BACKUP_DIR="/srv/backups/qdrant"            # Where to store backups
...
# 📦 Current backups:
#    /srv/backups/qdrant/contextual_rag_20251023_030000.snapshot (1.1G)
#    /srv/backups/qdrant/contextual_rag_20251024_030000.snapshot (1.2G)
#    ...
# ✅ Backup complete!
```
...
#    Backup: /srv/backups/qdrant/contextual_rag_20251030_030000.snapshot
#
# Continue? (yes/no): yes
#
# 🔄 Starting restore...
