...
***REMOVED*** Expected spans from observability implementation
EXPECTED_SPANS = {
    "telegram-message",
    "query-router",
...
***REMOVED*** Expected scores from bot handler
EXPECTED_SCORES = {
    "semantic_cache_hit",
    "query_type",
}
...
def validate_latest_trace(
    *,
    ...
    try:
        ***REMOVED*** Query recent traces with telegram+rag tags
        ...
        ***REMOVED*** Get the most recent trace
        trace_id = traces_page.data[0].id
        trace = langfuse.api.trace.get(trace_id)

        ***REMOVED*** Extract span names and score names
