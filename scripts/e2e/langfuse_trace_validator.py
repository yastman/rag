...
def validate_latest_trace(
    ...
    ***REMOVED*** Base contract: all "real" bot messages should emit these scores.
    ***REMOVED*** This enables branch-aware validation without flakiness from cache hits.
    required_scores: set[str] = set(SCORE_NAMES)

    ***REMOVED*** Base span contract (current LangGraph node names as of 2026-02-13)
