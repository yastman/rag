...
Usage:
    ...
    python scripts/e2e/auth.py --phone +359876342100

    # Step 2: Complete auth with received code
    python scripts/e2e/auth.py --phone +359876342100 --code 12345
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--phone", required=True, help="Phone number (+359876342100)")
