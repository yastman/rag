...
REQUIRE_MINI_APP_ENDPOINT="${REQUIRE_MINI_APP_ENDPOINT:-auto}" ***REMOVED*** auto|true|false|profile
...
if [ "$REQUIRE_MINI_APP_ENDPOINT" = "true" ]; then
  ...
  ***REMOVED*** Enforce the mini app only when the effective compose config declares it.
