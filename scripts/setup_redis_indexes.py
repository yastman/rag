...
def check_query_engine(client: redis.Redis) -> bool:
    ...
    try:
        ...
        ***REMOVED*** "unknown command" means Query Engine not available
        ***REMOVED*** Other errors mean command exists but something else failed
...
Examples:
  ...
  REDIS_URL=redis://localhost:6379 python scripts/setup_redis_indexes.py
    ...
    ***REMOVED*** Check for Query Engine
