...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--public-key",
        default=os.environ.get("LANGFUSE_PUBLIC_KEY", _LANGFUSE_PUBLIC_KEY_PLACEHOLDER),
        help="Langfuse public key (default: $LANGFUSE_PUBLIC_KEY or dev placeholder)",
    )
    parser.add_argument(
        "--secret-key",
        default=os.environ.get("LANGFUSE_SECRET_KEY", _LANGFUSE_SECRET_KEY_PLACEHOLDER),
        help="Langfuse secret key (default: $LANGFUSE_SECRET_KEY or dev placeholder)",
    )
    parser.add_argument(
        "--lookback-minutes",
        type=int,
