#!/usr/bin/env python3
"""Canonical OpenCode worker route models for tmux swarm helpers."""
...
CANONICAL_WORKER_ROUTES = {
    "implementation": ("kiro_default", DEFAULT_WORKER_MODEL),
    "plan-execution": ("kiro_default", DEFAULT_WORKER_MODEL),
    "quick": ("kiro_default", DEFAULT_WORKER_MODEL),
    "local-verification": ("kiro_default", DEFAULT_WORKER_MODEL),
    "pr-review": ("kiro_default", DEFAULT_WORKER_MODEL),
    "review-fix": ("kiro_default", DEFAULT_WORKER_MODEL),
}
