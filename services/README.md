...
***REMOVED******REMOVED******REMOVED*** `bge-m3-api/` — Multi-Vector Embedding Service
...
***REMOVED******REMOVED******REMOVED*** `docling/` — Document Parsing Service
...
***REMOVED******REMOVED******REMOVED*** `user-base/` — Russian Dense Embedding Service
...
***REMOVED******REMOVED*** Validation Boundaries

These containers are safe to validate independently:

```bash
***REMOVED*** Build and health-check a single service
