...
async def main():
    ...
    ***REMOVED*** Test 1: Create collection with new config
    ...
    ***REMOVED*** Test 2: Get collection info
    ...
    ***REMOVED*** Test 3: Verify configuration via API
    print("Step 3: Checking configuration via Qdrant API...")
    import requests

    ***REMOVED*** Run blocking HTTP call in executor to avoid blocking event loop
    loop = asyncio.get_event_loop()
    response = await loop.run_in_executor(
        None,
        lambda: requests.get(  ***REMOVED*** noqa: ASYNC210
