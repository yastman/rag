...
***REMOVED******REMOVED*** Project At A Glance
...
***REMOVED******REMOVED*** First Pass For New Sessions
...
***REMOVED******REMOVED*** Instruction Priority
...
***REMOVED******REMOVED*** Workflow Reality
...
***REMOVED******REMOVED*** MCP Priority And Fallbacks
...
***REMOVED******REMOVED*** SDK And Docs Lookup Order
...
***REMOVED******REMOVED*** Documentation Entry Points
...
***REMOVED******REMOVED*** Runtime And Compose Contract
...
***REMOVED******REMOVED*** Test Writing Instruction
...
***REMOVED******REMOVED*** Engineering Heuristics
...
***REMOVED******REMOVED*** Fast Start Commands
- `uv sync`
- `make local-up`
- `make run-bot`
- `make check`
