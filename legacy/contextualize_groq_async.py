...
class ContextualRetrievalGroqAsync:
    ...
    def __init__(
        ...
        model: str = "llama-3.1-8b-instant",  ***REMOVED*** Default: fast and cheap
        max_tokens: int = 1500,
        ...
        ***REMOVED*** Groq endpoint (OpenAI-compatible)
        ...
        ***REMOVED*** Pricing (per 1M tokens) - as of 2025-10-22
        self.pricing = {
            ***REMOVED*** Budget tier
