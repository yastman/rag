...
class ContextualRetrievalZAI:
    ...
    def __init__(
        ...
        ***REMOVED*** For GLM Coding Plan subscribers, use the coding endpoint
    ...
    def situate_context_with_metadata(
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                ***REMOVED*** Prepare Z.AI API request (OpenAI-compatible format)
                payload = {
                    "model": self.model,
                    "messages": [
                        {
                    ...
                    ***REMOVED*** Disable thinking mode for direct output
                ...
                ***REMOVED*** Track token usage (if provided)
                if "usage" in result:
                    usage = result["usage"]
                ...
                ***REMOVED*** GLM-4.6 может возвращать ответ в reasoning_content или content
                message = result["choices"][0]["message"]
                response_text = message.get("reasoning_content") or message.get("content", "")

                if not response_text:
                    ***REMOVED*** If both fields are empty - fallback
    ...
    def print_stats(self):
        ...
        ***REMOVED*** Estimate cost (Z.AI pricing: ~$3/month for unlimited GLM-4.6)
...
if __name__ == "__main__":
    ...
    if not os.getenv("ZAI_API_KEY"):
        ...
        print("  export ZAI_API_KEY=[REDACTED-ZAI-KEY]
        sys.exit(1)
