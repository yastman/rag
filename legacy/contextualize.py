...
class ContextualRetrieval:
    ...
    def situate_context_with_metadata(
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                ***REMOVED*** Call Claude API with prompt caching (anthropic 0.71.0+)
                ...
                ***REMOVED*** Rate limiting
                ...
                if attempt == self.max_retries - 1:
                    ***REMOVED*** Last attempt failed - return fallback
        ...
        ***REMOVED*** Should never reach here, but just in case
        return self._fallback_extraction(chunk_text)
    ...
    def _clean_json(self, json_str: str) -> str:
        ...
        ***REMOVED*** Remove comments (sometimes Claude adds them despite instructions)
        json_str = re.sub(r"//.*?\n", "\n", json_str)
        json_str = re.sub(r"/\*.*?\*/", "", json_str, flags=re.DOTALL)

        ***REMOVED*** Remove trailing commas before closing braces/brackets
    ...
    def _validate_metadata(self, metadata: dict) -> dict:
        ...
        ***REMOVED*** Ensure related_articles is a list
        if not isinstance(result["related_articles"], list):
            result["related_articles"] = []

        ***REMOVED*** Ensure numbers are integers (not strings)
    ...
    def get_stats(self) -> dict:
        ...
        ***REMOVED*** Calculate cache efficiency
    ...
    def print_stats(self):
        ...
        ***REMOVED*** Estimate cost
        if stats["total_calls"] > 0:
            ***REMOVED*** Claude Haiku pricing (as of 2024):
            ***REMOVED*** Input: $0.25/M tokens, Cached input: $0.03/M tokens, Output: $1.25/M tokens
            input_cost = (
            ...
            ***REMOVED*** Calculate savings from caching
...
if __name__ == "__main__":
    ...
    ***REMOVED*** Check for API key
    if not os.getenv("ANTHROPIC_API_KEY"):
        ...
        print("  export ANTHROPIC_API_KEY=[REDACTED-ANTHROPIC-KEY]
        sys.exit(1)

    ***REMOVED*** Initialize
    contextualizer = ContextualRetrieval()

    ***REMOVED*** Test with sample text
