...
def create_enhanced_collection(collection_name: str = None):
    ...
    ***REMOVED*** Use default collection if not specified
    if collection_name is None:
        collection_name = DEFAULT_COLLECTION

    ***REMOVED*** Collection configuration with quantization
    config = {
        "vectors": {
            "dense": {
            ...
            "colbert": {
                ...
                ***REMOVED*** ColBERT used only for reranking, not as first-stage search
                "hnsw_config": {
                    "m": 0  ***REMOVED*** Disables HNSW graph, saves memory & indexing time
                },
            },
        },
    ...
    ***REMOVED*** Delete if exists
    try:
        ...
        pass  ***REMOVED*** Collection doesn't exist, that's fine
