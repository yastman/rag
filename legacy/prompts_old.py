...
***REMOVED*** Ukrainian Legal Document Context Prompt
...
***REMOVED*** Ukrainian Legal Chunk Contextualization Prompt
...
***REMOVED*** Alternative: More structured prompt (can experiment with this)
...
***REMOVED*** ENHANCED: Context + Metadata + Relationships extraction (ONE API call)
...
***REMOVED*** System prompt for Claude (optional, for better instruction following)
...
***REMOVED*** Helper function to format prompts
...
if __name__ == "__main__":
    ***REMOVED*** Test prompt formatting
