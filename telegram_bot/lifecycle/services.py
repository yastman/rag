...
def build_services(config: BotConfig) -> Services:
    ...
    from .services.apartment.apartments_service import ApartmentsService
    ...
    from .services.apartment.apartment_extraction_pipeline import ApartmentExtractionPipeline
    from .services.apartment.apartment_filter_extractor import ApartmentFilterExtractor

    _apt_llm = None
    try:
        from .services.apartment.apartment_llm_extractor import ApartmentLlmExtractor
