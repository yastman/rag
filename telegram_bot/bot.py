...
class PropertyBot:
    ...
    async def handle_query(self, message: Message):
        ...
        ***REMOVED*** --- Supervisor path (***REMOVED***240) ---
        ...
        with propagate_attributes(
            ...
            ***REMOVED*** Wall-time for accurate latency_total_ms
            ...
            ***REMOVED*** Update trace with input/output and metadata
            lf = get_client()
            ...
            ***REMOVED*** Write Langfuse scores (14 + latency + response length ***REMOVED***129)
            _write_langfuse_scores(lf, result)

            ***REMOVED*** Online LLM-as-a-Judge sampling
            if (
    ...
    async def _handle_query_supervisor(self, message: Message, pipeline_start: float) -> None:
        """Handle query via supervisor graph (feature flag: USE_SUPERVISOR=true, ***REMOVED***240)."""
        ...
        ***REMOVED*** Build supervisor tools
        tools = [
            create_rag_agent(
                cache=self._cache,
                embeddings=self._embeddings,
        ...
        ***REMOVED*** Update keyboard to confirmation
        ...
        try:
            ...
            if msg is not None and hasattr(msg, "edit_reply_markup"):
                ...
                asyncio.create_task(  ***REMOVED*** noqa: RUF006
