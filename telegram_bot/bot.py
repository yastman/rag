    ...
    ***REMOVED*** Mapping callback_data -> query text for RAG pipeline
    ...
    async def _ainvoke_supervisor_with_recovery(
        ...
        *,
        ...
        forward LLM tokens via sendMessageDraft for real-time delivery (***REMOVED***952).
        ...
        ***REMOVED*** --- Streaming path: forward tokens via sendMessageDraft (***REMOVED***952) ---
        if message is not None and getattr(self.config, "streaming_enabled", False):
            try:
                ...
                ***REMOVED*** fall through to ainvoke path below
        ...
        *,
        ...
        async for event in agent.astream(
            ...
            if mode == "messages":
                ...
                ***REMOVED*** Skip tool-call decisions (content empty or tool_calls present)
