...
class PropertyBot:
    ...
    async def cmd_clear(
        ...
        ***REMOVED*** ***REMOVED***1454: drop any active aiogram-dialog stack BEFORE clearing FSM, so
        ***REMOVED*** the dialog framework can clean up its own state correctly. Without
        ***REMOVED*** this the user remained in DemoSG.search after /clear and the next
        ***REMOVED*** free-text message was handled by demo-search instead of telegram-rag.
