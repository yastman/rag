...
class PropertyBot:
    ...
    async def handle_menu_button(
        ...
        ***REMOVED*** Catalog browsing is handled by catalog_router (StateFilter-based)
    ...
    ***REMOVED*** Mapping callback_data -> query text for RAG pipeline
    ...
    async def start(self):
        ...
        ***REMOVED*** Catalog browsing router — SDK StateFilter-based, intercepts text
        ***REMOVED*** in CatalogBrowsingSG.browsing state. Registered BEFORE catch-all.
