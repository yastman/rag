...
class PropertyBot:
    ...
    def __init__(self, config: BotConfig):
        ...
        ***REMOVED*** CESC: User context and personalization
...
"""
    ...
    async def handle_query(self, message: Message):
        ...
        ***REMOVED*** CESC: Update user context (extracts preferences every 3rd query)
        ...
        ***REMOVED*** Uses langcache-embed-v1 (256-dim) for fast cache matching
        ...
        if cached_answer:
            ***REMOVED*** CESC: Personalize if user has preferences
