    ...
    async def handle_query(self, message: Message):
        ...
        ***REMOVED*** Scores accumulator - defaults are "miss" / "not applied"
        ...
        try:
            ...
            ***REMOVED*** 5. Get conversation history for context-aware responses
            ...
            ***REMOVED*** 6. Generate answer with LLM STREAMING
            ...
            ***REMOVED*** 7. Store assistant answer in conversation
            await self.cache_service.store_conversation_message(user_id, "assistant", answer)

            ***REMOVED*** 8. Store in semantic cache for future queries
