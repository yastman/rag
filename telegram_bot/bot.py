...
class PropertyBot:
    ...
    async def _handle_manager(self, message: Message, i18n: Any = None) -> None:
        ...
        if self._forum_bridge is not None:
            ***REMOVED*** Forum Topics enabled — start qualification flow (***REMOVED***730).
            await start_qualification(message, i18n=i18n)
        else:
            ***REMOVED*** Fallback — original behavior: delegate to agent pipeline.
    ...
    async def _complete_handoff(
        ...
        ***REMOVED*** 6. Business hours message.
    ...
    async def handle_feedback(self, callback: CallbackQuery):
        """Handle feedback button callback (***REMOVED***229)."""
        ...
        ***REMOVED*** Write score to Langfuse (direct client, not context-dependent)
        try:
