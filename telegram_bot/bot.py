...
class PropertyBot:
    ...
    async def handle_menu_button(self, message: Message, state: FSMContext) -> None:
        """Route ReplyKeyboard button press to dedicated handler (***REMOVED***628)."""
    ...
    async def _handle_search(self, message: Message) -> None:
        """Start property search funnel (***REMOVED***628)."""
    ...
    async def _handle_viewing(self, message: Message, state: FSMContext) -> None:
        """Start viewing appointment flow — collect phone (***REMOVED***628)."""
    ...
    async def _handle_promotions(self, message: Message) -> None:
        """Show current promotions (***REMOVED***628)."""
    ...
    async def handle_results_callback(self, callback: CallbackQuery, state: FSMContext) -> None:
        """Handle property results callbacks (more/refine/viewing) (***REMOVED***628)."""
        data = callback.data or ""
        if data == "results:more":
            ***REMOVED*** Placeholder — будет показывать следующую порцию
            await callback.answer("Загрузка...")
        elif data == "results:refine":
            ***REMOVED*** Placeholder — возвращает в воронку
