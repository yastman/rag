...
def _write_langfuse_scores(lf: Any, result: dict) -> None:
    ...
    scores = {
        ...
        "embeddings_cache_hit": 0.0,  ***REMOVED*** Not tracked in LangGraph state
        "search_cache_hit": 0.0,  ***REMOVED*** Not tracked in LangGraph state
        "rerank_applied": 1.0 if result.get("rerank_applied") else 0.0,
        "rerank_cache_hit": 0.0,  ***REMOVED*** Not tracked in LangGraph state
        ...
        "confidence_score": 0.0,  ***REMOVED*** Not tracked in LangGraph state
        "hyde_used": 0.0,  ***REMOVED*** Not tracked in LangGraph state
    }
    ...
    async def handle_query(self, message: Message):
        ...
        ***REMOVED*** Early typing ACK — user sees "typing..." immediately
        ...
        with propagate_attributes(
            ...
            ***REMOVED*** Write all 12 Langfuse scores (guaranteed on all exit paths)
