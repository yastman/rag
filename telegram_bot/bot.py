...
"""
    ...
    async def handle_query(self, message: Message):
        ...
        ***REMOVED*** Early typing ACK — user sees "typing..." immediately
        ...
        ***REMOVED*** Scores accumulator - defaults are "miss" / "not applied"
        ...
        try:
            ...
            ***REMOVED*** Keep typing indicator alive during heavy pipeline work
        ...
        if self.config.enable_confidence_scoring:
            ...
            ***REMOVED*** Standard streaming mode
            ...
            try:
                ...
                ***REMOVED*** Empty stream fallback: if streaming yielded nothing, use sync generation
                if not answer.strip():
                    logger.warning(
