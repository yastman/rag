    ...
    def __init__(self, config: BotConfig):
        ...
        ***REMOVED*** Initialize services
        ...
        self.query_analyzer = QueryAnalyzer(
            ...
            model="gpt-4o-mini",  ***REMOVED*** Cost-efficient model for filter extraction
        )
...
"""
    ...
    async def handle_query(self, message: Message):
        ...
        ***REMOVED*** 4.5. Rerank top results with cross-encoder (+10-15% accuracy)
                ...
                ***REMOVED*** Update message every 10 chunks or when punctuation appears
                if chunk_count % 10 == 0 or chunk in ".!?\n":
                    try:
                        ...
                        ***REMOVED*** Ignore "message not modified" errors
                        pass
