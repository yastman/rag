...
class PropertyBot:
    ...
    async def _handle_viewing(self, message: Message, state: FSMContext) -> None:
        """Viewing appointment — fork: choose objects or phone (***REMOVED***628)."""
    ...
    async def _send_property_card(
        ...
        """Send a single property card with action buttons (DRY helper, ***REMOVED***705)."""
    ...
    async def handle_card_callback(self, callback: CallbackQuery, state: FSMContext) -> None:
        """Handle card action callbacks: card:viewing and card:ask (***REMOVED***705)."""
        from .handlers.phone_collector import start_phone_collection
