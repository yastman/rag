...
"""
    ...
    async def handle_query(self, message: Message):
        ...
        ***REMOVED*** CESC: Update user context (extracts preferences every Nth query)
        ...
        ***REMOVED*** Uses langcache-embed-v1 (256-dim) for fast cache matching
        ...
        if cached_answer:
            ***REMOVED*** CESC: Personalize if enabled and user has preferences
            if self.config.cesc_enabled:
        ...
        ***REMOVED*** 4. Search in Qdrant with hybrid search
        ...
        if results is None:
            ***REMOVED*** Generate sparse vector for hybrid search
            ...
            ***REMOVED*** Voyage rerank for final precision
