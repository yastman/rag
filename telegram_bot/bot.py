...
class PropertyBot:
    ...
    def __init__(self, config: BotConfig):
        ...
        ***REMOVED*** Voyage AI unified service (embeddings + reranker)
        ***REMOVED*** Asymmetric retrieval: voyage-4-large for docs, voyage-4-lite for queries
        ...
        try:
            ...
            ***REMOVED*** 4. Search in Qdrant with hybrid search
            ...
            if results is None:
                ...
                ***REMOVED*** Skip rerank for simple queries or few results
