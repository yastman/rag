...
"""
        ...
        ***REMOVED*** Scores accumulator - defaults are "miss" / "not applied"
        ...
        try:
            ...
            ***REMOVED*** 0. Query preprocessing (translit + HyDE gating)
            ...
            embed_text = query  ***REMOVED*** Default: embed the original query
            ...
            ***REMOVED*** 1. Generate embedding (with embeddings cache - Tier 1)
            ...
            ***REMOVED*** 2. Check semantic cache (Tier 1 - highest priority)
            ***REMOVED*** Uses langcache-embed-v1 (256-dim) for fast cache matching
            ...
            ***REMOVED*** 3. Analyze query with cache (Tier 2)
            ...
            ***REMOVED*** 4. Search in Qdrant with hybrid search
            ...
            if results is None:
                ***REMOVED*** Generate sparse vector with cache (2026 best practice)
                ...
                if sparse_vector is None:
                    ...
                    if sparse_vector.get("indices"):  ***REMOVED*** Only cache non-empty vectors
            ...
            ***REMOVED*** 9. Store in semantic cache for future queries
            ***REMOVED*** Uses langcache-embed-v1 (256-dim) for cache indexing
    ...
    async def start(self):
        ...
        ***REMOVED*** Preflight dependency checks
