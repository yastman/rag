"""Supervisor tools with runtime user context (***REMOVED***240).
...
def build_tools_for_role(
    *, role: str, base_tools: list[Any], manager_tools: Iterable[Any]
    ...
    """Select tools based on user role (***REMOVED***388)."""
...
def create_crm_score_sync_tool(
    *,
    ...
    """Create crm_sync_lead_score tool for supervisor (***REMOVED***384)."""
...
def create_manager_nurturing_tools(*, analytics_service: Any, nurturing_service: Any) -> list[Any]:
    """Create manager-only nurturing + analytics tools (***REMOVED***390)."""
