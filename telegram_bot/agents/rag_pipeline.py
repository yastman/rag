...
***REMOVED*** top_k=5 for reranking. Standard in literature; balances latency vs recall for reranking candidate pool.
...
async def _hybrid_retrieve(
    ...
    ***REMOVED*** Step 1: Get sparse embedding (cached or compute)
    ...
    ***REMOVED*** Step 2: Compute retrieval filters before touching the search cache.
    ...
    ***REMOVED*** Step 3: Check search cache
