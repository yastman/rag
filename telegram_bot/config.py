...
class BotConfig:
    ...
    ***REMOVED*** LLM (OpenAI compatible API - GLM-4)
    ...
    ***REMOVED*** Asymmetric retrieval: documents use large model, queries use lite model
    ...
    ***REMOVED*** Matryoshka embedding dimensions (2048, 1024, 512, 256)
    ***REMOVED*** Lower dimensions = less storage, faster search, slightly lower quality
    ...
    ***REMOVED*** Qdrant Quantization Configuration (2026 best practice)
    ***REMOVED*** Binary quantization: 40x faster, -75% RAM for dim >= 1024
    ***REMOVED*** Scalar (INT8): 4x faster, better accuracy than binary
    ***REMOVED***
    ***REMOVED*** quantization_mode: off | scalar | binary (controls collection suffix)
    ***REMOVED***   - off: Use base collection without quantization
    ***REMOVED***   - scalar: Use *_scalar collection (INT8 quantization)
    ***REMOVED***   - binary: Use *_binary collection (binary quantization, fastest)
    ...
    ***REMOVED*** Small-to-big context expansion
    small_to_big_mode: str = os.getenv("SMALL_TO_BIG_MODE", "off").lower()  ***REMOVED*** off|on|auto
    ...
    def get_collection_name(self) -> str:
        ...
        ***REMOVED*** off or any other value
        return base
