"""CRM card callback handlers for quick actions (***REMOVED***697 Task 8).
...
async def on_task_complete(
    ...
    ***REMOVED*** callback.data is guaranteed non-None by F.data.regexp filter
    assert callback.data is not None
    ***REMOVED*** callback.data format: crm:task:complete:{id}
...
async def on_note_text_received(
    ...
    try:
        ...
        logger.exception("Failed to add note for %s ***REMOVED***%d", entity_type, entity_id)
...
def create_crm_router() -> Router:
    ...
    ***REMOVED*** Immediate actions (no FSM required)
    ...
    ***REMOVED*** FSM-triggering actions
    ...
    ***REMOVED*** FSM text input handlers
