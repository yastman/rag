...
async def handle_catalog_filters(
    ...
    ***REMOVED*** Pass current filters as start_data so dialog can pre-populate dialog_data
...
***REMOVED*** --- Voice in catalog mode → transcribe + new search ---
...
***REMOVED*** --- Catch-all: treat free text as new search ---
