"""Favorite callback handlers — fav:add/remove/viewing/viewing_all (***REMOVED***628)."""
...
async def handle_favorite_callback(
    ...
    """Main entry point for fav:* callbacks — delegates to specific handlers (***REMOVED***628)."""
    data = callback.data or ""

    ***REMOVED*** Parse callback data for legacy string-based calls
    ...
    ***REMOVED*** Dispatch to specific handlers
    if action == "add":
        ***REMOVED*** Build FavoriteCB-like object for handle_fav_add
