...
class QdrantService:
    ...
    ***REMOVED*** Track: waiting for qdrant-client 1.18+ release. See ***REMOVED***590.
    ...
    async def search_with_score_boosting(
        ...
        rag_pipeline. Decision (2026-02-24, ***REMOVED***590): Keep as opt-in capability.
        ...
        See ***REMOVED***590 for full audit. Strict mode + aliases are active (see ensure_collection).
