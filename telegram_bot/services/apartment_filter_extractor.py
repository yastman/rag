...
***REMOVED*** City aliases — sorted longest-first for greedy match
_CITY_ALIASES: dict[str, str] = {
    ***REMOVED*** Солнечный берег — все падежи
