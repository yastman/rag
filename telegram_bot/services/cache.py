...
class UserBaseVectorizer(BaseVectorizer):
    ...
    ***REMOVED*** Pydantic fields (BaseVectorizer is a Pydantic model)
...
class CacheService:
    ...
    def __init__(
        ...
        rerank_cache_ttl: int = 2 * 3600,  ***REMOVED*** 2 hours (same as search)
        sparse_cache_ttl: int = 7 * 24 * 3600,  ***REMOVED*** 7 days (same as embeddings)
        distance_threshold: float = 0.15,  ***REMOVED*** cosine distance threshold (0.15 = tight, USER-base handles Russian morphology)
    ):
        ...
        ***REMOVED*** Latency tracking (2026 best practice)
        ***REMOVED*** Stores last N latencies per cache type for p50/p95 calculation
        ...
        self._max_latency_samples = 1000  ***REMOVED*** Keep last 1000 samples per type
    ...
    async def initialize(self):
        ...
        try:
            ...
            ***REMOVED*** Uses external user-base service for high-quality Russian semantic matching
            ***REMOVED*** Best-in-class STS score (74.35 on ruMTEB) for Russian morphology
            try:
            ...
            ***REMOVED*** Uses same user-base service for consistency
            try:
                user_base_url = os.getenv("USER_BASE_URL", "http://localhost:8003")
                ...
                self.message_history = SemanticMessageHistory(
                    ...
                    distance_threshold=0.15,  ***REMOVED*** Tighter threshold for conversation matching
                )
    ...
    ***REMOVED*** ========== TIER 2: Voyage Rerank Cache (2026 best practice) ==========
    ...
    async def get_cached_rerank(
        ...
        try:
            ***REMOVED*** Semantic key: use embedding hash for paraphrase matching
    ...
    ***REMOVED*** ========== TIER 2: Sparse Embeddings Cache (BM42) ==========
    ...
    ***REMOVED*** ========== Metrics ==========
    ...
    def record_latency(self, cache_type: str, latency_ms: float):
        ...
        ***REMOVED*** Keep only last N samples
