...
class KommoTokenStore:
    ...
    async def get_valid_token(self) -> str:
        ...
        ***REMOVED*** Fallback seed mode (***REMOVED***678): access token was pre-provisioned via env and
        ***REMOVED*** may not have refresh metadata. Try it as-is instead of forcing refresh.
