"""Kommo CRM async HTTP client with rate limiting (***REMOVED***389).
        ...
        *,
        ...
        for attempt in range(self._max_retries + 1):
            ...
            if response.status_code == 429 and attempt < self._max_retries:
                ***REMOVED*** Kommo returns retry_after in JSON body; fallback to header
        ...
        raise RuntimeError("Kommo request retries exhausted")  ***REMOVED*** pragma: no cover
