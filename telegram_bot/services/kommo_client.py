    ...
    async def _request(self, method: str, path: str, **kwargs: Any) -> dict:
        ...
        if response.status_code == 401:
            try:
                ...
                ***REMOVED*** Seeded long-lived tokens have no refresh_token — re-raise as HTTP error.
                response.raise_for_status()
                return {}  ***REMOVED*** unreachable, raise_for_status always throws on 401
        ...
        ***REMOVED*** Raises for 429/5xx so tenacity can retry.
        response.raise_for_status()
