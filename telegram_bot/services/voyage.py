...
class VoyageService:
    ...
    async def embed_documents(
        ...
        ***REMOVED*** Update Langfuse with input metadata
        ...
        for i in range(0, len(texts), self.BATCH_SIZE):
            ...
            ***REMOVED*** asyncio.to_thread for non-blocking async (best practice)
    ...
    async def embed_query(self, text: str) -> list[float]:
        ...
        ***REMOVED*** Update Langfuse with input metadata
        get_client().update_current_generation(
            ...
            input={"text": text[:200]},  ***REMOVED*** Truncate for logging
        )
    ...
    ***REMOVED*** Matryoshka embeddings (variable dimensions)
