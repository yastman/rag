        ...
        try:
            response = await self.client.post(
                ...
                json={
                    ...
                    "temperature": 0.0,
                    "max_tokens": 1000,  ***REMOVED*** GLM-4.7 needs more for thinking mode
                },
                headers={
            ...
            ***REMOVED*** Guard against None content (some models return null in thinking mode)
            if content is None:
                logger.warning(
            ...
            ***REMOVED*** Parse JSON with fallback
            try:
            ...
            ***REMOVED*** Guard against non-dict responses (e.g. LLM returns "null" or a list)
