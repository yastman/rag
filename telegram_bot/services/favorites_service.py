...
``lifecycle.setup_postgres``). The capability predicate lives in the
dependency-light :mod:`telegram_bot.capabilities` (UI surfaces import it
from there; this module intentionally keeps the asyncpg dependency inside
the optional construction path).
"""
