...
class ApartmentExtractionPipeline:
    ...
    async def extract(self, query: str) -> ApartmentSearchFilters:
        ...
        ***REMOVED*** LOW confidence — full LLM extraction
