...
***REMOVED*** Cache store is limited to these types; STRUCTURED excluded (MVP: stale/over-specific risk).
...
***REMOVED*** Minimum grade_confidence to allow cache store.
...
async def run_client_pipeline(
    ...
    ***REMOVED*** Cache store — apply guards: type, contextual, confidence, source presence.
