...
***REMOVED*** Display maps for human-readable filter values
...
def build_filter_options_keyboard(
    ...
    *,
    ...
    if field == "city":
        ...
        ***REMOVED*** Dynamic options loaded from service (e.g. complex names)
        any_btn = InlineKeyboardButton(
            text="✅ Любое" if current_value is None else "Любое",
        ...
        ***REMOVED*** Generic fallback (view, area, floor without dynamic data)
        rows.append(
            [
                InlineKeyboardButton(
                    text="Любое",
    ...
    ***REMOVED*** Back button always last
    rows.append(
        [
            InlineKeyboardButton(
