...
***REMOVED*** Threshold above which regex is confident enough to skip ML layer
_REGEX_SKIP_ML_THRESHOLD = 0.9

***REMOVED*** Threshold above which combined score counts as injection
...
async def guard_node(
    ...
    ***REMOVED*** --- Layer 1: Regex ---
    _detected, risk_score, pattern = detect_injection(query)

    ml_score = 0.0
    ml_latency_ms = 0.0

    ***REMOVED*** --- Layer 2: ML classifier via HTTP (opt-in) ---
    ...
    ***REMOVED*** Update pattern if ML raised the score
