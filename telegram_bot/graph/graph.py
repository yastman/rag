...
def build_graph(
    ...
    ***REMOVED*** Add nodes — wrap those that need injected deps via functools.partial
    if classifier is not None:
        workflow.add_node(
            "classify",
            functools.partial(classify_node, classifier=classifier),  ***REMOVED*** type: ignore[type-var]
        )
    else:
        workflow.add_node("classify", classify_node)  ***REMOVED*** type: ignore[type-var]
    ...
    workflow.add_node("grade", grade_node)  ***REMOVED*** type: ignore[type-var]
