...
def test_filtering():
    ...
    ***REMOVED*** Test 1: Get all points (no filter)
    ...
    ***REMOVED*** Test 2: Filter only CSV rows
    ...
    ***REMOVED*** Test 3: Complex filter (city + price range)
    ...
    ***REMOVED*** Test 4: Filter by distance to sea
