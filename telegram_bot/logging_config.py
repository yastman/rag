...
***REMOVED*** from telegram_bot.logging_config import setup_logging, StructuredLogger
***REMOVED***
***REMOVED*** ***REMOVED*** Setup at application start
***REMOVED*** setup_logging(level="INFO", json_format=True)
***REMOVED***
***REMOVED*** ***REMOVED*** Use in modules
***REMOVED*** logger = StructuredLogger(__name__)
***REMOVED*** logger.info("User query received", user_id=123, query="apartments", latency_ms=45.3)
***REMOVED***
***REMOVED*** Output:
***REMOVED*** {
***REMOVED***   "timestamp": "2025-01-06T12:34:56.789Z",
***REMOVED***   "level": "INFO",
***REMOVED***   "logger": "telegram_bot.bot",
***REMOVED***   "message": "User query received",
***REMOVED***   "user_id": 123,
***REMOVED***   "query": "apartments",
***REMOVED***   "latency_ms": 45.3
***REMOVED*** }
