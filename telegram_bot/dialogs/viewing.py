...
async def on_phone_contact_received(message: Message, widget: Any, manager: DialogManager) -> None:
    ...
    if message.contact and message.contact.phone_number:
        ...
        ***REMOVED*** Auto-confirm: submit CRM and close dialog without summary step
        try:
...
viewing_dialog = Dialog(
    ...
    ***REMOVED*** Step 3: Summary + confirm
    Window(
        Format("{summary_text}"),
