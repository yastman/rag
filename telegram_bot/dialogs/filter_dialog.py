...
async def on_apply(
    ...
    ***REMOVED*** Show confirmation with catalog keyboard so user can browse results
...
async def on_reset(
    ...
    ***REMOVED*** Reset all Radio widgets to unchecked
...
filter_dialog = Dialog(
    ...
    ***REMOVED*** City window — Radio with ✓ indicator
    Window(
    ...
    ***REMOVED*** Complex window — ScrollingGroup for dynamic list
    Window(
