...
***REMOVED*** IMPORTANT: use "any" (not "") — aiogram-dialog Select skips empty item_ids.
...
***REMOVED*** ============================================================
***REMOVED*** on_select_* handlers — store selection in dialog_data
***REMOVED*** ============================================================
...
def _filters_to_dialog_data(filters: dict[str, Any]) -> dict[str, Any]:
    ...
    if filters.get("price_eur"):
        ***REMOVED*** Reverse-lookup budget key from BUDGET_MAP
...
***REMOVED*** ============================================================
***REMOVED*** on_reset — clear all filter fields in dialog_data
***REMOVED*** ============================================================
...
async def on_reset(
    ...
    for field in FIELD_TO_FILTER_KEY:
        manager.dialog_data.pop(field, None)
    ***REMOVED*** Also clear direct filter keys
    for key in (
        "city",
        "rooms",
        "budget",
