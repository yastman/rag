"""Property search funnel dialog (aiogram-dialog) — ***REMOVED***628."""
...
***REMOVED*** --- Filter building helpers ---
...
async def get_results_data(
    ...
    **kwargs: Any,
    ...
    """Getter for results window — fetches real apartments via hybrid search (***REMOVED***628)."""
    ...
    ***REMOVED*** Resolve apartments_service and hybrid_embeddings with property_bot fallback
...
funnel_dialog = Dialog(
    ...
    ***REMOVED*** Step 4a: Floor (optional)
    Window(
        Format("{title}"),
        Column(
            Select(
