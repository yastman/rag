...
deploy-bot:  ***REMOVED******REMOVED*** Deploy all services to VPS (git push + SSH rebuild)
...
ingest-services: ***REMOVED******REMOVED*** Index services.yaml content into Qdrant (idempotent)
