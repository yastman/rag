...
test-unit: ***REMOVED******REMOVED*** Run unit tests locally in parallel (xdist worksteal)
...
eval-judge: ***REMOVED******REMOVED*** LLM-as-a-Judge: batch evaluation (24h traces)
...
eval-judge-sample: ***REMOVED******REMOVED*** LLM-as-a-Judge: 50% sample of 48h traces
...
validate-traces-fast: ***REMOVED******REMOVED*** No rebuild, just start stack + trace validation + report
