...
***REMOVED*** AI Real Estate Automation Platform
...
***REMOVED******REMOVED******REMOVED*** Cheap-First Apartment Search
...
***REMOVED******REMOVED******REMOVED*** Partial i18n
...
| **Deployment** | Docker Compose | Local Compose primary, with k3s manifests for core services |
...
├── graph/                 ***REMOVED***   LangGraph voice RAG pipeline
