...
***REMOVED*** Mock aiogram before importing bot
...
def reset_bot_module():
    ...
    ***REMOVED*** Remove cached bot module to get fresh import
...
class TestBotGetSparseVector:
    ...
    async def test_get_sparse_vector_handles_error_gracefully(self):
        ...
        with (
            ...
            ***REMOVED*** Should return empty vector, not raise
