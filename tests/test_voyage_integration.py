...
class TestVoyagePipelineIntegration:
    ...
    def test_full_search_pipeline_sync(self):
        ...
        ***REMOVED*** Reset singleton before test
        ...
        ***REMOVED*** Setup mocks
        with (
            ...
            ***REMOVED*** 1. Preprocess query
            ...
            assert analysis["rrf_weights"]["sparse"] == 0.8  ***REMOVED*** Exact query
            assert analysis["is_exact"] is True

            ***REMOVED*** 2. Embed query
            ...
            ***REMOVED*** 3. Simulate retrieval results
            retrieval_results = [
                {
    ...
    def test_singleton_shared_across_services(self):
        ...
        ***REMOVED*** Reset singleton
        ...
        with (
            ...
            ***REMOVED*** Get instances from different entry points
    ...
    def test_document_batching(self):
        ...
        ***REMOVED*** Reset singleton
        ...
        with (
            ...
            ***REMOVED*** Return embeddings matching the batch size dynamically
            ...
            ***REMOVED*** Create 150 documents (should trigger 2 batches: 128 + 22)
            docs = [f"document {i}" for i in range(150)]
            embeddings = service.embed_documents_sync(docs)

            ***REMOVED*** Verify embed was called twice (batched)
    ...
    def test_empty_documents_list(self):
        ...
        ***REMOVED*** Reset singleton
        ...
        with (
            ...
            ***REMOVED*** Empty list should return empty list without API call
    ...
    def test_page_content_fallback(self):
        ...
        ***REMOVED*** Reset singleton
        ...
        with (
            ...
            ***REMOVED*** Document with page_content instead of text
