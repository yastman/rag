...
class BaselineManager:
    ...
    def create_snapshot(
        ...
        ***REMOVED*** Extract latency percentiles
        llm_p50 = 0.0
        llm_p95 = 0.0
        ...
        for item in latency.get("data", []):
            ...
            break  ***REMOVED*** Take first model's metrics

        ***REMOVED*** Get operation counts
        ...
        return BaselineSnapshot(
            ...
            full_rag_latency_p95_ms=llm_p95 * 1.5,  ***REMOVED*** Estimate
