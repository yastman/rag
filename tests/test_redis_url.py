...
def test_redis_url_generation():
    ...
    ***REMOVED*** Load password from .env
    ...
    ***REMOVED*** Test URL generation logic (same as in RedisSemanticCache)
    redis_password = os.getenv("REDIS_PASSWORD", "")
    redis_host = os.getenv("REDIS_HOST", "redis")
    redis_port = os.getenv("REDIS_PORT", "6379")
    redis_db = os.getenv("REDIS_CACHE_DB", "2")

    ***REMOVED*** Verify URL would be generated correctly (same logic as RedisSemanticCache)
