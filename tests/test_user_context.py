...
***REMOVED*** Direct import to avoid __init__.py dependency chain
...
class TestUserContextService:
    ...
    def test_should_extract_on_first_query(self):
        ...
        ***REMOVED*** interaction_count will be 1 after first query
    ...
    def test_should_extract_every_third_query(self):
        ...
        ***REMOVED*** Should extract on queries 1, 4, 7, 10...
        ...
        ***REMOVED*** Should NOT extract on queries 2, 3, 5, 6, 8, 9...
    ...
    def test_generate_summary_partial(self):
        ...
        ***REMOVED*** Should not contain budget or property types
...
class TestUserContextServiceAsync:
    ...
    async def test_update_from_query_no_cache_single_query(self):
        ...
        ***REMOVED*** Without cache, only current query is in context
        assert context["interaction_count"] == 1
