...
_REQUIRED_AS_TYPE: dict[str, str] = {
    ...
    "tool-handoff": "tool",
    # CRM tools archived in #2625 — removed from taxonomy contract:
    # "tool-crm-sync-lead-score", "manager-get-funnel-analytics",
    # "manager-run-nurturing-batch", crm-get-deal, crm-get-contacts,
    # crm-create-lead, crm-update-lead, crm-upsert-contact, crm-add-note,
    # crm-create-task, crm-link-contact-to-deal, crm-search-leads,
    # crm-get-my-leads, crm-get-my-tasks, crm-update-contact
