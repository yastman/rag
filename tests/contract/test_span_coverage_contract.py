...
SENSITIVE_SPANS = [
    ...
    ***REMOVED*** Classify
    "classify-query",
    ***REMOVED*** Graph node (sensitive)
    "node-rewrite",
    ***REMOVED*** Cache (all 12)
    ...
    ***REMOVED*** USER-base service (all 2)
    "user-base-service-embed",
    "user-base-service-embed-batch",
    ***REMOVED*** Search engines (all 3)
    ...
    ***REMOVED*** Bot command/menu/callback flows
    "cmd-start",
    "cmd-clear",
    "cmd-clearcache",
    "cmd-call",
    ...
    "cb-feedback-reason",
    "cb-clearcache",
    ***REMOVED*** Dialog/handler spans with capture disabled
    ...
    ***REMOVED*** Contextualization (raw text chunks and queries)
