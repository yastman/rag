...
Safe-slice items removed in PR ***REMOVED***1541 (this PR):
...
Items DEFERRED to follow-up PRs (still on the ***REMOVED***1541 list, kept for clarity):

* Item ***REMOVED***1 ``telegram_bot/services/llm.py`` (whole file, 381 lines) —
...
* Item ***REMOVED***3 ``QdrantService.search_with_score_boosting`` (152 lines) — large
