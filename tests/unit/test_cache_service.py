...
***REMOVED*** Mark integration tests that need redisvl + live Redis
try:
...
class TestCacheServiceVectorizer:
    ...
    def _make_redisvl_mocks(self):
        ...
        ***REMOVED*** Ensure instances returned by cache classes have awaitable adisconnect
        mock_semantic = MagicMock()
        mock_semantic.adisconnect = AsyncMock()
    ...
    async def test_cache_service_uses_voyage_vectorizer_for_semantic_cache(self):
        ...
        with (
            ...
            ***REMOVED*** Verify VoyageAITextVectorizer was created
    ...
    async def test_vectorizer_model_is_voyage_multilingual_2(self):
        ...
        with (
            ...
            ***REMOVED*** Both vectorizer creations should use voyage-multilingual-2
