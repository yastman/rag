"""Unit tests for stale legacy results callbacks (***REMOVED***654)."""
...
***REMOVED*** handle_results_callback
...
***REMOVED*** create_results_callback_router
