...
# NOTE: Direct module-level handler tests for results_callbacks.py / card_callback
# were removed in #1598 when the orphaned module telegram_bot/handlers/results_callbacks.py
# was deleted. PropertyBot.handle_results_callback and PropertyBot.handle_card_callback
# (tested above) are the canonical owners of ResultsCB and card:* callbacks.
