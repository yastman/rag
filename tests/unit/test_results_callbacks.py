"""Unit tests for handle_results_callback (***REMOVED***654)."""
...
async def test_results_more_shows_next_page() -> None:
    ...
    ***REMOVED*** 3 remaining cards via answer_photo + 1 footer message via answer
