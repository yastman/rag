...
class TestCatalogMoreHandler:
    ...
    async def test_all_shown_hides_more_button(self):
        ...
        last_call = message.answer.call_args_list[-1]
        kb = last_call.kwargs.get("reply_markup")
        assert len(kb.keyboard) == 3  ***REMOVED*** filters+bookmarks, viewing+manager, menu
        button_texts = [btn.text for row in kb.keyboard for btn in row]
    ...
    async def test_no_service_does_nothing(self):
        ...
        property_bot = MagicMock(spec=[])  ***REMOVED*** no attributes
...
***REMOVED*** ============================================================
***REMOVED*** handle_catalog_filters
***REMOVED*** ============================================================
...
***REMOVED*** ============================================================
***REMOVED*** handle_catalog_bookmarks
***REMOVED*** ============================================================
...
***REMOVED*** ============================================================
***REMOVED*** handle_catalog_viewing
***REMOVED*** ============================================================
...
***REMOVED*** ============================================================
***REMOVED*** handle_catalog_manager
***REMOVED*** ============================================================
...
***REMOVED*** ============================================================
***REMOVED*** handle_catalog_more — list view mode
***REMOVED*** ============================================================
...
class TestCatalogListViewMode:
    async def test_list_mode_sends_text(self):
        ...
        ***REMOVED*** In list mode, cards are NOT sent individually
        property_bot._send_property_card.assert_not_awaited()
        ***REMOVED*** Instead, text message is sent
...
***REMOVED*** ============================================================
***REMOVED*** build_catalog_keyboard — viewing + manager buttons
***REMOVED*** ============================================================
