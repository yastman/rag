...
# NOTE: Direct module-level handler tests for service_callbacks.py / cta_callback
# were removed in #1598 when the orphaned module telegram_bot/handlers/service_callbacks.py
# was deleted. PropertyBot.handle_service_callback and PropertyBot.handle_cta_callback
# (tested above) are the canonical owners of svc:* and cta:* callbacks.
