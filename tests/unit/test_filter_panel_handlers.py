...
def test_handler_functions_exist() -> None:
    ...
    from telegram_bot.handlers.filter_panel import (  ***REMOVED*** noqa: F401
...
***REMOVED*** --- on_filter_panel_select: shows sub-menu for a filter ---
...
async def test_select_city_edits_message_with_options() -> None:
    ...
    ***REMOVED*** Should edit with some text and inline keyboard
...
***REMOVED*** --- on_filter_panel_set: updates filters in FSMContext ---
...
async def test_set_goes_back_to_panel_after_update() -> None:
    ...
    ***REMOVED*** Should edit message to show updated panel
    callback.message.edit_text.assert_called_once()


***REMOVED*** --- on_filter_panel_apply: close panel, re-search ---
...
***REMOVED*** --- on_filter_panel_reset: clears all filters ---
...
***REMOVED*** --- on_filter_panel_back: close panel ---
...
async def test_back_from_submenu_returns_to_panel() -> None:
    ...
    ***REMOVED*** Should edit message back to main panel (not delete)
    callback.message.edit_text.assert_called_once()
