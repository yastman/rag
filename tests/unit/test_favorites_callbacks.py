...
# NOTE: Direct module-level handler tests for favorites_callbacks.py
# were removed in #1598 when the orphaned module telegram_bot/handlers/favorites_callbacks.py
# was deleted. PropertyBot.handle_fav_add / handle_fav_remove / handle_fav_viewing /
# handle_fav_viewing_all / handle_favorite_callback (tested above) are the canonical
# owners of fav:* callbacks.
