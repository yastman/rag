"""Unit tests for handle_favorite_callback metadata fix (***REMOVED***655)."""
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Helpers (same pattern as test_results_callbacks.py)
***REMOVED*** ---------------------------------------------------------------------------
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Tests: fav:add with metadata
***REMOVED*** ---------------------------------------------------------------------------
...
async def test_fav_remove_deletes_and_removes_message() -> None:
    ...
    state = _make_state()  ***REMOVED*** empty = bookmarks context
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Tests: Task 4 — toggle fav via edit_reply_markup (***REMOVED***705)
***REMOVED*** ---------------------------------------------------------------------------
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Direct module-level handler tests (***REMOVED***1264)
***REMOVED*** ---------------------------------------------------------------------------
...
***REMOVED*** handle_fav_viewing_all
...
***REMOVED*** handle_favorite_callback
...
***REMOVED*** create_favorites_router
