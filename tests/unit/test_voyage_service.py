...
class TestEmbedDocuments:
    ...
    async def test_embed_documents_batching(self):
        ...
        with patch("telegram_bot.services.voyage.voyageai.Client") as mock_client:
            ...
            ***REMOVED*** Create 200 documents (should require 2 batches)
            ...
            with patch("asyncio.to_thread", new_callable=AsyncMock) as mock_to_thread:
                ...
                ***REMOVED*** Should have called to_thread twice (128 + 72 docs)
    ...
    async def test_embed_query_uses_query_model(self):
        ...
        with patch("telegram_bot.services.voyage.voyageai.Client") as mock_client:
            ...
            with patch("asyncio.to_thread", new_callable=AsyncMock) as mock_to_thread:
                ...
                ***REMOVED*** Check that to_thread was called with query model
