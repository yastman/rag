...
class TestClassifyQueryComplex:
    ...
    @pytest.mark.parametrize(
        "query",
        [
            ***REMOVED*** Note: "двухкомнатная квартира в Бургасе..." matches SIMPLE pattern
    ...
    def test_classify_room_in_complex_query_as_simple(self):
        ...
        ***REMOVED*** This is expected behavior - pattern matching is prefix-based
...
class TestGetChitchatResponse:
    ...
    def test_greeting_response_russian(self):
        ...
        ***REMOVED*** Should be one of the greeting responses
...
class TestNeedsRerank:
    ...
    def test_chitchat_with_few_results_no_rerank(self):
        ...
        ***REMOVED*** CHITCHAT is not explicitly handled by needs_rerank (skipped before reaching it)
        ***REMOVED*** But if called, it behaves like COMPLEX (only checks SIMPLE and result count)
    ...
    def test_chitchat_with_many_results_needs_rerank(self):
        ...
        """
        ***REMOVED*** This is a documentation test - CHITCHAT should be handled at routing level
