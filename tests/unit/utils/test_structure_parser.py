...
class TestRomanToInt:
    ...
    def test_invalid_roman_numeral(self):
        ...
        assert roman_to_int("XXI") is None  ***REMOVED*** Beyond defined range
...
class TestUkrainianNumberToInt:
    ...
    def test_invalid_words(self):
        ...
        assert ukrainian_number_to_int("одинадцята") is None  ***REMOVED*** 11 not in mapping
...
class TestExtractRelatedArticles:
    ...
    def test_instrumental_case_limitation(self):
        ...
        result = extract_related_articles(text)
        ***REMOVED*** This is a known limitation - instrumental case is not matched
...
class TestParseLegalStructure:
    ...
    def test_parse_article_multiline_title(self):
        ...
        ***REMOVED*** Whitespace should be normalized
...
class TestExtractContextualPrefix:
    ...
    def test_prefix_with_article_no_title(self):
        ...
        ***REMOVED*** Should not have colon if no title
        lines = prefix.split("\n")
    ...
    def test_prefix_empty_metadata(self):
        ...
        prefix = extract_contextual_prefix(metadata)
        ***REMOVED*** Should only contain document name
...
"""
    ...
    def test_whitespace_handling(self):
        ...
        ***REMOVED*** Title should have normalized whitespace
        assert "  " not in metadata["article_title"]
...
"""
        metadata = parse_legal_structure(text)
        ***REMOVED*** Should extract first chapter
...
"""
        metadata = parse_legal_structure(text)
        assert metadata["section_number"] == 3  ***REMOVED*** From Roman III
        assert metadata["chapter_number"] == 47  ***REMOVED*** Arabic
        assert metadata["article_number"] == 509  ***REMOVED*** Arabic
...
Текст статті."""
        ...
        ***REMOVED*** The parser should attempt to match this pattern
        ***REMOVED*** Based on the code, this might or might not match depending on context
