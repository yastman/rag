...
class TestLLMServiceInit:
    ...
    def test_init_custom_values(self):
        ...
        assert service.base_url == "https://custom.api.com/v1"  ***REMOVED*** Trailing slash removed
...
class TestFormatContext:
    ...
    def test_format_context_single_chunk(self):
        ...
        assert "релевантность" not in result  ***REMOVED*** RRF scores removed (***REMOVED***566)
    ...
    def test_format_context_multiple_chunks(self):
        ...
        assert "---" in result  ***REMOVED*** Separator
...
class TestGetFallbackAnswer:
    ...
    def test_fallback_limits_to_three_chunks(self):
        ...
        assert "Title 3" not in result  ***REMOVED*** Should be excluded
