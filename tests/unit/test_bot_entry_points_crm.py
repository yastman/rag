...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Test: _handle_viewing — fork keyboard
***REMOVED*** ---------------------------------------------------------------------------
...
async def test_handle_viewing_shows_fork_keyboard() -> None:
    ...
    ***REMOVED*** Check keyboard has 2 rows
    keyboard = call_kwargs[1]["reply_markup"]
    assert len(keyboard.inline_keyboard) == 2
    ***REMOVED*** Check callback_data values
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Test: viewing:phone -> start_phone_collection(service_key="viewing")
***REMOVED*** ---------------------------------------------------------------------------
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Test: viewing:choose_objects -> redirect to apartment search
***REMOVED*** ---------------------------------------------------------------------------
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Test: results:viewing -> viewing_objects built from apartment_results
***REMOVED*** ---------------------------------------------------------------------------
