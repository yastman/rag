"""Unit tests for sdk_agent streaming path — issue ***REMOVED***952.
...
***REMOVED*** --------------------------------------------------------------------------- ***REMOVED***
***REMOVED*** _astream_agent_response tests                                                ***REMOVED***
***REMOVED*** --------------------------------------------------------------------------- ***REMOVED***
...
async def test_astream_agent_response_sends_drafts():
    ...
    result = await PropertyBot._astream_agent_response(
        instance,  ***REMOVED*** type: ignore[arg-type]
        agent=mock_agent,
        payload=payload,
        config=config,
        message=message,
...
***REMOVED*** --------------------------------------------------------------------------- ***REMOVED***
***REMOVED*** _ainvoke_supervisor_with_recovery routing tests                              ***REMOVED***
***REMOVED*** --------------------------------------------------------------------------- ***REMOVED***
