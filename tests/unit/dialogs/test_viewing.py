...
***REMOVED*** --- Objects getter (empty favorites) ---
...
async def test_on_confirm_creates_crm_entities():
    ...
    ***REMOVED*** Lead name should contain the object name
    ...
    ***REMOVED*** Task text should contain the object name
...
async def test_on_confirm_sends_confirmation_with_correct_text():
    ...
    ***REMOVED*** 2. Lead title contains object name
    lead_arg = kommo.create_lead.await_args.args[0]
