...
class TestFilterDialogStructure:
    ...
    def test_filter_dialog_has_hub_window(self):
        ...
        ***REMOVED*** filter_dialog.windows is a dict: State → Window
        ***REMOVED*** State.state has format "FilterSG:hub"
...
***REMOVED*** ============================================================
***REMOVED*** Getter for individual filter windows
***REMOVED*** ============================================================
...
class TestFilterWindowGetters:
    ...
    async def test_get_budget_data_returns_options(self):
        ...
        assert "budget_options" in result
        ***REMOVED*** 5 tiers + optional "Любой" clear option
    ...
    async def test_all_getters_use_any_sentinel_not_empty_string(self):
        ...
        for key, getter in getters:
            ...
            options = result[key]
            ***REMOVED*** First option should be "Любой"/"Любое" with "any" as value
...
***REMOVED*** ============================================================
***REMOVED*** _make_select_handler — item_id="any" clears filter
***REMOVED*** ============================================================
