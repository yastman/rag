"""Tests for property search funnel dialog (***REMOVED***628)."""
...
async def test_get_results_data_any_any_returns_all():
    ...
    mock_svc.scroll_with_filters.assert_awaited_once()
    ***REMOVED*** No filters when all "any"
