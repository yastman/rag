...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** 1. Callback-flow: multi-page pagination (results:more)
***REMOVED*** ---------------------------------------------------------------------------
...
class TestMultiPagePagination:
    ...
    async def test_page2_of_12_shows_5_cards_and_has_more(self) -> None:
        ...
        assert cb.message.answer.await_count == 6  ***REMOVED*** 5 cards + 1 footer
    ...
    async def test_page3_of_12_shows_2_cards_no_more(self) -> None:
        ...
        assert cb.message.answer.await_count == 3  ***REMOVED*** 2 cards + 1 footer
...
class TestViewingPhoneCollector:
    ...
    async def test_results_viewing_passes_source_results(self) -> None:
        ...
        bot = _create_bot()
        state = _make_state()  ***REMOVED*** empty state -> no apartment_results
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** 5. Footer contract: shown/total/has_more consistency
***REMOVED*** ---------------------------------------------------------------------------
...
class TestFooterContract:
    ...
    async def test_no_duplicate_cards_edge_page(self) -> None:
        ...
        ***REMOVED*** 2 cards (prop-5, prop-6) + 1 footer = 3 calls
