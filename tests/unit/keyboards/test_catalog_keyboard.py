***REMOVED*** tests/unit/keyboards/test_catalog_keyboard.py
...
class TestBuildCatalogKeyboard:
    def test_has_6_buttons(self):
        ...
        assert len(buttons) == 6  ***REMOVED*** show_more + filters + bookmarks + viewing + manager + main_menu
    ...
    def test_all_shown_hides_more_row(self):
        ...
        assert len(kb.keyboard) == 3  ***REMOVED*** filters+bookmarks, viewing+manager, main_menu
