...
***REMOVED*** --- Task 1: Catalog button routing ---
...
def test_get_menu_button_texts_catalog_handled_by_router():
    ...
    ***REMOVED*** Catalog-specific buttons NOT in main menu texts (handled by CatalogBrowsingSG state)
...
***REMOVED*** --- Task 2: Catalog keyboard favorites ---
