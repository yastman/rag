...
***REMOVED*** Mock langfuse module before any imports
@pytest.fixture(autouse=True)
def mock_langfuse_module():
    """Mock langfuse module and its components."""

    ***REMOVED*** Configure observe to return a pass-through decorator
    ...
    ***REMOVED*** Create the mock module
    ...
    ***REMOVED*** Apply mock
    ...
    try:
        ...
        ***REMOVED*** Restore original state
...
class TestTraceSearchWithDecorator:
    ...
    def test_trace_search_basic(self, mock_langfuse_module):
        ...
        ***REMOVED*** Verify the client was called (via the returned mock)
    ...
    def test_trace_search_latency_measurement(self, mock_langfuse_module):
        ...
        def mock_search(query: str) -> list:
            time.sleep(0.01)  ***REMOVED*** 10ms simulated latency
            return []
        ...
        assert latency_ms < 100  ***REMOVED*** Should be under 100ms
...
class TestTraceSearchWithSpans:
    ...
    def test_span_creation(self, mock_langfuse_module):
        ...
        ***REMOVED*** Simulate span creation
        ...
        ***REMOVED*** Verify the span was created
    ...
    def test_evaluation_span_with_expected_article(self, mock_langfuse_module):
        ...
        ***REMOVED*** Create a mock span that tracks calls
        eval_span = MagicMock()
        ...
        ***REMOVED*** Verify correct values were computed and methods called
        assert precision_at_1 == 1.0
...
class TestMetricsCalculation:
    ...
    def test_latency_calculation(self):
        ...
        start_time = time.time()
        time.sleep(0.05)  ***REMOVED*** 50ms
        latency_ms = (time.time() - start_time) * 1000

        assert 45 < latency_ms < 100  ***REMOVED*** Allow some tolerance
...
class TestTraceTags:
    ...
    def test_search_tags(self, mock_langfuse_module):
        ...
        ***REMOVED*** Verify tags contain expected values
    ...
    def test_metadata_application(self, mock_langfuse_module):
        ...
        ***REMOVED*** Verify metadata structure
...
class TestResultExtraction:
    ...
    def test_handle_missing_payload(self):
        ...
        mock_result = MagicMock(spec=[])  ***REMOVED*** No payload attribute
...
class TestSessionAndUserTracking:
    ...
    def test_user_id_tracking(self, mock_langfuse_module):
        ...
        ***REMOVED*** Verify user_id is a non-empty string
    ...
    def test_session_id_tracking(self, mock_langfuse_module):
        ...
        ***REMOVED*** Verify session_id is a non-empty string
    ...
    def test_anonymous_user(self, mock_langfuse_module):
        ...
        ***REMOVED*** Verify anonymous user_id
    ...
    def test_optional_session_id(self, mock_langfuse_module):
        ...
        ***REMOVED*** Verify session_id can be None
