...
class TestFetchArticleTexts:
    ...
    def test_fetch_single_article(self, mock_imports):
        ...
        ***REMOVED*** Simulate fetch_article_texts behavior
        article_numbers = ["115"]
        articles = {}
...
class TestGenerateQueriesForArticle:
    ...
    async def test_generate_queries_success(self, mock_imports):
        ...
        ***REMOVED*** Create async context manager mocks
        ...
        ***REMOVED*** Simulate generate_queries_for_article logic
        article_num = "115"
...
class TestGenerateAllQueries:
    ...
    async def test_generate_all_queries_success(self, mock_imports):
        ...
        ***REMOVED*** Simulate query generation
        all_queries = []
        ...
        assert len(all_queries) == 6  ***REMOVED*** 3 queries per article * 2 articles
    ...
    async def test_generate_queries_with_errors(self, mock_imports):
        ...
        assert len(all_queries) == 2  ***REMOVED*** Only 115 and 121
        assert len(errors) == 1
...
class TestErrorHandling:
    ...
    def test_missing_json_keys(self):
        ...
        partial_json = {"direct": "query 1"}  ***REMOVED*** Missing semantic and paraphrased
