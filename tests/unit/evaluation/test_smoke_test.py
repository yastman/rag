...
class TestSmokeQueriesStandalone:
    ...
    ***REMOVED*** Define queries structure locally for testing
    SMOKE_QUERIES = [
...
class TestSLOViolationDetection:
    ...
    def test_violation_when_precision_low(self):
        ...
        violations = self._check_violations(
            avg_precision_at_1=0.85,  ***REMOVED*** Below 90%
            avg_recall_at_10=0.98,
            p95_latency=500,
            failure_rate=0.0,
        )
    ...
    def test_violation_when_recall_low(self):
        ...
        violations = self._check_violations(
            avg_precision_at_1=0.95,
            avg_recall_at_10=0.90,  ***REMOVED*** Below 95%
            p95_latency=500,
            failure_rate=0.0,
        )
    ...
    def test_violation_when_latency_high(self):
        ...
        violations = self._check_violations(
            avg_precision_at_1=0.95,
            avg_recall_at_10=0.98,
            p95_latency=1000,  ***REMOVED*** Above 800ms
            failure_rate=0.0,
        )
    ...
    def test_violation_when_failure_rate_nonzero(self):
        ...
        violations = self._check_violations(
            ...
            avg_recall_at_10=0.98,
            p95_latency=500,
            failure_rate=0.05,  ***REMOVED*** Above 0%
        )
    ...
    def test_multiple_violations(self):
        ...
        violations = self._check_violations(
            avg_precision_at_1=0.80,  ***REMOVED*** Below 90%
            avg_recall_at_10=0.85,  ***REMOVED*** Below 95%
            p95_latency=1000,  ***REMOVED*** Above 800ms
            failure_rate=0.10,  ***REMOVED*** Above 0%
        )
...
class TestLatencyPercentileCalculation:
    ...
    def test_percentile_calculation(self):
        ...
        ***REMOVED*** 100 values from 1 to 100
        latencies = list(range(1, 101))

        percentiles = self._calculate_percentiles(latencies)

        ***REMOVED*** p50 = latencies_sorted[100 // 2] = latencies_sorted[50] = 51 (1-indexed)
        assert percentiles["p50"] == 51
        ***REMOVED*** p95 = latencies_sorted[int(100 * 0.95)] = latencies_sorted[95] = 96
        assert percentiles["p95"] == 96
        ***REMOVED*** p99 = latencies_sorted[int(100 * 0.99)] = latencies_sorted[99] = 100
        assert percentiles["p99"] == 100

    def test_percentile_with_uniform_values(self):
        """Test percentile calculation with uniform values."""
        latencies = [100] * 100  ***REMOVED*** All same value
...
class TestEngineSelection:
    ...
    def test_unknown_engine_detection(self):
        ...
        assert "rrf_colbert" not in valid_engines  ***REMOVED*** Not in the smoke test list
...
class TestResultsStructure:
    ...
    def test_results_dictionary_structure(self):
        ...
        ***REMOVED*** Verify all expected keys are present
    ...
    def test_passed_flag_logic(self):
        ...
        ***REMOVED*** Passed when no violations
        violations_empty = []
        passed = len(violations_empty) == 0
        assert passed is True

        ***REMOVED*** Not passed when violations exist
