...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Helpers — import under test after path manipulation
***REMOVED*** ---------------------------------------------------------------------------
...
class TestParseServicesYaml:
    def test_returns_list_of_services(self, services_yaml_file: Path) -> None:
        ...
        ***REMOVED*** Only services WITH card_text are returned
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** Idempotency — deterministic IDs
***REMOVED*** ---------------------------------------------------------------------------
...
***REMOVED*** ---------------------------------------------------------------------------
***REMOVED*** build_points — PointStruct construction (no network calls)
***REMOVED*** ---------------------------------------------------------------------------
...
class TestBuildPoints:
    def test_build_points_returns_correct_count(self, services_yaml_file: Path) -> None:
        ...
        ***REMOVED*** Fake embeddings matching chunk count
        n = len(chunks)
        fake_embeddings = {
