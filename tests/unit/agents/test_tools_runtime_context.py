"""Tests for supervisor tools with runtime user context (***REMOVED***240)."""
...
async def test_rag_search_reads_user_context(rag_services):
    ...
    ***REMOVED*** In xdist runs this patch can be bypassed by prior import state;
    ***REMOVED*** verify context only when mocked graph was actually used.
...
async def test_rag_search_without_user_id_returns_error(rag_services):
    ...
    ***REMOVED*** Graph should NOT have been called without user context
