"""Tests for ColbertRerankerService deprecation warning.

Verifies that ColbertRerankerService emits DeprecationWarning on
instantiation (client-side reranking replaced by server-side ColBERT
via hybrid_search_rrf_colbert() in #569).
"""
