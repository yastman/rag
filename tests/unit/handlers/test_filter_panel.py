***REMOVED*** tests/unit/handlers/test_filter_panel.py
...
***REMOVED*** Helper to build callback + state mocks for handler tests
...
async def test_handle_set_recalculates_count():
    ...
    state.get_data = AsyncMock(
        return_value={
            "apartment_filters": {},
            "apartment_total": 100,  ***REMOVED*** stale
        }
    )
    state.update_data = AsyncMock()
    ...
    ***REMOVED*** Panel text should contain the live count (15), not stale (100)
...
***REMOVED*** ============================================================
***REMOVED*** Budget filter coercion
***REMOVED*** ============================================================
...
async def test_handle_set_budget_stores_price_eur():
    ...
    ***REMOVED*** Should store price_eur, not budget
...
***REMOVED*** ============================================================
***REMOVED*** All filter coercion tests
***REMOVED*** ============================================================
...
***REMOVED*** ============================================================
***REMOVED*** Handler set/clear tests for all filter types
***REMOVED*** ============================================================
...
***REMOVED*** ============================================================
***REMOVED*** select action — opens sub-menu
***REMOVED*** ============================================================
...
***REMOVED*** ============================================================
***REMOVED*** apply action — applies filters
***REMOVED*** ============================================================
...
async def test_handle_apply_reloads_results():
    ...
    ***REMOVED*** State updated with new offset
...
***REMOVED*** ============================================================
***REMOVED*** back action — returns to catalog results
***REMOVED*** ============================================================
...
***REMOVED*** ============================================================
***REMOVED*** unknown action — logs warning
***REMOVED*** ============================================================
...
***REMOVED*** ============================================================
***REMOVED*** complex filter — dynamic options from service
***REMOVED*** ============================================================
...
async def test_handle_select_complex_loads_from_service():
    ...
    ***REMOVED*** Keyboard should contain dynamic options
...
async def test_handle_select_complex_current_value_checked():
    ...
    button_texts = [btn.text for row in kb.inline_keyboard for btn in row]
    assert "✅ Premier Fort" in button_texts
    assert "Harmony Suites" in button_texts  ***REMOVED*** no checkmark
