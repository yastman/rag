...
class TestEvaluateTrajectory:
    def test_exact_match_trajectory(self, eval_module) -> None:
        example = {
            "id": 1,
...
class TestComputeMetrics:
    def test_all_metrics_pass(self, eval_module) -> None:
        results = [
            {
    ...
    def test_empty_results_metrics(self, eval_module) -> None:
