...
class TestFilterExtractorPrice:
    ...
    ***REMOVED*** Range pattern - range "от X до Y" is checked FIRST before individual patterns
    def test_price_range_pattern_order(self, extractor: FilterExtractor) -> None:
        ...
        ***REMOVED*** Range pattern is checked first, so we get both bounds
    ...
    ***REMOVED*** K suffix - regex correctly captures 'к' and _parse_number converts it
    def test_price_k_suffix_captured_by_regex(self, extractor: FilterExtractor) -> None:
        ...
        ***REMOVED*** '100к' is captured and converted to 100000
        assert result == {"price": {"lt": 100000}}
