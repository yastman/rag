...
class TestFilterExtractorDistanceToSea:
    ...
    ***REMOVED*** First line / near sea - correctly maps to distance <= 200m
    def test_distance_pervaya_liniya(self, extractor: FilterExtractor) -> None:
        ...
        ***REMOVED*** "первая линия" correctly maps to distance_to_sea <= 200m
        assert result["distance_to_sea"] == {"lte": 200}
    ...
    def test_distance_u_morya(self, extractor: FilterExtractor) -> None:
        ...
        ***REMOVED*** "у моря" correctly maps to distance_to_sea <= 200m  ***REMOVED*** noqa: RUF003
        assert result["distance_to_sea"] == {"lte": 200}
