...
def test_lead_model():
    ...
    from src.services.kommo_models import Lead
...
def test_contact_create():
    ...
    from src.services.kommo_models import ContactCreate
...
def test_contact_model():
    ...
    from src.services.kommo_models import Contact
...
def test_task_create():
    ...
    from src.services.kommo_models import TaskCreate
...
def test_note_response():
    """Note response model."""
    from src.services.kommo_models import Note
...
def test_task_with_extended_fields():
    ...
    from src.services.kommo_models import Task
...
def test_contact_update_minimal():
    ...
    from src.services.kommo_models import ContactUpdate
...
class TestKommoCustomFieldValue:
    ...
    def test_string_value_serializes_to_value_dict(self) -> None:
        from src.services.kommo_models import KommoCustomFieldValue
...
class TestKommoCustomField:
    ...
    def test_field_id_zero_is_rejected_by_helper(self) -> None:
        ...
        """
        from src.services.kommo_models import KommoCustomField
