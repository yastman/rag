...
class TestContactCreate:
    ...
    def test_contact_to_kommo_payload(self):
        ...
        ***REMOVED*** custom_fields_values should contain phone and email
...
class TestLeadCreate:
    ...
    def test_lead_to_kommo_payload(self):
        ...
        ***REMOVED*** session_id should be in custom_fields_values
        cfv = payload.get("custom_fields_values", [])
        assert len(cfv) >= 1
...
class TestTaskCreate:
    def test_task_create(self):
        ...
        assert task.task_type_id == 1  ***REMOVED*** default: follow-up
