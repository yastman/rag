...
async def test_streaming_placeholder_failure_degrades_gracefully() -> None:
    """Placeholder failure → sent_msg=None, LLM stream still runs (***REMOVED***675, ***REMOVED***683).
...
async def test_placeholder_and_stream_run_in_parallel() -> None:
    """asyncio.gather used so message.answer and llm.create start simultaneously (***REMOVED***675).
