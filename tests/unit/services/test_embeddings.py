...
***REMOVED*** =============================================================================
***REMOVED*** TestEmbeddingServiceInit
***REMOVED*** =============================================================================
...
***REMOVED*** =============================================================================
***REMOVED*** TestEmbeddingServiceEmbedQuery
***REMOVED*** =============================================================================
...
class TestEmbeddingServiceEmbedQuery:
    ...
    def service_with_mock_client(self, mock_client):
        ...
        with patch("httpx.AsyncClient", return_value=mock_client):
            service = EmbeddingService("http://localhost:8001")
        ***REMOVED*** Ensure we have our mock client regardless of any module pollution
    ...
    async def test_embed_query_returns_first_embedding_only(
        ...
        ***REMOVED*** API returns multiple embeddings but we only sent one text
        mock_response = MagicMock()
    ...
    async def test_embed_query_with_empty_text(self, service_with_mock_client, mock_client):
        ...
        ***REMOVED*** Should still make the request
        mock_client.post.assert_called_once()
        call_args = mock_client.post.call_args
...
***REMOVED*** =============================================================================
***REMOVED*** TestEmbeddingServiceClose
***REMOVED*** =============================================================================
...
class TestEmbeddingServiceClose:
    ...
    async def test_close_can_be_called_multiple_times(self):
        ...
        ***REMOVED*** Call close multiple times
        await service.close()
        await service.close()

        ***REMOVED*** aclose should be called twice
...
class TestEmbeddingServiceFlow:
    ...
    async def test_multiple_queries(self):
        ...
        ***REMOVED*** Different responses for different queries
        responses = [
            {"dense_vecs": [[0.1, 0.2]]},
            {"dense_vecs": [[0.3, 0.4]]},
            {"dense_vecs": [[0.5, 0.6]]},
