...
class TestQueryAnalyzerAnalyze:
    ...
    async def test_analyze_fallback_on_json_parse_error(
        ...
        ***REMOVED*** Should return fallback: empty filters, original query
        ...
        response_content = json.dumps(
            {
                ...
                ***REMOVED*** Missing semantic_query
            }
        )
...
class TestQueryAnalyzerFlow:
    ...
    async def test_error_recovery(self):
        ...
        ***REMOVED*** First call fails, should return fallback
