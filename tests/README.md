...
├── test_qdrant_connection.py          ***REMOVED*** connection tests
├── test_qdrant_read.py                ***REMOVED*** read operations
│
...
```bash
source /home/admin/contextual_rag/venv/bin/activate
pip install -e .
```
...
- `/home/admin/contextual_rag/README.md` - Main project guide
