...
def test_criminal_code_chunking():
    ...
    ***REMOVED*** Generate chunks
    print("⚙️  Chunking document...")
    chunks = chunker.chunk_pdf(docx_path)

    print(f"✅ Created {len(chunks)} chunks\n")

    ***REMOVED*** Test 1: Chunk count
    print("=" * 80)
    ...
    ***REMOVED*** Test 2: Article number coverage
    print("\n" + "=" * 80)
    ...
    ***REMOVED*** Test 3: Article sequence
    print("\n" + "=" * 80)
    ...
    ***REMOVED*** Actual Criminal Code may have fewer articles in some versions
    ***REMOVED*** Main check: reasonable number of unique articles found
    ...
    ***REMOVED*** Test 4: No scattered articles
    print("\n" + "=" * 80)
    ...
    for article, positions in article_positions.items():
        if len(positions) > 1:
            ...
            if max_gap > 5:  ***REMOVED*** Non-consecutive
    ...
    ***REMOVED*** Legal documents often have many short articles
    ***REMOVED*** Main check: chunks are not excessively large
    oversized = len([t for t in token_counts if t > 1000])
    if oversized < len(chunks) * 0.05:  ***REMOVED*** Less than 5% oversized
