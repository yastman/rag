...
class TestIsPersonalizedQuery:
    ...
    ***REMOVED*** Test personal markers (Russian)
    ...
    ***REMOVED*** Test personal markers (English)
    @pytest.mark.parametrize(
        "query",
        [
    ...
    ***REMOVED*** Test generic queries (no markers)
    @pytest.mark.parametrize(
        "query",
        [
            "квартиры в Бургасе",
    ...
    def test_generic_query_with_user_preferences(self):
        ...
        ***REMOVED*** Generic query but user has preferences
    ...
    def test_marker_takes_priority_over_empty_context(self):
        ...
        ***REMOVED*** Has marker but no preferences - should still trigger
    ...
    def test_partial_marker_not_matched(self):
        ...
        ***REMOVED*** "мне" shouldn't match in "именно"
        ***REMOVED*** Actually "мне" could match as a standalone word - let's use better example
        ***REMOVED*** "моя" shouldn't match in "немоям" (if such word existed)
        ***REMOVED*** Testing with actual word boundary behavior
...
class TestCESCPersonalizer:
    ...
    def test_build_prompt_with_missing_fields(self):
        ...
        assert "Бургас" in prompt
        assert "не указан" in prompt  ***REMOVED*** Default for missing budget
        assert "новый пользователь" in prompt  ***REMOVED*** Default for missing summary
