***REMOVED*** tests/integration/test_unified_ingestion_e2e.py
...
def temp_sync_dir(tmp_path):
    ...
    ***REMOVED*** Create test markdown file
    ...
    test_file.write_text("***REMOVED*** Test Document\n\nThis is test content for ingestion.")
...
class TestUnifiedPipelinePayload:
    ...
    async def test_payload_has_required_fields(
        ...
        ***REMOVED*** Create test collection with correct vector config
        ...
        ***REMOVED*** Check payload contract
        ...
        ***REMOVED*** Flat file_id for fast delete
        assert payload["file_id"] == file_id

        ***REMOVED*** Cleanup CocoIndex
...
class TestUnifiedPipelineDeleteSemantics:
    ...
    async def test_delete_removes_points(
        ...
        ***REMOVED*** Second pass - should detect deletion
        cocoindex.update_all_flows()

        ***REMOVED*** Verify points removed
