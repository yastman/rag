...
***REMOVED*** Also skip if Redis hostname (default: "redis") is not reachable
pytestmark = [
...
async def test_redis_connection():
    ...
    try:
        ***REMOVED*** Initialize cache (uses env REDIS_PASSWORD automatically)
...
async def test_cache_invalidation():
    ...
    try:
        ...
        ***REMOVED*** Version 1.0.1 (different cache keys)
...
def main():
    ...
    ***REMOVED*** Check environment
    ...
    if not redis_password:
        ...
        print("   Loading from /srv/.env...")

        ***REMOVED*** Try to load from .env
