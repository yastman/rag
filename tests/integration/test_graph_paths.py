...
async def test_path_cache_hit():
    ...
    ***REMOVED*** FAQ query — allowlisted for semantic cache (***REMOVED***163)
...
async def test_path_happy_retrieve_rerank_generate():
    ...
    ***REMOVED*** ENTITY query — allowlisted for semantic cache (***REMOVED***163)
    state = make_initial_state(
    ...
    ***REMOVED*** Semantic cache stored (allowlisted ENTITY); no legacy LIST conversation store
