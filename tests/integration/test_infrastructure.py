...
class TestQdrantInfrastructure:
    ...
    def test_collections_exist(self, qdrant_client):
        ...
        ***REMOVED*** legal_documents may not exist in all envs
        ***REMOVED*** assert "legal_documents" in names
    ...
    def test_search_sparse_works(self, qdrant_client):
        ...
        ***REMOVED*** Minimal sparse vector using NamedSparseVector
        ***REMOVED*** Note: random indices may not match any documents (returns empty)
        ...
        ***REMOVED*** The important thing is it executes without error
...
class TestRedisInfrastructure:
    ...
    async def test_query_engine_available(self, redis_client):
        ...
        try:
            ...
            assert isinstance(result, list)  ***REMOVED*** Empty list is OK
    ...
    async def test_vector_search_available(self, redis_client):
        ...
        try:
            ***REMOVED*** Create index with VECTOR field (DIM 4 for minimal test)
...
class TestMLflowInfrastructure:
    ...
    async def test_experiments_list(self):
        ...
        async with httpx.AsyncClient(timeout=5.0) as client:
            ***REMOVED*** MLflow search experiments requires POST with max_results
