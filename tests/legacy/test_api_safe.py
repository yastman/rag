...
***REMOVED*** Phase 1: Budget tier (дешёвые и быстрые)
PHASE_1_MODELS = [
    {
        "provider": "groq",
...
***REMOVED*** Phase 2: Mid tier (баланс цена/качество)
PHASE_2_MODELS = [
    {
        "provider": "groq",
...
***REMOVED*** Phase 3: Premium tier (максимальное качество)
PHASE_3_MODELS = [
    {
        "provider": "groq",
...
def print_comparison_table(all_results: list[dict]):
    ...
    ***REMOVED*** Filter successful results
    ...
    ***REMOVED*** Cost estimate for full Criminal Code (448 chunks)
    print("\n" + "=" * 100)
