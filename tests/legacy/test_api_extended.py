...
***REMOVED*** Extended test: 12 models across all tiers
EXTENDED_MODELS = [
    ***REMOVED*** === BUDGET TIER (cheap + fast) ===
    {
        "provider": "groq",
    ...
    try:
        ...
        ***REMOVED*** Calculate accuracy
        ...
        if "total_cost_usd" in stats:
            ...
            full_doc_cost = cost_per_chunk * 448  ***REMOVED*** Criminal Code
...
def print_comparison_table(all_results: list[dict]):
    ...
    ***REMOVED*** Best balance (quality/price ratio)
    balanced = max(
    ...
    ***REMOVED*** Cost comparison for full Criminal Code
    print("\n" + "=" * 100)
