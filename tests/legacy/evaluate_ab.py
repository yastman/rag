    ...
    ***REMOVED*** DCG
    ...
    for i, result in enumerate(results[:k]):
        if result["id"] in relevant_ids:
            ***REMOVED*** 1-based position
            dcg += 1.0 / (i + 1)

    ***REMOVED*** IDCG (ideal DCG)
...
def evaluate_collections(
    ...
    for idx, query_data in enumerate(queries):
        ...
        ***REMOVED*** Extract chunk IDs from ground_truth
        ...
        try:
            ...
            ***REMOVED*** Calculate metrics for each K
            for k in k_values:
                ***REMOVED*** Baseline metrics
    ...
    ***REMOVED*** Calculate averages and improvements
    ...
    ***REMOVED*** Highlight key improvement
