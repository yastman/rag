...
***REMOVED*** Test 1: DBSF fusion (what we currently use)
print("=" * 80)
    ...
    "prefetch": [
        {
            ...
            "query": {"fusion": "dbsf"},  ***REMOVED*** ← DBSF
        }
    ],
    "query": colbert,
    "using": "colbert",
...
***REMOVED*** Test 2: RRF fusion (official Qdrant method)
print("=" * 80)
