...
def main():
    ...
    ***REMOVED*** Load BGE-M3 model
    print("🤖 Loading BGE-M3 embedding model...")
    model = BGEM3FlagModel("BAAI/bge-m3", use_fp16=True)
    print("   ✓ Model loaded successfully")
    print()

    ***REMOVED*** Create search engine (uses DEFAULT_SEARCH_ENGINE from config.py)
    collection_name = "ukraine_criminal_code_zai_full"
    engine_type = DEFAULT_SEARCH_ENGINE  ***REMOVED*** "dbsf_colbert" (recommended)
    ...
    ***REMOVED*** Example searches
    ...
    for i, query in enumerate(queries, 1):
        ...
        ***REMOVED*** Search (uses DBSF+ColBERT 3-stage pipeline)
