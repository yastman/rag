***REMOVED*** Local vs Production: Чеклист готовности

---

***REMOVED******REMOVED*** Что работает локально
...
***REMOVED******REMOVED*** Чеклист для Production

***REMOVED******REMOVED******REMOVED*** Critical (блокирует деплой)
...
***REMOVED******REMOVED******REMOVED*** High (нужно для стабильности)
...
***REMOVED******REMOVED******REMOVED*** Medium (улучшает надёжность)
...
***REMOVED******REMOVED*** Различия окружений

| Аспект | Local | Production |
|--------|-------|------------|
| **Путь** | /mnt/c/.../rag-fresh | /srv/rag-fresh |
...
***REMOVED******REMOVED*** Команды деплоя
...
***REMOVED*** Перезапуск сервисов
sudo systemctl restart telegram-bot

***REMOVED*** Проверка статуса
