  ...
  "chunks": [
    {
      ...
      "text_for_embedding": "***REMOVED*** Тема чанка\n\nКонтекст\n\nТекст"
    }
  ]
}
```

***REMOVED******REMOVED******REMOVED*** Step 2: Index into Qdrant

```bash
python scripts/index_contextual.py docs/processed/[название].json --collection contextual_demo
```

***REMOVED******REMOVED******REMOVED*** Step 3: Test Search
