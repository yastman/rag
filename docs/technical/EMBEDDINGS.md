***REMOVED*** BGE-M3 Embeddings Specification
...
***REMOVED******REMOVED*** Output Types

***REMOVED******REMOVED******REMOVED*** Dense Vectors
- **Dimensions:** 1024
- **Normalized:** Yes (cosine similarity)
- **Access:** `output['dense_vecs']`

***REMOVED******REMOVED******REMOVED*** Sparse Vectors (BM42)
- **Format:** `{token_id: weight}` dict
- **Access:** `output['lexical_weights']`
- **Performance:** +9% Precision@10 vs BM25

***REMOVED******REMOVED******REMOVED*** ColBERT Multivectors
...
***REMOVED******REMOVED******REMOVED*** Generate All Three
...
dense = output['dense_vecs']        ***REMOVED*** (batch, 1024)
sparse = output['lexical_weights']  ***REMOVED*** [{token: weight}, ...]
colbert = output['colbert_vecs']    ***REMOVED*** (batch, N, 1024)
```

***REMOVED******REMOVED******REMOVED*** Similarity Scoring
...
***REMOVED******REMOVED*** Qdrant Integration
