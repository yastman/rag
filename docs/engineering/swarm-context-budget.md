***REMOVED*** Swarm Context Budget Improvements

***REMOVED******REMOVED*** Problem

The tmux/OpenCode swarm flow can waste large amounts of orchestrator context on diagnostic output that is not authoritative. In the ***REMOVED***1090 session, the biggest avoidable costs came from reading OpenCode TUI logs and process arguments that included the full worker prompt.

***REMOVED******REMOVED*** Principle
...
***REMOVED******REMOVED*** Proposed Rules
...
***REMOVED******REMOVED*** Suggested DONE JSON Requirements
...
***REMOVED******REMOVED*** Orchestrator Review Order
...
***REMOVED******REMOVED*** Prompt File Handoff
...
***REMOVED******REMOVED*** OpenCode Role Policy
...
***REMOVED******REMOVED*** Rule To Add To Swarm Skill
