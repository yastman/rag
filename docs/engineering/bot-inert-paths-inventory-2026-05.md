...
- `dead-code-audit-2026-05.md` — deleted (stale historical, ARCH-10 #2606)
- `scripts-inventory-2026-05.md` — deleted (stale historical, ARCH-10 #2606)
...
- Companion docs: `dead-code-audit-2026-05.md` (deleted),
  `scripts-inventory-2026-05.md` (delivered separately under #1997, deleted).
