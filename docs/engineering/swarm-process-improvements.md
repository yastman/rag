***REMOVED*** Swarm Deploy Process Improvements
...
***REMOVED******REMOVED******REMOVED*** CI deploy job (`ci.yml`)
...
***REMOVED******REMOVED******REMOVED*** Local deploy script (`scripts/deploy-vps.sh`)
...
***REMOVED******REMOVED******REMOVED*** Image publishing (`publish-internal-images.yml`)
