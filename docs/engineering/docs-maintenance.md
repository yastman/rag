...
| **Raw secrets / tokens / DSNs / chat IDs / phone numbers / private URLs** | Pasted `.env` line with `TELEGRAM_BOT_TOKEN=[REDACTED-TELEGRAM-TOKEN] | Redact to `<redacted>` or describe the variable name |
