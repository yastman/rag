...
|---|---|---|---|---|---|
| pipeline-exception-suppression | `tests/unit/runtime/test_assistant_pipeline.py::test_run_assistant_pipeline_propagates_exception` — asserts that exceptions raised inside `run_assistant_pipeline` propagate to the caller instead of being swallowed into an error result | [#2967](https://github.com/yastman/rag/issues/2967) | — | 2026 | 2026 |
...
| History-rewrite syntactic corruption | `make compile-python` runs compileall over every repo-tracked Python file to catch unterminated string literals and other syntactic breakage caused by secret-scrub history rewrites; `trusted-heavy.yml` Fast Tests and `nightly-heavy.yml` run it as early gates | [#2320](https://github.com/yastman/rag/issues/2320) | [#2319](https://github.com/yastman/rag/issues/2319), [#1982](https://github.com/yastman/rag/issues/1982), [#1580](https://github.com/yastman/rag/issues/1580) | 2026 | 2026 |
