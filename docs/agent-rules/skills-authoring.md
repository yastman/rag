***REMOVED*** Skills Authoring Guide
...
***REMOVED******REMOVED*** Required Skill Structure
...
***REMOVED******REMOVED*** Writing Requirements
...
***REMOVED******REMOVED*** Optimization Requirements
...
***REMOVED******REMOVED*** Common Anti-Patterns
