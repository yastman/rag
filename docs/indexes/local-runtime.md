...
|---|---|---|
| Run dev Docker stack on remote host | [`../LOCAL-DEVELOPMENT.md`](../LOCAL-DEVELOPMENT.md***REMOVED***2-start-services) | `make remote-env-sync && make remote-active-up` |
| Bootstrap local services for native bot iteration | [`../LOCAL-DEVELOPMENT.md`](../LOCAL-DEVELOPMENT.md***REMOVED***7-minimal-stack-fast-iteration) | `make local-up && make test-bot-health` |
| Run the bot natively from `.env` | [`../LOCAL-DEVELOPMENT.md`](../LOCAL-DEVELOPMENT.md***REMOVED***7-minimal-stack-fast-iteration) | `make bot` |
| Check the bot username behind the current token | [`../LOCAL-DEVELOPMENT.md`](../LOCAL-DEVELOPMENT.md***REMOVED***1-bootstrap-workspace) | `curl -s "https://api.telegram.org/bot${TELEGRAM_BOT_TOKEN}/getMe"` and inspect `.result.username` |
...
| `make bot` fails with polling lock busy | [`../LOCAL-DEVELOPMENT.md`](../LOCAL-DEVELOPMENT.md***REMOVED***8-common-issues) | Stop the Docker bot container or wait for Redis lock TTL |
| Telethon session file exists but is not authorized | [`../LOCAL-DEVELOPMENT.md`](../LOCAL-DEVELOPMENT.md***REMOVED***8-common-issues) | Refresh with `scripts.e2e.auth` |
