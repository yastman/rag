...
| `make bot` fails with polling lock busy | [`../LOCAL-DEVELOPMENT.md`](../LOCAL-DEVELOPMENT.md***REMOVED***10-common-issues) | Stop the Docker bot container or wait for Redis lock TTL |
| Telethon session file exists but is not authorized | [`../LOCAL-DEVELOPMENT.md`](../LOCAL-DEVELOPMENT.md***REMOVED***10-common-issues) | Refresh with `scripts.e2e.auth` |
