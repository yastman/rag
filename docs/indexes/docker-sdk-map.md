...
| Archived Mini App (`archive/mini_app`) | [`runtime-services.md`](runtime-services.md), [`../../archive/mini_app/README.md`](../../archive/mini_app/README.md) | Not a required/runtime SDK surface | Use only if explicitly unarchiving the Mini App | Archived FastAPI/React code is preserved, but `mini-app-api` and `mini-app-frontend` are not Compose services |
