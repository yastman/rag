...
| `redis` | [`observability-and-storage.md`](observability-and-storage.md), [`../CACHE_DEGRADATION.md`](../CACHE_DEGRADATION.md) (design), [`../TROUBLESHOOTING_CACHE.md`](../TROUBLESHOOTING_CACHE.md) (debug), [`../runbooks/REDIS_CACHE_DEGRADATION.md`](../runbooks/REDIS_CACHE_DEGRADATION.md) (incident) | `redis-py (asyncio)`, `redisvl` | `/redis/redis-py`, `/redis/redis-vl-python`; official Redis docs for server config | Cache, TTL, pub/sub, eviction, or semantic-cache rules |
