***REMOVED*** Review: статусы "выполнено" в общем плане
...
***REMOVED******REMOVED*** Findings — All Resolved
...
***REMOVED******REMOVED*** Verified As Completed
...
***REMOVED******REMOVED*** Resolved Questions
