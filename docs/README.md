...
│   ├── contextualize.py                   ***REMOVED*** Claude
│   ├── contextualize_openai_async.py      # OpenAI
│   ├── contextualize_groq_async.py        ***REMOVED***
│   └── contextualize_zai_async.py         # ✅ Z.AI (fastest, $3/mo)
│
├── utils/structure_parser.py              # Fallback parser
...
# One of the API providers:
ANTHROPIC_API_KEY=[REDACTED-ANTHROPIC-KEY]  # or
OPENAI_API_KEY=[REDACTED-OPENAI-KEY]    # or
GROQ_API_KEY=[REDACTED-GROQ-KEY]           # or
ZAI_API_KEY=[REDACTED-ZAI-KEY]                # ✅ Recommended ($3/mo)
```
...
# Z.AI: 3-5 min, $0 (within plan limits)
***REMOVED***: 2-4 min, free (with rate limits)
# OpenAI: 5-8 min, ~$5-10
# Claude: 8-12 min, ~$10-15
```
...
### Research Documents (docs/ folder, organized by categories)
