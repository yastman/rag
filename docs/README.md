...
ANTHROPIC_API_KEY=[REDACTED-ANTHROPIC-KEY]  # или
OPENAI_API_KEY=[REDACTED-OPENAI-KEY]    # или
GROQ_API_KEY=[REDACTED-GROQ-KEY]           # или
ZAI_API_KEY=[REDACTED-ZAI-KEY]                # ✅ Рекомендуется ($3/mo)
```
...
***REMOVED***: 2-4 мин, free (с лимитами)
# OpenAI: 5-8 мин, ~$5-10
