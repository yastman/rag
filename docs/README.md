...
- [`security/no-patch-dependency-alerts.md`](security/no-patch-dependency-alerts.md) — Current closeout assessment for former no-patch Dependabot alerts (ragas, diskcache).
