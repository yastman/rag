...
│   ├── contextualize_groq_async.py  # Groq async version
...
│   ├── create_collection_enhanced.py   # Qdrant collection creation
...
│
├── 📦 rag-fresh.egg-info/      # Package metadata (auto-generated)
│   ├── PKG-INFO
│   ├── SOURCES.txt
