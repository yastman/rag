***REMOVED*** Docling → Qdrant → n8n (BGE-M3) — Task Checklist (Updated 2025-10-22 06:41:41)
...
***REMOVED******REMOVED*** 0) Prerequisites and Versions
...
***REMOVED******REMOVED*** 1) Converting Documents to DoclingDocument
...
***REMOVED******REMOVED*** 2) Chunking: Hierarchical → Hybrid
...
***REMOVED******REMOVED*** 3) Serialization (Markdown/JSON/YAML) + DPK (optional)
...
***REMOVED******REMOVED*** 4) Embeddings (BGE-M3: dense + sparse + colbert/multivector)
...
***REMOVED******REMOVED*** 5) Qdrant: Collection and Loading
...
***REMOVED******REMOVED*** 6) Search Query (retrieve → rerank) + Filters
...
***REMOVED******REMOVED*** 7) n8n Orchestration and Redis Cache
...
***REMOVED******REMOVED*** 8) Contextualization and Retrieval Improvements
...
***REMOVED******REMOVED*** 9) Quality Evaluation (offline)
...
***REMOVED******REMOVED*** 10) Observability and Alerts
...
***REMOVED******REMOVED*** 11) Security and Limits
...
***REMOVED******REMOVED*** 12) Final Check (go-live checklist)
