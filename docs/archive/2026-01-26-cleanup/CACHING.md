...
redis.setex(key, 30 * 24 * 3600, json.dumps(context))  # TTL: 30 дней
```
...
cesc_extraction_frequency: int = 3  # Каждый 3-й запрос
user_context_ttl: int = 30 * 24 * 3600  # 30 дней
```
