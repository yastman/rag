...
***REMOVED******REMOVED*** 3. Hybrid RRF + ColBERT ✅
...
***REMOVED******REMOVED*** 4. DBSF + ColBERT

**Algorithm:**
```
Same as ***REMOVED***3 but with DBSF fusion instead of RRF
```
...
results = engine.search(
    query_embedding="text query",  ***REMOVED*** String for hybrid
    top_k=10,
    score_threshold=0.3
)
```
...
***REMOVED******REMOVED******REMOVED*** Prefetch Limits

```python
"limit": 100  ***REMOVED*** Default
"limit": 200  ***REMOVED*** Better recall, slower
"limit": 50   ***REMOVED*** Faster, lower recall
```

***REMOVED******REMOVED******REMOVED*** Score Thresholds

- Baseline: 0.5 (high confidence)
- Hybrid: 0.3 (recommended)
- Experimental: 0.1 (very permissive)

***REMOVED******REMOVED******REMOVED*** Quantization Oversampling

```python
"oversampling": 3.0  ***REMOVED*** Baseline only
```
