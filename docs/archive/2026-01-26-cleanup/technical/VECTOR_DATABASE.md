...
***REMOVED******REMOVED*** Collection: `legal_documents`

- Points: 1,294
- Vectors: 3,882 (dense + colbert + bm42)
- Status: Green

***REMOVED******REMOVED*** Vector Configuration
...
vectors_config = {
    "dense": VectorParams(
        ...
        on_disk=True  ***REMOVED*** Original vectors on disk
    ),
...
***REMOVED******REMOVED*** HNSW Parameters
...
***REMOVED******REMOVED*** Point Structure
...
***REMOVED******REMOVED*** Search Queries

***REMOVED******REMOVED******REMOVED*** Dense-Only
...
***REMOVED******REMOVED******REMOVED*** Hybrid RRF
...
***REMOVED******REMOVED******REMOVED*** Hybrid RRF + ColBERT
...
***REMOVED******REMOVED******REMOVED*** After (quantized)
