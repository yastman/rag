***REMOVED*** CRM Deal Lifecycle via Supervisor Tools — Design
...
telegram_bot/
  ...
  services/
    kommo_client.py            ***REMOVED***Client (async httpx, OAuth2 auto-refresh)
    kommo_models.py            # Pydantic v2 models
    kommo_tokens.py            ***REMOVED***TokenStore (Redis-backed)
...
##***REMOVED***TokenStore (Redis-backed)
