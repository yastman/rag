***REMOVED*** Developer Guide: Adding New Features
...
***REMOVED******REMOVED******REMOVED*** 2. Understand the State Contract
...
***REMOVED******REMOVED******REMOVED*** 3. Register the Node in build_graph()
...
***REMOVED******REMOVED******REMOVED*** 4. Conditional Routing
...
***REMOVED******REMOVED*** Testing New Nodes/Tools

***REMOVED******REMOVED******REMOVED*** Unit Test Pattern

```python
***REMOVED*** tests/unit/graph/test_my_node.py
import pytest
