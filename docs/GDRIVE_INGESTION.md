...
```bash
***REMOVED*** Official install script
curl https://rclone.org/install.sh | sudo bash

***REMOVED*** Or via Makefile
make rclone-install
```

***REMOVED******REMOVED******REMOVED*** 2. Setup Google Cloud Service Account
...
***REMOVED******REMOVED******REMOVED*** 3. Configure rclone
...
***REMOVED******REMOVED******REMOVED*** 4. Install cron job
...
***REMOVED******REMOVED******REMOVED*** 5. Setup Qdrant collections

```bash
make ingest-gdrive-setup
```

***REMOVED******REMOVED******REMOVED*** 6. Run ingestion
...
***REMOVED******REMOVED*** rclone Export Formats
...
***REMOVED******REMOVED*** Collection Schema
...
***REMOVED******REMOVED*** Replace Semantics
...
***REMOVED******REMOVED*** File ID Stability (Manifest)
...
```
docker/rclone/
├── rclone.conf          ***REMOVED*** rclone configuration
├── sync-drive.sh        ***REMOVED*** Sync script (→ /opt/scripts/)
├── gdrive-manifest.sh   ***REMOVED*** Manifest script (→ /opt/scripts/)
└── crontab              ***REMOVED*** Cron job (→ /etc/cron.d/)

/data/drive-sync/        ***REMOVED*** Synced files
├── .gdrive_manifest.json  ***REMOVED*** Drive file ID mapping
└── ...                    ***REMOVED*** Your documents

/var/log/
├── rclone-sync.log      ***REMOVED*** Sync logs
├── rclone-cron.log      ***REMOVED*** Cron output
└── rclone-manifest.log  ***REMOVED*** Manifest logs
```
