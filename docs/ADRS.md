***REMOVED*** Architecture Decision Records (ADRs)

Documenting significant architectural decisions.

---

***REMOVED******REMOVED*** ADR-001: TypedDict for Graph State (not Pydantic)
...
***REMOVED******REMOVED******REMOVED*** Consequences
...
***REMOVED******REMOVED*** ADR-002: RRF Fusion over Semantic Search Only
...
**Positive:**
- Handles both "2-bedroom apartment" (semantic) and "Apt ***REMOVED***123" (keyword)
...
***REMOVED******REMOVED*** ADR-003: RedisVL for Semantic Cache
...
***REMOVED******REMOVED*** ADR-004: Interrupt-based HITL Pattern
...
***REMOVED******REMOVED*** ADR-005: BGE-M3 for All Embeddings
...
***REMOVED******REMOVED*** ADR-006: LiteLLM for LLM Abstraction
