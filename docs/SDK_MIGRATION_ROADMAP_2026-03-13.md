***REMOVED*** SDK Migration Roadmap (Post-Audit)

> **Historical evidence snapshot.** This dated roadmap records SDK migration
> follow-up from March 13, 2026. Do not treat it as the active SDK source of
> truth. Current SDK/framework guidance lives in
> [`docs/engineering/sdk-registry.md`](engineering/sdk-registry.md).

**As of:** 2026-03-13

***REMOVED******REMOVED*** Phase 1: Cleanup Stale Audit Scope

- Mark already-shipped SDK items as done in issue ***REMOVED***728.
- Remove/replace stale recommendations that are now misleading.
- Keep one canonical, tracked audit snapshot in `docs/`.

***REMOVED******REMOVED*** Phase 2: High-ROI Incremental SDK Adoption
...
***REMOVED******REMOVED*** Phase 3: Bounded SDK Spikes
...
***REMOVED******REMOVED*** Phase 4: Optional Research
