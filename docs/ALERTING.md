...
***REMOVED******REMOVED******REMOVED*** 1. Create Alerting Telegram Bot
...
***REMOVED******REMOVED******REMOVED*** 2. Get Your Chat ID
...
***REMOVED******REMOVED******REMOVED*** 4. Start Monitoring Stack

```bash
***REMOVED*** Start just monitoring services
make monitoring-up

***REMOVED*** Or start full dev stack (includes monitoring)
...
***REMOVED*** Send test alert
make monitoring-test-alert
```

***REMOVED******REMOVED*** Make Targets
...
***REMOVED******REMOVED******REMOVED*** telegram-bot.yaml
...
***REMOVED******REMOVED******REMOVED*** infrastructure.yaml
...
***REMOVED******REMOVED******REMOVED*** Extended Services (extended-services.yaml)
...
***REMOVED******REMOVED*** Querying Logs

Access Loki directly for log queries:

```bash
***REMOVED*** Query recent bot errors
...
***REMOVED******REMOVED******REMOVED*** Alerts not sending
...
***REMOVED******REMOVED******REMOVED*** Promtail not scraping logs
...
***REMOVED******REMOVED******REMOVED*** Loki rules not loading (400 error)
...
***REMOVED******REMOVED******REMOVED*** No dispatch logs in Alertmanager
...
***REMOVED******REMOVED*** Customizing Alerts
