...
- ~~0003 - LangGraph voice/text split~~ — _archived; superseded by ADR-0019_
...
- ~~0010 - Voice path `create_agent` migration plan~~ — _archived; voice path is optional_
...
- ~~0017 - OpenTelemetry trace sampling roadmap~~ — _archived; OTel sampling deferred, not active_
...
Archived ADR files are under [`../archive/adr/`](../archive/adr/).
