***REMOVED*** ADR-0002: BGE-M3 as Primary Embedding Model
...
***REMOVED******REMOVED******REMOVED*** Why Self-Hosted
...
***REMOVED******REMOVED******REMOVED*** Why BGE-M3
...
```bash
BGE_M3_URL=http://bge-m3:8000  ***REMOVED*** Container URL
```
