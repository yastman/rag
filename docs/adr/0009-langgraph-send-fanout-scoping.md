# ADR-0009: LangGraph `Send` Fan-Out Adoption — Scoping

**Status:** Scoping (no production adoption yet)

**Date:** 2026-05-20

**Closes:** [#1670](https://github.com/yastman/issues/1670)
...
## Required shape when a site is migrated
...
## Forbidden during a future pilot
...
- Issue [#1670](https://github.com/yastman/rag/issues/1670) — research request.
- Issue [#1538](https://github.com/yastman/rag/issues/1538) — broader SDK-vs-custom audit; this is one concrete sub-item.
- Issue [#1671](https://github.com/yastman/rag/issues/1671) — `stream_mode="custom"` (orthogonal but composable with `Send`).
