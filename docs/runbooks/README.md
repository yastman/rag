...
|---|---|
| Recent Langfuse traces (`изучи последние трейсы`) | `make validate-traces-fast` or [Langfuse CLI](remote-macbook-docker.md***REMOVED***langfuse-cli) → [`LANGFUSE_TRACING_GAPS.md`](LANGFUSE_TRACING_GAPS.md) |
