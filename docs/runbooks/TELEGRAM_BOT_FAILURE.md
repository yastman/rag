...
If traces are stale or missing, see [`../archive/runbooks/LANGFUSE_TRACING_GAPS.md`](../archive/runbooks/LANGFUSE_TRACING_GAPS.md). Langfuse can be healthy while the bot still records `LLM failed: Connection error` spans — that points back at LiteLLM, not Langfuse.
...
- [`../archive/runbooks/LANGFUSE_TRACING_GAPS.md`](../archive/runbooks/LANGFUSE_TRACING_GAPS.md)
