***REMOVED*** Env Contract Cleanup Implementation Plan
...
***REMOVED******REMOVED******REMOVED*** Task 1: Guard the local env contract
...
***REMOVED******REMOVED******REMOVED*** Task 2: Verify the touched contract end-to-end
