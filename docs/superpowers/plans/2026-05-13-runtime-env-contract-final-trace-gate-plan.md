...
- Worktree: `/home/user/projects/rag-fresh-wt-final-runtime-verify-r2`
- Signal: `/home/user/projects/rag-fresh-wt-final-runtime-verify-r2/.signals/W-final-runtime-verify-r2.json`
...
git worktree add /home/user/projects/rag-fresh-wt-final-runtime-verify-r2 -b swarm/final-runtime-verify-r2 origin/dev
mkdir -p /home/user/projects/rag-fresh-wt-final-runtime-verify-r2/.signals /home/user/projects/rag-fresh-wt-final-runtime-verify-r2/logs
```
...
RAG_RUNTIME_ENV_FILE=/home/user/projects/rag-fresh/.env
Use `make docker-ps`, not raw `docker compose ps`.
Run: RAG_RUNTIME_ENV_FILE=/home/user/projects/rag-fresh/.env make e2e-test-traces-core
If voice fixture is absent, return blocked and do not invent audio.
If core gate passes, run: uv run --env-file /home/user/projects/rag-fresh/.env python -m scripts.e2e.langfuse_latest_trace_audit --limit 12 --output-dir .artifacts/langfuse-local-audit --sdk-only
```
...
/home/user/.codex/skills/tmux-swarm-orchestration/scripts/launch_opencode_worker.sh \
  ...
  /home/user/projects/rag-fresh-wt-final-runtime-verify-r2 \
  /home/user/projects/rag-fresh/.codex/prompts/worker-final-runtime-verify-r2.md
```
...
/home/user/.codex/skills/tmux-swarm-orchestration/scripts/validate_worker_signal.py \
  --role quick \
  --signal /home/user/projects/rag-fresh-wt-final-runtime-verify-r2/.signals/W-final-runtime-verify-r2.json \
  --launch /home/user/projects/rag-fresh-wt-final-runtime-verify-r2/.signals/launch-W-final-runtime-verify-r2.json \
...
```bash
git worktree remove /home/user/projects/rag-fresh-wt-final-runtime-verify-r2
