***REMOVED*** SDK Gate Split Implementation Plan
...
***REMOVED******REMOVED******REMOVED*** Knowledge Producer
...
***REMOVED******REMOVED******REMOVED*** Orchestration Enforcement
...
***REMOVED******REMOVED******REMOVED*** Validators And Tests
...
***REMOVED******REMOVED*** Task 1: Add Prompt Validator Tests For Baseline Classifications
...
***REMOVED******REMOVED*** Task 2: Implement Prompt Baseline Validation
...
***REMOVED******REMOVED*** Task 3: Add Signal Validator Tests For SDK Baseline Blocking
...
***REMOVED******REMOVED*** Task 4: Implement Signal Blocked Contract Validation
...
***REMOVED******REMOVED*** Task 5: Update `sdk-research` To Produce Worker-Ready Baselines
...
In `/home/USER/.codex/skills/sdk-research/SKILL.md`, replace `***REMOVED******REMOVED*** Формат рекомендации`
with:

````markdown
***REMOVED******REMOVED*** Формат рекомендации
...
Keep the existing `***REMOVED******REMOVED*** SDK Coverage` table only as optional human-readable
support after the worker-ready block.
````

- [ ] **Step 2: Update process text to mention the three classifications**

Add this under `***REMOVED******REMOVED*** Процесс`:
...
***REMOVED******REMOVED*** Task 6: Update tmux Swarm SDK Gate Contract Text
...
replace `***REMOVED******REMOVED*** SDK/Custom Decision Block` with the baseline format from the spec.
Also add:
...
Under `***REMOVED******REMOVED*** Worker Prompt Section`, add:
...
***REMOVED******REMOVED*** Task 7: Add Documentation Contract Assertions
...
***REMOVED******REMOVED*** Task 8: Run Focused Regression Checks
