***REMOVED*** Issue ***REMOVED***1080 Langfuse Connectivity Plan
...
***REMOVED******REMOVED******REMOVED*** Task 1: Reproduce and capture the real failure boundary
...
***REMOVED******REMOVED******REMOVED*** Task 2: Lock the broken contract with tests
...
***REMOVED******REMOVED******REMOVED*** Task 3: Apply the minimal compose fix
...
***REMOVED******REMOVED******REMOVED*** Task 4: Verify the actual runtime is repaired
...
- move `***REMOVED***1080` out of `Plan needed`
- switch `Next recommended task` to `***REMOVED***1081`
