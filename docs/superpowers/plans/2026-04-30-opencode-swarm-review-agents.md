***REMOVED*** OpenCode Swarm Review Agents Implementation Plan
...
***REMOVED******REMOVED*** Task 1: Add Project-Local `gh-pr-review` OpenCode Skill
...
***REMOVED******REMOVED*** Task 2: Add OpenCode Role Agents
...
***REMOVED******REMOVED*** Task 3: Make tmux Launcher Agent-Aware
...
***REMOVED******REMOVED*** Task 4: Update tmux Swarm Skill Contract
...
***REMOVED******REMOVED*** Task 5: Add Smoke Verification for the New Flow
...
***REMOVED******REMOVED*** Task 6: End-to-End Dry Run on a Real PR Without Merge
...
***REMOVED******REMOVED*** Task 7: Update Context Budget Notes
...
***REMOVED******REMOVED*** Task 8: Final Verification
