***REMOVED*** Swarm Skill Split Implementation Plan
...
- Modify or create: `/repo/.opencode/agents/secretary-flash.md`
- Modify or create: `/repo/.opencode/agents/secretary-pro.md`
  - Make secretary agents first-class and tracked.
- Modify: `/repo/.opencode/agents/pr-worker.md`
- Modify: `/repo/.opencode/agents/pr-review.md`
- Modify: `/repo/.opencode/agents/pr-review-fix.md`
- Modify: `/repo/.opencode/agents/complex-escalation.md`
  - Add explicit local-only permissions required by launcher when `SWARM_LOCAL_ONLY=1`.

***REMOVED******REMOVED*** Task 1: Create Codex Skill Skeletons
...
***REMOVED******REMOVED*** Task 2: Move Control-Plane Rules Into Focused Skills
...
***REMOVED******REMOVED*** Task 3: Convert `tmux-swarm-orchestration` Into A Router
...
***REMOVED******REMOVED*** Task 4: Add Worker-Facing Secretary Skill
...
***REMOVED******REMOVED*** Task 5: Make Secretary Agents First-Class
...
***REMOVED******REMOVED*** Task 6: Validate End-To-End Contracts Without Launching Real Work
...
***REMOVED******REMOVED*** Task 7: Commit

**Files:**
- All modified Codex skill files under `/home/USER/.codex/skills`
- Repo OpenCode files under `/repo/.opencode`
