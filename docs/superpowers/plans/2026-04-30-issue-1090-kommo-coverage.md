***REMOVED*** Issue 1090 Kommo Coverage Plan
...
Lane: `Full plan` because ***REMOVED***1090 is `lane:plan-needed`, business-critical CRM behavior, and spans request errors, OAuth token lifecycle, and lead operations.
...
***REMOVED******REMOVED******REMOVED*** Task 1: Request Error/Retry Coverage
...
***REMOVED******REMOVED******REMOVED*** Task 2: OAuth Token Edge Coverage
...
***REMOVED******REMOVED******REMOVED*** Task 3: Lead Operations And Score Sync Coverage
...
- Run `make check`.
- Create PR against `dev` with `Closes ***REMOVED***1090`.

**Done Definition:**
- Plan exists before implementation.
- Part branches have focused verification evidence.
- PR targets `dev`, links ***REMOVED***1090, and includes verification.
