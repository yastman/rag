***REMOVED*** Issue 1091 Unified Ingestion Coverage Plan
...
Lane: `Full plan` because issue ***REMOVED***1091 is `lane:plan-needed`, touches ingestion runtime contracts, and spans state manager, flow, and target connector coverage.
...
***REMOVED******REMOVED*** Repository Constraints
...
***REMOVED******REMOVED*** Worker Slices

***REMOVED******REMOVED******REMOVED*** Task 1: State Manager Transitions
...
***REMOVED******REMOVED******REMOVED*** Task 2: Flow And Manifest Wiring
...
***REMOVED******REMOVED******REMOVED*** Task 3: Target Connector State/Writer Paths
...
***REMOVED******REMOVED******REMOVED*** Task 4: Final Integration
...
- Create PR against `dev` with `Closes ***REMOVED***1091`.

**Done Definition:**
- Plan committed before implementation.
- Each part branch has focused tests and `make check` evidence in DONE JSON.
- Final PR targets `dev`, links `Closes ***REMOVED***1091`, and includes verification evidence.
