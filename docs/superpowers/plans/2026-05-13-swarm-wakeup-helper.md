...
**Files:**
- Create temporary prompt under `/home/user/projects/rag-fresh/.codex/prompts/worker-wakeup-helper-smoke.md`
- Create temporary worktree `/home/user/projects/rag-fresh-wt-wakeup-helper-smoke`
...
```bash
ORCH_MARKER="/home/user/projects/rag-fresh/.signals/orchestrator-pane.json" \
...
import json
from pathlib import Path
m=json.loads(Path('/home/user/projects/rag-fresh/.signals/orchestrator-pane.json').read_text())
...
```bash
git worktree add /home/user/projects/rag-fresh-wt-wakeup-helper-smoke -b swarm/wakeup-helper-smoke HEAD
```
...
Create `/home/user/projects/rag-fresh/.codex/prompts/worker-wakeup-helper-smoke.md`
with:
...
Expected behavior:
1. Write `/home/user/projects/rag-fresh-wt-wakeup-helper-smoke/.signals/W-wakeup-helper-smoke.json`.
...
/home/user/.codex/skills/tmux-swarm-orchestration/scripts/launch_opencode_worker.sh \
  ...
  /home/user/projects/rag-fresh-wt-wakeup-helper-smoke \
  /home/user/projects/rag-fresh/.codex/prompts/worker-wakeup-helper-smoke.md
```
...
```bash
test -f /home/user/projects/rag-fresh-wt-wakeup-helper-smoke/.signals/W-wakeup-helper-smoke.json
test -f /home/user/projects/rag-fresh-wt-wakeup-helper-smoke/.signals/wakeup-W-wakeup-helper-smoke.json
...
git worktree remove /home/user/projects/rag-fresh-wt-wakeup-helper-smoke --force
git branch -D swarm/wakeup-helper-smoke
rm -f /home/user/projects/rag-fresh/.codex/prompts/worker-wakeup-helper-smoke.md
```
