...
Add `***REMOVED******REMOVED******REMOVED*** Secretary Flash` and `***REMOVED******REMOVED******REMOVED*** Secretary Pro` sections with allowed actions, forbidden actions, and artifact outputs.
...
***REMOVED******REMOVED*** Task 6: Delegate Review, SDK, And Knowledge Gates
