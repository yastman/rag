***REMOVED*** Issue ***REMOVED***1081 Postgres Shutdown Safety Implementation Plan
...
***REMOVED******REMOVED******REMOVED*** Task 1: Lock the shutdown contract with a regression test
...
***REMOVED******REMOVED******REMOVED*** Task 2: Implement the compose fix
...
***REMOVED******REMOVED******REMOVED*** Task 3: Verify effective runtime behavior
