***REMOVED*** P0 Postgres Docker Audit Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Close `***REMOVED***1081` with fresh Postgres shutdown evidence, audit the local Docker Compose runtime, and create separate GitHub issues for newly discovered broken services.

**Architecture:** Treat `***REMOVED***1081` as a root-cause/evidence close-out, not a catch-all Docker cleanup. Keep runtime findings in a dated audit report, update only the relevant runbook/docs, and turn distinct reproducible service failures into their own GitHub issues. Use Docker Compose native env/config handling and avoid destructive volume or database operations.
...
***REMOVED******REMOVED*** Task 1: Confirm Clean Working Context And Issue State
...
- Read: GitHub issue `***REMOVED***1081`
...
***REMOVED******REMOVED*** Task 2: Verify Postgres Shutdown Contract For `***REMOVED***1081`
...
Add a `***REMOVED***1081 Postgres Evidence` section to `docs/plans/2026-04-28-docker-runtime-audit-report.md` with:
...
***REMOVED******REMOVED*** Task 3: Update Postgres Runbook
...
```markdown
***REMOVED******REMOVED*** Shutdown Safety And Local Docker Desktop Recovery
...
***REMOVED******REMOVED*** Task 4: Audit Local Docker Compose Runtime
...
***REMOVED******REMOVED*** Task 5: Create GitHub Issues For New Failures
...
***REMOVED******REMOVED*** Expected
The service should start in the documented local Compose profile, or docs should state required prerequisites.

***REMOVED******REMOVED*** Audit Source
Found during the 2026-04-28 local Docker runtime audit while closing ***REMOVED***1081.

***REMOVED******REMOVED*** Proposed Triage
...
***REMOVED******REMOVED*** Task 6: Close Or Update `***REMOVED***1081`
...
- [ ] **Step 2: Close `***REMOVED***1081` if evidence supports closure**
...
***REMOVED******REMOVED*** Task 7: Final Verification
