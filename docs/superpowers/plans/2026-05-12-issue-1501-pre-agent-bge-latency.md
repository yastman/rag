***REMOVED*** Issue 1501 Pre-Agent BGE Latency Implementation Plan
...
***REMOVED******REMOVED*** Spec And Evidence

- GitHub issue: `***REMOVED***1501` (`perf: reduce pre-agent BGE latency in client-direct RAG traces`).
...
- `litellm-acompletion` trace `fff64889-26e8-4d0b-b20e-434f0012f018` is a LiteLLM proxy callback trace, not the ***REMOVED***1501 root cause. Keep as separate follow-up unless product wants proxy traces disabled or parented.
...
***REMOVED******REMOVED*** Swarm Execution Map
...
***REMOVED******REMOVED******REMOVED*** Task 1: Add Bot Pre-Agent Deferral Regression Tests
...
***REMOVED******REMOVED******REMOVED*** Task 2: Split Bot Pre-Agent Dense Lookup From MISS Vector Preparation
...
***REMOVED******REMOVED******REMOVED*** Task 3: Add Dense Query Helper And Suppress Wrapper Span Payloads
...
***REMOVED******REMOVED******REMOVED*** Task 4: Add Separate BGE Model Processing Score
...
***REMOVED******REMOVED******REMOVED*** Task 5: Update Existing Pre-Agent Tests That Encode Old Behavior
...
Revise these existing tests because they currently encode the behavior ***REMOVED***1501 is fixing:
...
***REMOVED******REMOVED******REMOVED*** Task 6: Runtime Trace Validation
...
***REMOVED******REMOVED******REMOVED*** Task 7: Final Verification
...
***REMOVED******REMOVED*** Out Of Scope / Follow-Ups
