***REMOVED*** Swarm Skill Split Design
...
***REMOVED******REMOVED*** Control-Plane Boundary
...
***REMOVED******REMOVED*** Proposed Codex Skills

***REMOVED******REMOVED******REMOVED*** `tmux-swarm-orchestration`
...
***REMOVED******REMOVED******REMOVED*** `swarm-intake`
...
***REMOVED******REMOVED******REMOVED*** `swarm-plan`
...
***REMOVED******REMOVED******REMOVED*** `swarm-launch`
...
***REMOVED******REMOVED******REMOVED*** `swarm-acceptance`
...
***REMOVED******REMOVED******REMOVED*** `swarm-pr-review-flow`
...
***REMOVED******REMOVED******REMOVED*** `swarm-recovery`
...
***REMOVED******REMOVED*** OpenCode Worker Plane
...
***REMOVED******REMOVED******REMOVED*** Worker-Facing OpenCode Skills
...
***REMOVED******REMOVED*** Artifact Pipeline
...
***REMOVED******REMOVED*** Skill Creation Plan
