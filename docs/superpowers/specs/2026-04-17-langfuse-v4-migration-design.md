***REMOVED*** Langfuse V4 Migration Design

***REMOVED******REMOVED*** Context

Issue `***REMOVED***1174` tracks a blocked dependency upgrade: the repository intentionally held `langfuse` at `3.14.6` because the current codebase still depends on v3-only tracing APIs.

This repository is not a single application. Langfuse spans several runtime surfaces:

- Telegram bot request handling and pipelines in `/repo/telegram_bot/`;
- FastAPI request handling in `/repo/src/api/`;
- voice lifecycle tracing in `/repo/src/voice/`;
- ingestion lifecycle tracing in `/repo/src/ingestion/unified/`;
- evaluation and developer-facing observability helpers in `/repo/src/evaluation/`.
...
- Re-run the validation set for issue `***REMOVED***1174`, plus repo-wide checks appropriate for a cross-system dependency migration.
...
***REMOVED******REMOVED******REMOVED*** Blocking v3 Patterns
...
***REMOVED******REMOVED******REMOVED*** Primary Runtime Surfaces

The migration affects at least these areas:

- `/repo/telegram_bot/observability.py`
- `/repo/telegram_bot/bot.py`
- `/repo/telegram_bot/middlewares/langfuse_middleware.py`
- `/repo/telegram_bot/pipelines/client.py`
- `/repo/src/api/main.py`
- `/repo/src/voice/observability.py`
- `/repo/src/ingestion/unified/observability.py`
- `/repo/src/evaluation/langfuse_integration.py`
...
***REMOVED******REMOVED******REMOVED*** Main Migration Constraint

The repo already has a useful observability entrypoint in `/repo/telegram_bot/observability.py`. That file should remain the common initialization and safe-export location for the SDK, but it must not become a custom shim that redefines v4 in v3 terms.
...
***REMOVED******REMOVED*** Target V4 Model

***REMOVED******REMOVED******REMOVED*** Core Rule
...
***REMOVED******REMOVED******REMOVED*** Trace and Observation Semantics
...
***REMOVED******REMOVED******REMOVED*** Root Observation Ownership
...
***REMOVED******REMOVED*** Migration Pattern Mapping

***REMOVED******REMOVED******REMOVED*** Pattern A: `update_current_trace(...)`
...
***REMOVED******REMOVED******REMOVED*** Pattern B: `start_as_current_span(...)`
...
***REMOVED******REMOVED******REMOVED*** Pattern C: `CallbackHandler(update_trace=...)`
...
***REMOVED******REMOVED******REMOVED*** Pattern D: Tests Coupled To Old APIs
...
***REMOVED******REMOVED******REMOVED*** `/repo/telegram_bot/observability.py`
...
***REMOVED******REMOVED******REMOVED*** `/repo/telegram_bot/bot.py`
...
***REMOVED******REMOVED******REMOVED*** `/repo/telegram_bot/middlewares/langfuse_middleware.py`
...
***REMOVED******REMOVED******REMOVED*** `/repo/telegram_bot/pipelines/client.py`
...
***REMOVED******REMOVED******REMOVED*** `/repo/src/api/main.py`
...
***REMOVED******REMOVED******REMOVED*** `/repo/src/voice/observability.py`
...
***REMOVED******REMOVED******REMOVED*** `/repo/src/ingestion/unified/observability.py`
...
***REMOVED******REMOVED******REMOVED*** `/repo/src/evaluation/langfuse_integration.py`
...
***REMOVED******REMOVED*** Data Flow Design

***REMOVED******REMOVED******REMOVED*** Telegram And API Requests
...
***REMOVED******REMOVED******REMOVED*** Voice And Ingestion Lifecycles
...
***REMOVED******REMOVED******REMOVED*** LangChain Callback Paths
...
***REMOVED******REMOVED******REMOVED*** Risk: Silent Semantics Drift
...
***REMOVED******REMOVED******REMOVED*** Risk: Incomplete Repo Migration
...
***REMOVED******REMOVED******REMOVED*** Risk: Over-Customization
...
***REMOVED******REMOVED******REMOVED*** Risk: OpenTelemetry Export Drift
...
***REMOVED******REMOVED******REMOVED*** Issue-Level Validation

Run the validation set recorded on issue `***REMOVED***1174`:
...
***REMOVED******REMOVED******REMOVED*** Focused Regression Validation
...
***REMOVED******REMOVED******REMOVED*** Migration Completion Check
...
***REMOVED******REMOVED*** Completion Criteria
...
- the issue `***REMOVED***1174` validation set passes;
