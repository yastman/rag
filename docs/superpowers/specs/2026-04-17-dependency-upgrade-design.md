***REMOVED*** Dependency Upgrade Design
...
- root Python application dependencies in `/repo/pyproject.toml` and `/repo/uv.lock`;
- nested Python manifests in `/repo/telegram_bot/` and service images under `/repo/services/`;
- frontend dependencies in `/repo/mini_app/frontend/package.json`;
...
***REMOVED******REMOVED******REMOVED*** Branch and Automation Drift
...
***REMOVED******REMOVED******REMOVED*** Dependency Surfaces
...
***REMOVED******REMOVED******REMOVED*** Execution Risk
...
***REMOVED******REMOVED******REMOVED*** Required Alignment
...
***REMOVED******REMOVED******REMOVED*** Release Semantics
...
***REMOVED******REMOVED******REMOVED*** Wave 2: Python Dependency Modernization
...
***REMOVED******REMOVED******REMOVED*** Wave 3: Mini App Dependency Modernization

Purpose:
- update the frontend toolchain and runtime dependencies without mixing them into Python failures.

Scope:
- `/repo/mini_app/frontend/package.json`;
...
***REMOVED******REMOVED******REMOVED*** Wave 4: Docker and Runtime Image Modernization
...
***REMOVED******REMOVED*** Grouping Strategy
...
***REMOVED******REMOVED******REMOVED*** Base Verification
...
***REMOVED******REMOVED******REMOVED*** Runtime and Compose Verification
...
***REMOVED******REMOVED******REMOVED*** Wave Discipline
...
***REMOVED******REMOVED*** Implementation Guidance
