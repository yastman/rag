***REMOVED*** OpenCode Swarm Workers Design
...
***REMOVED******REMOVED*** Current Context
...
***REMOVED******REMOVED*** Proposed Architecture
...
***REMOVED******REMOVED******REMOVED*** Worker Runner
...
***REMOVED******REMOVED******REMOVED*** Registry Metadata
...
***REMOVED******REMOVED*** Worker Types And OpenCode Agents
...
***REMOVED******REMOVED*** Required Skill Availability Gate
...
***REMOVED******REMOVED*** Documentation Skill Contract
...
***REMOVED******REMOVED*** Prompt Contract Changes
...
***REMOVED******REMOVED*** DONE JSON Changes
...
***REMOVED******REMOVED*** Local-Only And Docs Lookup Policy
...
***REMOVED******REMOVED*** Tests And Validation
...
***REMOVED******REMOVED*** Migration Plan Outline
