***REMOVED*** Remote MacBook Docker Host Design
...
***REMOVED******REMOVED*** Runtime Modes

***REMOVED******REMOVED******REMOVED*** Primary Mode: Remote Docker Stack With Bot
...
***REMOVED******REMOVED******REMOVED*** Full Stack Mode
...
***REMOVED******REMOVED******REMOVED*** Native Bot Mode
...
***REMOVED******REMOVED*** Environment Handling
...
***REMOVED******REMOVED*** Code Synchronization
...
***REMOVED******REMOVED*** Developer Commands
...
- From WSL to MacBook-exposed ports, use `REDACTED_PRIVATE_IP`.
...
***REMOVED******REMOVED******REMOVED*** Stay On WSL
...
***REMOVED******REMOVED******REMOVED*** Run From WSL Against MacBook Services
...
***REMOVED******REMOVED******REMOVED*** Run On The MacBook Over SSH
...
***REMOVED******REMOVED*** Resource Policy
