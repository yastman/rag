***REMOVED*** Exhaustive List Coverage for Knowledge RAG
...
***REMOVED******REMOVED******REMOVED*** Generation
...
***REMOVED******REMOVED*** Rollout 1: Coverage-Aware Generation

***REMOVED******REMOVED******REMOVED*** New runtime signal
...
***REMOVED******REMOVED******REMOVED*** Detection strategy
...
***REMOVED******REMOVED******REMOVED*** Prompt routing
...
***REMOVED******REMOVED******REMOVED*** Prompt contract for `generate_exhaustive_list`
...
***REMOVED******REMOVED******REMOVED*** Precedence over response style
...
***REMOVED******REMOVED******REMOVED*** Observability additions
...
***REMOVED******REMOVED******REMOVED*** Primary mechanism: grouping
...
***REMOVED******REMOVED******REMOVED*** Fallback mechanism: post-query cap
...
***REMOVED******REMOVED******REMOVED*** MMR policy
...
***REMOVED******REMOVED******REMOVED*** Normal knowledge question
...
***REMOVED******REMOVED******REMOVED*** Enumeration-style knowledge question
...
***REMOVED******REMOVED*** File-Level Change Plan

***REMOVED******REMOVED******REMOVED*** Rollout 1
...
***REMOVED******REMOVED******REMOVED*** Rollout 2
...
***REMOVED******REMOVED*** Validation Plan

***REMOVED******REMOVED******REMOVED*** Golden set
...
***REMOVED******REMOVED******REMOVED*** Langfuse evaluation
...
***REMOVED******REMOVED******REMOVED*** Retrieval validation
...
***REMOVED******REMOVED******REMOVED*** Regression guardrails
...
***REMOVED******REMOVED******REMOVED*** False positive coverage detection
...
***REMOVED******REMOVED******REMOVED*** Weak or inconsistent document identifier
...
***REMOVED******REMOVED******REMOVED*** Over-grouping
...
***REMOVED******REMOVED******REMOVED*** Prompt over-expansion
...
***REMOVED******REMOVED*** Shipping Order

***REMOVED******REMOVED******REMOVED*** PR1
...
***REMOVED******REMOVED******REMOVED*** Possible PR3 only if needed
