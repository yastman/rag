***REMOVED*** Swarm Wake-Up Helper Design
...
***REMOVED******REMOVED******REMOVED*** Option A: Keep snippets, improve lint
...
***REMOVED******REMOVED******REMOVED*** Option B: Notification helper
...
***REMOVED******REMOVED******REMOVED*** Option C: Full signal helper
...
***REMOVED******REMOVED*** Proposed Design
...
- `tmux display-message -p -t "$ORCH_TARGET" '***REMOVED***{window_id}'` matches
  `--window-id`;
- `***REMOVED***{window_name}` matches `--window-name`;
- `***REMOVED***{session_name}` matches `--session`;
