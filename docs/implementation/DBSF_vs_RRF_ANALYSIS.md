...
***REMOVED******REMOVED*** 🚨 КРИТИЧЕСКАЯ ПРОБЛЕМА: DBSF не документирован

***REMOVED******REMOVED******REMOVED*** Исследование через MCP Context7

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Поиск в официальной документации Qdrant
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Проверка статьи из нашего кода
...
***REMOVED******REMOVED*** 🧪 Эксперимент: Оба метода работают в Qdrant

***REMOVED******REMOVED******REMOVED*** Тестирование через API
...
***REMOVED******REMOVED*** 🔍 Наш текущий код
...
"query": {
    "fusion": "dbsf"  ***REMOVED*** Distribution-Based Score Fusion ← НЕ ДОКУМЕНТИРОВАН!
},
```

***REMOVED******REMOVED******REMOVED*** Комментарий в коде:
```python
...
***REMOVED******REMOVED*** 🎯 Возможные сценарии

***REMOVED******REMOVED******REMOVED*** Сценарий 1: DBSF = устаревший метод
...
***REMOVED******REMOVED******REMOVED*** Сценарий 2: DBSF = alias для RRF
...
***REMOVED******REMOVED******REMOVED*** Сценарий 3: DBSF = undocumented feature
...
***REMOVED******REMOVED******REMOVED*** Сценарий 4: DBSF = fallback к RRF
...
***REMOVED******REMOVED*** ⚠️ Риски использования DBSF
...
***REMOVED******REMOVED*** ✅ Рекомендации (после A/B теста)

***REMOVED******REMOVED******REMOVED*** Если результаты идентичны:
...
***REMOVED******REMOVED******REMOVED*** Если RRF показывает лучшие результаты:

1. **Переключить на RRF немедленно**
2. **Провести полный A/B тест на 150 запросах**
3. **Обновить OPTIMIZATION_PLAN.md**

***REMOVED******REMOVED******REMOVED*** Если DBSF показывает лучшие результаты:
...
***REMOVED******REMOVED*** 📚 Источники

***REMOVED******REMOVED******REMOVED*** Официальная документация Qdrant
...
***REMOVED******REMOVED******REMOVED*** RRF в официальной документации
```python
...
***REMOVED******REMOVED******REMOVED*** Наш код
...
***REMOVED******REMOVED*** ✅ ОБНОВЛЕНИЕ (2025-10-23, 18:30)

***REMOVED******REMOVED******REMOVED*** Решение проблемы sparse векторов
...
3. ✅ Обновлен `config.py`:
   ```python
   DEFAULT_COLLECTION = "legal_documents"  ***REMOVED*** Единая коллекция для всех документов
   ```
