...
- [`monolith-core-issue-backlog.md`](monolith-core-issue-backlog.md) —
  ...
  выполнения без лишних зависимостей, week-1 focus, шаблоны `CORE-001` …
  `CORE-010` и follow-up slice `CORE-011` … `CORE-018`.
...
- ADR решения `CORE-018`: [`../adr/0019-core-text-path-procedural-runtime.md`](../adr/0019-core-text-path-procedural-runtime.md)
