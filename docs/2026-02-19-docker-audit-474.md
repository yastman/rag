***REMOVED*** Docker Image/Container Audit — ***REMOVED***474

**Date:** 2026-02-19
**Auditor:** Claude Sonnet 4.6 (W-DOCKER worker)
**Branch:** `chore/docker-audit-474`
**Issue:** [***REMOVED***474 — chore(infra): audit bot Docker image/container contents, caches, versions, and security](https://github.com/yastman/rag/issues/474)

---

***REMOVED******REMOVED*** 1. Image Summary
...
***REMOVED******REMOVED******REMOVED*** Top 5 Largest Layers
...
***REMOVED******REMOVED*** 2. Runtime Versions
...
***REMOVED******REMOVED******REMOVED*** Key Dependency Versions
...
***REMOVED******REMOVED******REMOVED*** Drift Analysis
...
***REMOVED******REMOVED*** 3. Cache / Storage
...
***REMOVED******REMOVED******REMOVED*** Bytecode (`.pyc`) Files
...
***REMOVED******REMOVED******REMOVED*** Env Vars Baked Into Image
...
***REMOVED******REMOVED******REMOVED*** Secret Leak Check
...
***REMOVED******REMOVED******REMOVED*** `.dockerignore` Coverage
...
***REMOVED******REMOVED*** 5. Security

***REMOVED******REMOVED******REMOVED*** CVE Scan (pip-audit 2.10.0, OSV database)
...
***REMOVED******REMOVED******REMOVED*** Layer History Analysis

No secrets, API keys, or passwords found in any layer commands. Build args not used. All secrets are runtime-injected.

***REMOVED******REMOVED******REMOVED*** Manual Checks (no Trivy/Grype/Syft available on host)
...
***REMOVED******REMOVED******REMOVED*** Base Image Pinning
...
***REMOVED******REMOVED******REMOVED*** Syntax Directive

`telegram_bot/Dockerfile` uses `***REMOVED*** syntax=docker/dockerfile:1@sha256:b6afd42430b15f2d2a4c5a02b919e98a525b785b1aaff16747d2f623364e39b6` — frontend pinned.

***REMOVED******REMOVED******REMOVED*** Lock File Integrity
...
***REMOVED******REMOVED******REMOVED*** Determinism
...
| ***REMOVED*** | Finding | Severity | Owner | Action |
|---|---------|----------|-------|--------|
...
***REMOVED******REMOVED******REMOVED*** READY FOR DEPLOY (with caveats)
