...
## Supervisor Architecture (#240, #310)

**Status:** Always-on (monolith path removed in #310).
...
│   ├── services/                 ***REMOVED***Service, QdrantService, etc.
│   └── bot.py                    # Main handler
│
├── scripts/                      # Utilities
