...
***REMOVED******REMOVED******REMOVED*** Current Behavior (Generic)
...
***REMOVED******REMOVED******REMOVED*** Recommended: Structured Errors
...
***REMOVED******REMOVED******REMOVED*** QueryRequest
...
***REMOVED******REMOVED******REMOVED*** QueryResponse
