***REMOVED*** Documentation Index - Contextual RAG Pipeline
...
***REMOVED******REMOVED*** 📚 Core Documentation

***REMOVED******REMOVED******REMOVED*** Main Guides (Project Root)
...
***REMOVED******REMOVED******REMOVED*** 📁 Guides (`docs/guides/`)
...
***REMOVED******REMOVED******REMOVED*** 🔧 Implementation (`docs/implementation/`)
...
***REMOVED******REMOVED******REMOVED*** 📊 Reports (`docs/reports/`)
...
***REMOVED******REMOVED******REMOVED*** 📦 Archive (`docs/archive/`)
...
***REMOVED******REMOVED*** 🔍 Component Documentation

***REMOVED******REMOVED******REMOVED*** Ingestion Pipeline
...
***REMOVED******REMOVED******REMOVED*** Contextualization APIs
...
***REMOVED******REMOVED******REMOVED*** Search Engines
...
***REMOVED******REMOVED******REMOVED*** Evaluation Framework
...
***REMOVED******REMOVED*** 🎯 By Task

***REMOVED******REMOVED******REMOVED*** I want to...

***REMOVED******REMOVED******REMOVED******REMOVED*** ...install the system
→ Start with **[SETUP.md](../SETUP.md)**

***REMOVED******REMOVED******REMOVED******REMOVED*** ...understand how it works
→ Read **[ARCHITECTURE.md](../ARCHITECTURE.md)**

***REMOVED******REMOVED******REMOVED******REMOVED*** ...run a test
→ Follow **Quick Test** in [SETUP.md](../SETUP.md***REMOVED***first-test-run)

***REMOVED******REMOVED******REMOVED******REMOVED*** ...add a new feature
→ Check **[CODE_QUALITY.md](../CODE_QUALITY.md)** for standards

***REMOVED******REMOVED******REMOVED******REMOVED*** ...optimize search
...
***REMOVED******REMOVED******REMOVED******REMOVED*** ...compare APIs
→ See **[API Comparison Report](reports/TEST_RESULTS_SUMMARY.md)**

***REMOVED******REMOVED******REMOVED******REMOVED*** ...evaluate performance
→ Run **`evaluation/run_ab_test.py`** (see [README.md](../README.md***REMOVED***evaluation))
→ Review **[Evaluation Results](reports/FINAL_REPORT_CONTEXTUAL_RAG.md)**

***REMOVED******REMOVED******REMOVED******REMOVED*** ...fix code quality issues
→ Follow **[CODE_QUALITY.md](../CODE_QUALITY.md)**

***REMOVED******REMOVED******REMOVED******REMOVED*** ...integrate Docling
→ Read **[Docling Integration Guide](guides/DOC_LING_RAG_TASKS_2025.md)**

***REMOVED******REMOVED******REMOVED******REMOVED*** ...prevent duplicates
...
***REMOVED******REMOVED******REMOVED*** Application Config (config.py)
...
***REMOVED******REMOVED*** 📊 Performance Data

***REMOVED******REMOVED******REMOVED*** Ingestion Benchmarks (132 chunks)
...
***REMOVED******REMOVED******REMOVED*** Search Latency (estimated)
...
1. **Service connection errors** → Check Docker containers ([SETUP.md](../SETUP.md***REMOVED***troubleshooting))
2. **API key errors** → Verify .env configuration ([SETUP.md](../SETUP.md***REMOVED***issue-api-key-not-found-or-401-unauthorized))
3. **Code quality errors** → Run `ruff check --fix .` ([CODE_QUALITY.md](../CODE_QUALITY.md))
4. **BGE-M3 model not found** → Check volume ([SETUP.md](../SETUP.md***REMOVED***issue-bge-m3-model-not-found))
5. **Rate limits** → Adjust config ([SETUP.md](../SETUP.md***REMOVED***issue-rate-limits-groqopenai-free-tier))

---

***REMOVED******REMOVED*** 🔗 External Resources

***REMOVED******REMOVED******REMOVED*** Qdrant Documentation
...
***REMOVED******REMOVED******REMOVED*** Tools & Libraries
...
**Getting Started:**
- [Installation](../SETUP.md***REMOVED***installation-steps)
- [Configuration](../SETUP.md***REMOVED***configuration)
- [First Test](../SETUP.md***REMOVED***first-test-run)

**Development:**
- [Architecture Overview](../ARCHITECTURE.md***REMOVED***system-overview)
- [Code Quality](../CODE_QUALITY.md)
- [Search Engines](../ARCHITECTURE.md***REMOVED***search-engines)

**Evaluation:**
- [Run A/B Test](../README.md***REMOVED***evaluation)
- [Metrics](../ARCHITECTURE.md***REMOVED***technical-specifications)
...
- [Payload Indexes](../ARCHITECTURE.md***REMOVED***payload-indexes)
- [Performance Tuning](../ARCHITECTURE.md***REMOVED***performance-optimization)
