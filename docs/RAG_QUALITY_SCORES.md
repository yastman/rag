...
***REMOVED******REMOVED*** Score Overview
...
***REMOVED******REMOVED*** Score Categories

***REMOVED******REMOVED******REMOVED*** Retrieval Quality Scores
...
***REMOVED******REMOVED******REMOVED*** Generation Quality Scores
...
***REMOVED******REMOVED******REMOVED*** Cache Performance Scores
...
***REMOVED******REMOVED******REMOVED*** Latency Scores
...
***REMOVED******REMOVED*** RRF Scale Explanation
...
***REMOVED******REMOVED*** How to Interpret Scores

***REMOVED******REMOVED******REMOVED*** High cache hit rates indicate:
- Good cache coverage for repeated queries
- Appropriate cache thresholds for query types

***REMOVED******REMOVED******REMOVED*** Low confidence with results:
...
***REMOVED******REMOVED*** Where to View Scores
...
***REMOVED******REMOVED*** Score Data Types
