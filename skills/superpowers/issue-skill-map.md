...
| ***REMOVED***1654 | bot refactor | `using-git-worktrees`, `writing-plans`, `test-driven-development`, `verification-before-completion` | APScheduler loop refactor; protect bot startup/shutdown behavior with tests. |
