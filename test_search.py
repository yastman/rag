...
async def main():
    ...
    ***REMOVED*** Generate query embeddings using BGE-M3
    ...
    ***REMOVED*** Test 2: Sparse vector search (BM42)
    ...
    ***REMOVED*** Test 3: ColBERT multivector search
    ...
    ***REMOVED*** Test 4: Hybrid search with RRF
    ...
    hybrid_results = indexer.client.query_points(
        collection_name="legal_documents",
        prefetch=[
            ***REMOVED*** Dense vector search
            Prefetch(
                query=query_emb["dense_vecs"].tolist(),
                using="dense",
                limit=10,
            ),
            ***REMOVED*** Sparse vector search
            Prefetch(
                query=SparseVector(indices=sparse_indices, values=sparse_values),
                using="bm42",
                limit=10,
