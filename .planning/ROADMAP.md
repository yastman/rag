***REMOVED*** Roadmap: Contextual RAG Pipeline — Milestone Feature Expansion

***REMOVED******REMOVED*** Overview

This milestone delivers six open issues against a production RAG bot: guard coverage
gaps (***REMOVED***439, ***REMOVED***432), async pipeline simplification (***REMOVED***442), CRM test coverage (***REMOVED***441),
menu system expansion (***REMOVED***447), HITL confirmation for write operations (***REMOVED***443), and i18n
system prompt support (***REMOVED***444). The critical path runs through the pipeline refactor —
...
- [ ] **Phase 6: E2E Tests + Epic Close** - Full integration tests, cleanup, epic ***REMOVED***403 acceptance criteria

***REMOVED******REMOVED*** Phase Details

***REMOVED******REMOVED******REMOVED*** Phase 1: Security + Pipeline Foundation
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Observability + Test Coverage
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Menu System
...
***REMOVED******REMOVED******REMOVED*** Phase 4: HITL + CRM Extended + i18n
...
***REMOVED******REMOVED******REMOVED*** Phase 5: New Tools + Background Workers
...
***REMOVED******REMOVED******REMOVED*** Phase 6: E2E Tests + Epic Close
**Goal**: Full bot flow is validated under CI mocks; dead pre-***REMOVED***413 code is removed; all epic ***REMOVED***403 acceptance criteria are verified
**Depends on**: Phase 5
...
**Success Criteria** (what must be TRUE):
  ...
  2. All code paths and files from the pre-***REMOVED***413 architecture (supervisor graph, legacy handlers) are removed and tests still pass
  3. All acceptance criteria listed in epic ***REMOVED***403 are verified and the epic is closed
**Plans**: TBD
