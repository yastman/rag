...
│   │   ├── qdrant.py                ***REMOVED*** gRPC client + batch ops
│   │   ├── llm.py                   # LiteLLM (Cerebras/OpenAI)
│   │   ├── colbert_reranker.py      # ColBERT reranking
│   │   ├── voyage.py                ***REMOVED*** AI embeddings (dev)
...
│   │   ├── kommo_client.py          ***REMOVED*** CRM async httpx client (OAuth2 auto-refresh)
...
│   │   │   ├── qdrant_writer.py     ***REMOVED*** upsert/delete writer (sync methods)
...
│   │   ├── claude.py                ***REMOVED*** Claude contextualization
│   │   └── groq.py                  ***REMOVED***-based contextualization
