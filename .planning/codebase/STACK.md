...
***REMOVED******REMOVED*** Platform Requirements

**Development:**
- Docker & Docker Compose - Container orchestration
- uv installed - Package manager
- Python 3.12 interpreter (managed by uv)
- Linux/macOS/WSL2 - Tested on Linux, WSL2 (VPS at REDACTED_VPS_IP)

**Production:**
- VPS: k3s cluster at REDACTED_VPS_IP (admin@...:1654)
- CPU: 4-8 cores
