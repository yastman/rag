***REMOVED*** Codebase Concerns

**Analysis Date:** 2026-02-19

***REMOVED******REMOVED*** Tech Debt

**APScheduler v3 → v4 migration pending (***REMOVED***390):**
...
**MLflow integration stubs (***REMOVED***181, ***REMOVED***212 in src/evaluation/mlflow_experiments.py):**
...
**Database pool configuration missing timeout (***REMOVED***3 in lead_scoring_store.py comment):**
...
**Response style detection disabled by default (***REMOVED***129 in generate_node):**
...
***REMOVED******REMOVED*** Known Bugs

**Security: Text path bypasses guard node (***REMOVED***439) — CRITICAL**
...
**Streaming coordination broken (***REMOVED***428):**
...
**Agent semantic cache ineffective (***REMOVED***430):**
...
**Online LLM-as-a-Judge removed in ***REMOVED***413 migration (***REMOVED***427):**
...
**CRM tools untested, no error paths (***REMOVED***441):**
...
**Metrics command dead (***REMOVED***436):**
...
**Tool calls total score never written (***REMOVED***437):**
...
**Feedback buttons missing for history_search (***REMOVED***434):**
...
**PII masking incomplete (***REMOVED***5 in security/pii_redaction.py):**
...
**API response parsing not defensive (***REMOVED***98-101 in kommo_client.py):**
...
***REMOVED******REMOVED*** Performance Bottlenecks
...
**Streaming delivery with partial message recovery (***REMOVED***379-414 in generate_node):**
...
- Safe modification:
  ...
  3. Ensure respond_node gracefully handles response_sent=True (currently broken ***REMOVED***428)
...
***REMOVED******REMOVED*** Test Coverage Gaps
...
**Untested: CRM tool error paths (***REMOVED***441):**
...
**Untested: Guard node bypass via text path (***REMOVED***439):**
...
**Untested: Concurrent Kommo token refresh (***REMOVED***sec-kommo-race):**
...
***REMOVED******REMOVED*** Scaling Limits
...
***REMOVED******REMOVED*** Dependencies at Risk
...
***REMOVED******REMOVED*** Missing Critical Features
...
- Impact: Production vulnerability (see ***REMOVED***439)
...
- Fix: Restore online judge (see Known Bugs section ***REMOVED***427)
...
- Fix: Add error handling tests + user feedback on tool execution (see Known Bugs section ***REMOVED***441)
