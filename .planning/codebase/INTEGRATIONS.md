...
***REMOVED******REMOVED*** APIs & External Services
...
***REMOVED******REMOVED*** Authentication & Identity
...
***REMOVED******REMOVED*** CI/CD & Deployment

**Hosting:**
- Docker Compose (dev) - Local development, docker-compose.dev.yml
- k3s cluster (prod) - VPS at REDACTED_VPS_IP, manifests in `k8s/`
...
***REMOVED******REMOVED*** Webhooks & Callbacks
...
***REMOVED******REMOVED*** CRM Integration (Kommo)
