...
***REMOVED******REMOVED*** Discovery Tools
...
***REMOVED******REMOVED******REMOVED*** 1. Load the Repository Contract
...
***REMOVED******REMOVED******REMOVED*** 2. Check Repository Workflow
...
***REMOVED******REMOVED******REMOVED*** 3. Gather PR Context
...
***REMOVED******REMOVED******REMOVED*** 4. Route by Subsystem and Blast Radius
...
***REMOVED******REMOVED******REMOVED*** 5. Inspect the Right Failure Modes
...
***REMOVED******REMOVED******REMOVED*** 6. SDK-First and Docs Gate
...
***REMOVED******REMOVED******REMOVED*** 7. Container and Compose Gate
...
***REMOVED******REMOVED******REMOVED*** 8. Verify Before Claiming
...
***REMOVED******REMOVED******REMOVED*** 9. Merge Gate
...
***REMOVED******REMOVED******REMOVED*** 10. Autofix Lane
...
***REMOVED******REMOVED******REMOVED*** 11. Merge Execution
...
***REMOVED******REMOVED******REMOVED*** 12. Post-Merge Cleanup
...
***REMOVED******REMOVED*** Write the Review
...
***REMOVED******REMOVED*** Review Heuristics
