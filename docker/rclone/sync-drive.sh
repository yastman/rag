***REMOVED***!/bin/bash
***REMOVED*** Google Drive → Local sync for RAG ingestion
***REMOVED*** Runs via cron every 5 minutes
***REMOVED***
***REMOVED*** Install: sudo cp docker/rclone/sync-drive.sh /opt/scripts/
***REMOVED***          sudo chmod +x /opt/scripts/sync-drive.sh
...
***REMOVED*** Ensure log directory exists
mkdir -p "$(dirname "$LOG_FILE")"

***REMOVED*** Prevent concurrent runs
exec 200>"$LOCK_FILE"
...
***REMOVED*** Generate manifest for stable file IDs (optional)
