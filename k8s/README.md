***REMOVED*** K3s Deployment (Partial)
...
***REMOVED******REMOVED******REMOVED*** `overlays/`
...
***REMOVED******REMOVED******REMOVED*** `k3s-config.yaml`
...
```bash
***REMOVED*** Deploy stacks
make k3s-core      ***REMOVED*** core databases
make k3s-bot       ***REMOVED*** bot stack
make k3s-ingest    ***REMOVED*** ingestion stack
make k3s-full      ***REMOVED*** everything

***REMOVED*** Operational helpers
make k3s-status    ***REMOVED*** pod status
make k3s-logs SVC=bot
make k3s-down      ***REMOVED*** tear down
make k3s-secrets   ***REMOVED*** create secrets from k8s/secrets/.env
make k3s-ingest-start
make k3s-ingest-stop

***REMOVED*** Build and push versioned images
...
```bash
make k3s-secrets
make k3s-core      ***REMOVED*** or make k3s-bot / make k3s-ingest / make k3s-full
```
