***REMOVED*** W-1269-quick-cleanup: quick cleanup bundle
...
Fix GitHub issue ***REMOVED***1269: quick cleanup bundle.

Issue: https://github.com/yastman/rag/issues/1269

***REMOVED******REMOVED*** IMPLEMENTATION BRIEF
Goal: Apply the safe repository-file cleanup items from ***REMOVED***1269 without touching unrelated worktrees or active branches.
...
- Open PR against `dev` with `Fixes ***REMOVED***1269`.
...
WORKTREE=/repo-wt-1269-quick-cleanup
...
***REMOVED******REMOVED*** REQUIRED SKILLS WORKFLOW
...
ORCH_PANE=%26
SIGNAL_FILE=/repo-wt-1269-quick-cleanup/.signals/worker-1269-quick-cleanup.json

Write DONE JSON atomically via `.tmp` then `mv`. After writing it, run:

```bash
tmux send-keys -t "%26" "[DONE] W-1269-quick-cleanup /repo-wt-1269-quick-cleanup/.signals/worker-1269-quick-cleanup.json"
sleep 1
