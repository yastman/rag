        ...
        payload = {
            "filter": {
                "must": [
                    {
                        "key": "article_number",
                        "match": {"value": int(article_num)},  ***REMOVED*** Convert to int!
                    }
                ]
            },
            "limit": 1,
...
{{
  ...
  "paraphrased": "..."
    ...
    ***REMOVED*** Call LLM using aiohttp directly
    import aiohttp
    ...
    ***REMOVED*** Extract JSON from response (in case there's extra text)
    ...
    return [
        {
            ...
            "type": "direct",
            "expected_article": article_num,  ***REMOVED*** Already a string
            "difficulty": "easy",
        },
        {
...
async def main():
    ...
    ***REMOVED*** Generate queries
    ...
    queries = await generate_all_queries(
        article_texts,
        model="openai/gpt-oss-120b",  ***REMOVED*** 120B parameters, 100% accuracy
        max_concurrent=5,
    )
