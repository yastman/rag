...
***REMOVED*** MLflow integration (optional - gracefully handles if not available)
try:
...
def run_ab_test(
    ...
    ***REMOVED*** Log to MLflow (if available)
    if MLFLOW_AVAILABLE:
        print("=" * 80)
        ...
        try:
            ...
            ***REMOVED*** Create run name from timestamp
            ...
            with logger.start_run(
                ...
                ***REMOVED*** Log DBSF+ColBERT metrics
                dbsf_metrics = {
                ...
                ***REMOVED*** Log comparison improvements (DBSF vs Baseline)
                improvement_metrics = {
