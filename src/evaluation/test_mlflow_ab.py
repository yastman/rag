...
def main():
    ...
    ***REMOVED*** Create temporary queries file with just 5 queries for fast testing
    test_queries = [
    ...
    ***REMOVED*** Create temp file for queries
    ...
    try:
        ...
        ***REMOVED*** Run A/B test
        ...
        print()
        print("📊 Check results:")
        print("   - MLflow UI: http://localhost:5000/***REMOVED***/experiments")
        print(f"   - Reports: {results['reports']}")
        print()

    finally:
        ***REMOVED*** Clean up temp file
