...
0 2 * * * cd /srv/rag-fresh && /srv/app/venv/bin/python -m src.evaluation.ragas_evaluation >> /srv/logs/ragas_nightly.log 2>&1
```
...
export LANGFUSE_PUBLIC_KEY=[REDACTED-LANGFUSE-KEY]
export LANGFUSE_SECRET_KEY=[REDACTED-LANGFUSE-KEY]
