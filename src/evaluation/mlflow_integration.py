...
class MLflowRAGLogger:
    ...
    def __init__(
        ...
        ***REMOVED*** Set tracking URI
        mlflow.set_tracking_uri(tracking_uri)

        ***REMOVED*** Create or get experiment
        self.client = MlflowClient(tracking_uri=tracking_uri)
        try:
            self.experiment_id = self.client.create_experiment(experiment_name)
        except Exception:
            ***REMOVED*** Experiment already exists
    ...
    def log_metrics(
        ...
        **kwargs,
        ...
        Example:
            ...
            ***REMOVED*** Or use kwargs:
            logger.log_metrics(precision_at_1=0.94, recall_at_10=0.98)
        """
        if metrics is None:
            metrics = {}

        ***REMOVED*** Merge kwargs into metrics
        metrics.update(kwargs)

        ***REMOVED*** Log each metric
    ...
    def get_run_url(self) -> str:
        ...
        return f"{self.tracking_uri}/***REMOVED***/experiments/{self.experiment_id}/runs/{run_id}"


***REMOVED*** Convenience function for quick logging
