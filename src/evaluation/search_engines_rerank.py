...
***REMOVED*** Import from same directory
...
search_engines = importlib.util.module_from_spec(spec) ***REMOVED*** type: ignore[arg-type]
spec.loader.exec_module(search_engines) ***REMOVED*** type: ignore[union-attr]
