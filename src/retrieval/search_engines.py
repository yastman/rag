...
class HybridRRFColBERTSearchEngine(BaseSearchEngine):
    ...
    def _search_hybrid_colbert(
        ...
        ***REMOVED*** Convert to Python/Qdrant types
        ...
        try:
            ***REMOVED*** SDK query_points with nested prefetch for 3-stage pipeline
            response = self.client.query_points(
                collection_name=self.settings.collection_name,
                prefetch=[
                    ***REMOVED*** Outer prefetch: RRF fusion of dense + sparse
                    models.Prefetch(
                        prefetch=[
                            ...
                            ***REMOVED*** Stage 1b: BM42 sparse search
                            models.Prefetch(
                                query=sparse_vector,
                                using="bm42",
                                limit=100,
