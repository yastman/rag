***REMOVED*** Ingestion Module

> **Парсинг, чанкинг и индексация документов в Qdrant**

---

***REMOVED******REMOVED*** 📂 Скрипты

***REMOVED******REMOVED******REMOVED*** 1. **pdf_parser.py** - PDF парсер (PyMuPDF)
...
***REMOVED******REMOVED******REMOVED*** 2. **csv_to_qdrant.py** - CSV → Qdrant индексатор
...
***REMOVED******REMOVED******REMOVED*** 3. **chunker.py** - Стратегии чанкинга
...
***REMOVED******REMOVED******REMOVED*** 4. **indexer.py** - Индексация в Qdrant
...
***REMOVED******REMOVED*** 🔄 Типичный Pipeline
...
***REMOVED******REMOVED*** 🎯 Планируемые изменения

***REMOVED******REMOVED******REMOVED*** Рефакторинг на Docling
...
***REMOVED******REMOVED*** 🔗 Связанные модули
...
***REMOVED******REMOVED******REMOVED*** Проверить текущую коллекцию
```python
indexer = DocumentIndexer()
...
***REMOVED******REMOVED******REMOVED*** Batch индексация
```bash
***REMOVED*** Использовать существующий workflow из pipeline.py
python -c "
from src.core import RAGPipeline
pipeline = RAGPipeline()
***REMOVED*** pipeline имеет indexer, chunker, parser
"
```
