...
class GDriveIndexer:
    ...
    async def delete_file_points(
        ...
        ***REMOVED*** Count existing points first
    ...
    async def index_file_chunks(
        ...
        try:
            ***REMOVED*** Step 1: Delete existing points for this file
            stats.deleted_points = await self.delete_file_points(file_id, collection)

            ***REMOVED*** Step 2: Generate embeddings
            texts = [chunk.text for chunk in chunks]

            ***REMOVED*** Dense embeddings (Voyage)
            dense_embeddings = await self.voyage_service.embed_documents(texts)

            ***REMOVED*** Sparse embeddings (BM42)
            ...
            ***REMOVED*** Step 4: Upsert to Qdrant
