...
class VoyageIndexer:
    ...
    def __init__(
        ...
        # Qdrant client with longer timeout for batch operations
        ...
        # Voyage AI unified service for dense embeddings
    ...
    def create_collection(self, collection_name: str, recreate: bool = False) -> bool:
        ...
        self.client.create_collection(
            ...
            vectors_config={
                "dense": VectorParams(
                    size=1024,  # Voyage voyage-4-large dimension
