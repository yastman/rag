...
class QdrantHybridWriter:
    ...
    def __init__(
        ...
        ***REMOVED*** Sparse embeddings: BM42 via service or local FastEmbed
    ...
    def _embed_sparse_http(self, texts: list[str]) -> list[dict[str, list]]:
        ...
        ***REMOVED*** Try batch endpoint first
        try:
            response = self._bm42_http_client.post(
        ...
        ***REMOVED*** Fallback: per-text calls
