...
class QdrantHybridWriter:
    ...
    def __init__(
        ...
        ***REMOVED*** FastEmbed BM42 for sparse
    ...
    def upsert_chunks_sync(
        ...
        try:
            ...
            ***REMOVED*** Step 3: Generate embeddings (sync)
            ***REMOVED*** Use Voyage client directly (it's sync, async methods wrap with asyncio.to_thread)
