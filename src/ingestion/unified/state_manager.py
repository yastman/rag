...
class UnifiedStateManager:
    ...
    ***REMOVED*** =========================================================================
    ***REMOVED*** These wrap async methods using a dedicated event loop.
    ***REMOVED*** Safe to call from sync context (e.g., CocoIndex mutate()).
    ***REMOVED***
    ***REMOVED*** IMPORTANT: Each sync call uses a fresh event loop. To avoid asyncpg pool
    ***REMOVED*** being attached to a closed loop, we reset the pool before each sync call.
    ...
    def _run_sync(self, coro):
        ...
        """
        ***REMOVED*** Reset pool to avoid loop mismatch
        if self._pool is not None:
            ***REMOVED*** Pool exists from previous loop - it's now invalid
            ***REMOVED*** asyncpg pools cannot be reused across different event loops
            self._pool = None
        ...
        try:
            ...
            ***REMOVED*** Close pool before closing loop to release connections properly
            if self._pool is not None:
