...
class CSVToQdrantIndexer:
    ...
    def read_csv(self, file_path: Path) -> list[CSVRecord]:
        ...
        with open(file_path, encoding="utf-8") as f:
            ...
            for idx, row in enumerate(reader):
                ***REMOVED*** Convert row to natural language text
    ...
    def _row_to_text(self, row: dict[str, Any]) -> str:
        ...
        """
        ***REMOVED*** For Bulgarian properties data
        if "Название" in row:
            parts = [
        ...
        ***REMOVED*** Generic fallback - concatenate all fields
            ...
            for record, embedding in zip(records, embeddings):
                point = PointStruct(
                    ...
                    payload={
                        ...
                        **record.data,  ***REMOVED*** Include all CSV fields as metadata
                    },
                )
                points.append(point)
