...
class IncrementalApartmentIngester:
    ...
    def __init__(
        ...
        self._state: dict[str, str] = {}  ***REMOVED*** unique_key -> change_key
    ...
    def run_incremental(self, dry_run: bool = False) -> dict:
        ...
        ***REMOVED*** Always save state (even dry_run — to track what was seen)
...
if __name__ == "__main__":
    ...
    if args.incremental:
        ...
        ***REMOVED*** Full re-index: clear state and run
