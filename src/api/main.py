...
async def query(req: QueryRequest) -> QueryResponse:
    ...
    with propagate_attributes(**trace_kwargs):
        ...
        lf = get_client()
        ***REMOVED*** session_id/user_id/tags are also in propagate_attributes (for child spans);
        ***REMOVED*** update_current_trace sets them on the root @observe trace itself.
