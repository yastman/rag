"""CacheLayerManager — 5-tier Redis cache for RAG pipeline (canonical home, #3014).

Moved to ``src/runtime/cache/manager.py`` as part of the module-ownership
cleanup tracked under #3014. ``src.runtime.integrations.cache`` is kept as a
