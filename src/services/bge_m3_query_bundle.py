"""BGE-M3 query vector bundle contract (canonical home, #2049 slice 4).

Moved from ``telegram_bot/services/bge_m3_query_bundle.py`` as part of the
fourth slice of the reverse-layering fix tracked under #1948 / #2047 / #2049.
