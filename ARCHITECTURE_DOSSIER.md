...
|---|---|---|---|
| **qdrant** | `qdrant/qdrant:v1.19.0` | Vector store (dense + sparse + ColBERT); also the ingestion idempotency store | storage config (`on_disk_payload`, `indexing_threshold_kb`) mounted to cap growth |
