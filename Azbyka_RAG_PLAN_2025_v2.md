...
***REMOVED*** Azbyka RAG — Современный план внедрения (2025, v2)
**Версия:** 2025-10-30  
...
***REMOVED******REMOVED*** 0. Жёсткие критерии проекта (SLO / KPI)
...
***REMOVED******REMOVED*** 1. Архитектура (высокоуровнево)
...
azbyka-rag/
├─ src/
│  ├─ ingest/         ***REMOVED*** парсинг HTML→MD→TXT, нормализация
│  ├─ chunking/       ***REMOVED*** стратегии чанкинга
│  ├─ embeddings/     ***REMOVED*** обёртки моделей, кэш
│  ├─ retriever/      ***REMOVED*** BM25 + dense + RRF, фильтры
│  ├─ reranker/       ***REMOVED*** cross-encoder, ColBERT (фича)
│  ├─ llm/            ***REMOVED*** провайдеры, маршрутизация, политика ответов
│  ├─ tools/          ***REMOVED*** BibleTool, AuthorTool, SectionRetriever
│  ├─ eval/           ***REMOVED*** RAG-метрики, автозапуски
│  ├─ utils/          ***REMOVED*** логирование, OTEL, Langfuse, MLflow, Redis
│  └─ api/            ***REMOVED*** FastAPI/веб-контроллеры
├─ configs/           ***REMOVED*** Hydra: *.yaml для всех модулей/профилей
├─ data/              ***REMOVED*** исходники/подготовка (локально)
├─ docs/              ***REMOVED*** документация
├─ eval/              ***REMOVED*** датасеты test/small/full, golden-sets
├─ infra/             ***REMOVED*** docker-compose, grafana dashboards, prom rules
├─ scripts/           ***REMOVED*** запуск, снапшоты Qdrant, stress-test
└─ tests/             ***REMOVED*** pytest + e2e
```

---

***REMOVED******REMOVED*** 2. Конфигурации и секреты
...
retriever:
  ...
  fusion:
    method: "rrf"
    k: 60              ***REMOVED*** RRF parameter
    weighted: false
  filters:
    author: null
    book_type: [1,2]   ***REMOVED*** 1=Эталон, 2=Обычный (3 исключить по умолчанию)
    lang: ["ru","cs","en"]
```

---

***REMOVED******REMOVED*** 3. Чанкинг
...
***REMOVED******REMOVED*** 4. Эмбеддинги и индексация
...
***REMOVED******REMOVED*** 5. Ретривер, ранжирование и фильтры
...
***REMOVED******REMOVED*** 6. Генерация и политика ответов
...
***REMOVED******REMOVED*** 7. Кэширование (многоуровневое)
...
***REMOVED******REMOVED*** 8. Оценка качества (Eval First)
**Offline (nightly):**  
...
***REMOVED******REMOVED*** 9. Наблюдаемость и логирование
...
***REMOVED******REMOVED*** 10. Безопасность и риски
...
***REMOVED******REMOVED*** 11. Стоимость и производительность
...
***REMOVED******REMOVED*** 12. DR / Qdrant снапшоты
...
***REMOVED******REMOVED*** 13. План внедрения по неделям (DoD на каждый этап)

***REMOVED******REMOVED******REMOVED*** Week 1 — Initial Setup
**Задачи:**
...
***REMOVED******REMOVED******REMOVED*** Week 2 — Chunking/Embeddings/Eval v1
**Задачи:**
...
***REMOVED******REMOVED******REMOVED*** Week 3 — Quality Tuning (small set) + цитаты
**Задачи:**
...
***REMOVED******REMOVED******REMOVED*** Week 4 — Full dataset & Tools
**Задачи:**
...
***REMOVED******REMOVED******REMOVED*** Week 5 — Cost & Stability
**Задачи:**
...
***REMOVED******REMOVED******REMOVED*** Week 6 — Website Integration & UX
**Задачи:**
...
***REMOVED******REMOVED******REMOVED*** Week 7 — Public Release & SLA
**Задачи:**
...
***REMOVED******REMOVED*** 14. Release Checklist (кратко)
...
***REMOVED******REMOVED*** 15. Runbook (инциденты, откат, смена модели)
