...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-report-cleanup.log (APPEND):
Перед каждым шагом: echo "[START] $(date +%H:%M:%S) Task N Step M: description" >> /home/user/projects/rag-fresh/logs/worker-report-cleanup.log
После каждого шага: echo "[DONE] $(date +%H:%M:%S) Task N Step M: result" >> /home/user/projects/rag-fresh/logs/worker-report-cleanup.log
В конце: echo "[COMPLETE] $(date +%H:%M:%S) W-REPORT finished" >> /home/user/projects/rag-fresh/logs/worker-report-cleanup.log
