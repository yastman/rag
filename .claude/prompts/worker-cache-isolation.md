...
ПЛАН: /repo/docs/plans/2026-02-12-semantic-cache-isolation-plan.md
Работай из /repo. Ветка: feat/159-memory-observability-scores (или создай новую feat/163-semantic-cache-isolation от main если нужно).
...
4. GitHub issue: ***REMOVED***163. В каждом коммите ссылайся на ***REMOVED***163.
5. Создай ветку feat/163-semantic-cache-isolation от main если текущая ветка другая.

ЛОГИРОВАНИЕ в /repo/logs/worker-cache-isolation.log (APPEND):
