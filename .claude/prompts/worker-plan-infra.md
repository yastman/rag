W-INFRA: Написать планы реализации для issue ***REMOVED***121, ***REMOVED***122, ***REMOVED***101, ***REMOVED***105 (Infra-Perf + Gate stream)
...
=== ISSUE ***REMOVED***121: Redis SDK hardening ===
...
=== ISSUE ***REMOVED***122: Qdrant timeout + FormulaQuery ===
...
=== ISSUE ***REMOVED***101: Re-baseline latency + Go/No-Go gate ===
...
=== ISSUE ***REMOVED***105: Close parent tracking issue ===
