...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-p0-tests.log (APPEND):
Каждое действие логируй через: echo "[TAG] $(date +%H:%M:%S) message" >> /home/user/projects/rag-fresh/logs/worker-p0-tests.log
Теги: [START], [DONE], [ERROR], [COMPLETE]
В конце: echo "[COMPLETE] $(date +%H:%M:%S) Worker P0-TESTS finished" >> /home/user/projects/rag-fresh/logs/worker-p0-tests.log
