W-P0-TESTS: Fix 3 P0 test issues (***REMOVED***115, ***REMOVED***112, ***REMOVED***113)
...
Task 1.1 (***REMOVED***115): Cross-test pollution sys.modules
...
- Commit: git add tests/unit/test_redis_semantic_cache.py && commit с "Closes ***REMOVED***115"

Task 1.2 (***REMOVED***112): test_bot_handlers Langfuse API
...
- Commit: git add tests/unit/test_bot_handlers.py && commit с "Closes ***REMOVED***112"

Task 1.3 (***REMOVED***113): test_graph_paths GraphConfig mocks
...
- Commit: git add tests/integration/test_graph_paths.py && commit с "Closes ***REMOVED***113"
