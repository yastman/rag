...
Работай из /home/user/projects/rag-fresh. Ты на ветке fix/issue120-umbrella. Читай Task 1.4 в плане.
...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-p0-stream.log (APPEND):
Каждое действие логируй через: echo "[TAG] $(date +%H:%M:%S) message" >> /home/user/projects/rag-fresh/logs/worker-p0-stream.log
Теги: [START], [DONE], [ERROR], [COMPLETE]
В конце: echo "[COMPLETE] $(date +%H:%M:%S) Worker P0-STREAM finished" >> /home/user/projects/rag-fresh/logs/worker-p0-stream.log
