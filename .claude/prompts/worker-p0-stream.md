W-P0-STREAM: Fix ***REMOVED***114 streaming fallback duplicate response (TDD)
...
ЗАДАЧА: ***REMOVED***114 — Streaming fallback duplicate response
