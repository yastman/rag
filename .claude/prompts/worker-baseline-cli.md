...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-baseline-cli.log (APPEND):
В начале каждого таска: echo "[START] $(date +%H:%M:%S) Task N: description" >> /home/user/projects/rag-fresh/logs/worker-baseline-cli.log
В конце каждого: echo "[DONE] $(date +%H:%M:%S) Task N: result" >> /home/user/projects/rag-fresh/logs/worker-baseline-cli.log
После всех задач: echo "[COMPLETE] $(date +%H:%M:%S) Worker finished" >> /home/user/projects/rag-fresh/logs/worker-baseline-cli.log
