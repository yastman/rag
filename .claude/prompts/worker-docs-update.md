...
1. Прочитай текущие файлы:
   - /home/user/projects/rag-fresh/CLAUDE.md
   - /home/user/projects/rag-fresh/.claude/rules/features/embeddings.md
   - /home/user/projects/rag-fresh/.claude/rules/features/search-retrieval.md
   - /home/user/projects/rag-fresh/.claude/rules/features/caching.md
   - /home/user/projects/rag-fresh/.claude/rules/observability.md
   - /home/user/projects/rag-fresh/.claude/rules/services.md
...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-docs-update.log (APPEND):
echo "[START] $(date +%H:%M:%S) Step N: description" >> /home/user/projects/rag-fresh/logs/worker-docs-update.log
echo "[DONE] $(date +%H:%M:%S) Step N: result" >> /home/user/projects/rag-fresh/logs/worker-docs-update.log
В конце: echo "[COMPLETE] $(date +%H:%M:%S) Worker DOCS finished" >> /home/user/projects/rag-fresh/logs/worker-docs-update.log
