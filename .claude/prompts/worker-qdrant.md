W-QDRANT: Qdrant timeout + FormulaQuery (***REMOVED***122)
...
3. Два коммита: feat(qdrant): add explicit timeout=30 (***REMOVED***122) и feat(qdrant): migrate score boosting to FormulaQuery (***REMOVED***122)
