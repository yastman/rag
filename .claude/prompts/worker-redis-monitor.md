...
Работай из /home/user/projects/rag-fresh. Tasks 1, 2, 4, 5 выполняются другим воркером, НЕ трогай bot.py и test_bot_scores.py.
...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-redis-monitor.log (APPEND):
В начале Task: echo "[START] $(date +%H:%M:%S) Task 3: checkpoint key growth monitoring" >> /home/user/projects/rag-fresh/logs/worker-redis-monitor.log
По завершении Task: echo "[DONE] $(date +%H:%M:%S) Task 3: result" >> /home/user/projects/rag-fresh/logs/worker-redis-monitor.log
После всех задач: echo "[COMPLETE] $(date +%H:%M:%S) Worker finished" >> /home/user/projects/rag-fresh/logs/worker-redis-monitor.log
