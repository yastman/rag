W-LAT: Написать планы реализации для issue ***REMOVED***124, ***REMOVED***106, ***REMOVED***108 (Latency stream)
...
=== ISSUE ***REMOVED***124: TTFT variance + provider metadata ===
...
=== ISSUE ***REMOVED***106: BGE-M3 cold start + ONNX spike ===
...
=== ISSUE ***REMOVED***108: Rewrite stop-guard ===
...
ЛОГИРОВАНИЕ в /repo/logs/worker-plan-lat.log (APPEND mode, >> для каждой записи):
