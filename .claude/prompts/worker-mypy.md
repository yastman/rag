W-MYPY: Fix mypy errors + redisvl import gate (***REMOVED***191)
...
Task 1: Fix mypy no-any-return in sip_setup.py (***REMOVED***181)
...
Task 2: Fix mypy no-any-return + type-var in graph.py (***REMOVED***181)
  ...
  Стало:
    workflow.add_node("summarize", summarize_wrapper)  ***REMOVED*** type: ignore[type-var]

Task 3: Fix redisvl import gate in test_vectorizers.py (***REMOVED***183)
...
Commit message: fix(ci): resolve mypy errors and harden redisvl import gate (***REMOVED***191)
Scope коммита: src/voice/sip_setup.py, telegram_bot/graph/graph.py, tests/unit/test_vectorizers.py

ЛОГИРОВАНИЕ в /repo/logs/worker-mypy.log (APPEND):
