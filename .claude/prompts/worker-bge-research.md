...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-bge-research.log (APPEND):
echo "[TAG] $(date +%H:%M:%S) message" >> /home/user/projects/rag-fresh/logs/worker-bge-research.log
