...
Секция с заголовком TRACE VALIDATION (***REMOVED***110)
...
***REMOVED*** Validation reports (generated, not committed)
docs/reports/
...
git commit (conventional commit format, scope=validation, ref ***REMOVED***110)
