W-CACHE-FIX: Fix user_id inconsistency + commit Task C/D for ***REMOVED***163
...
- Если тесты прошли — один коммит:
  feat(cache): remove legacy LIST store + fix user_id consistency ***REMOVED***163
...
3. Ссылка на ***REMOVED***163 в коммите.
