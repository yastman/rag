...
Работай из /home/user/projects/rag-fresh. Ветка: fix/dev-setup-and-preflight (текущая, уже checkout).
...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-deps.log (APPEND):
