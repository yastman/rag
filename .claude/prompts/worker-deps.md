W-DEPS: Migrate dev dependencies to [dependency-groups] (PEP 735) ***REMOVED***169
...
6. Сообщение коммита: fix(build): migrate dev deps to [dependency-groups] (PEP 735) ***REMOVED***169
