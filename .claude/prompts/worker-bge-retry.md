***REMOVED*** Worker: BGE-M3 Retry & Resilience (***REMOVED***210)
...
***REMOVED******REMOVED*** SKILLS (вызывай в этом порядке)
...
```bash
uv run pytest tests/unit/integrations/test_embeddings.py -v          ***REMOVED*** Task 1 tests
uv run pytest tests/unit/graph/test_cache_nodes.py -v                ***REMOVED*** Task 2 tests
uv run pytest tests/unit/graph/test_edges.py -v                      ***REMOVED*** Task 2 edge tests
uv run pytest tests/unit/test_bot_handlers.py -v                     ***REMOVED*** Task 3 tests
uv run pytest tests/unit/ -n auto --timeout=30                       ***REMOVED*** Full suite
uv run pytest tests/integration/test_graph_paths.py -v               ***REMOVED*** Integration
make check                                                           ***REMOVED*** Lint + types
```

***REMOVED******REMOVED*** CRITICAL NOTES
