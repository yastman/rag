W-HOOKS: SDK hooks spike — checkpoint tracing design (Issue ***REMOVED***162)
...
КОНТЕКСТ:
Issue ***REMOVED***162: SDK-level InstrumentedAsyncRedisSaver hooks for checkpoint tracing.
Deferred from ***REMOVED***159 — нет callback hooks в SDK для checkpoint load/save.
Текущий подход (***REMOVED***159): graph.ainvoke() wall-time минус сумма pipeline stages = proxy для checkpointer overhead.
...
1. Напиши design doc: docs/plans/2026-02-12-sdk-hooks-spike-design.md
   ...
   - Current State: proxy approach из ***REMOVED***159
