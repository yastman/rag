...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-hooks.log (APPEND):
Формат: echo "[START/DONE] $(date +%H:%M:%S) Task N: description" >> /home/user/projects/rag-fresh/logs/worker-hooks.log
В конце: echo "[COMPLETE] $(date +%H:%M:%S) Worker hooks finished" >> /home/user/projects/rag-fresh/logs/worker-hooks.log
