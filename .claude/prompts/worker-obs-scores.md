...
Работай из /home/user/projects/rag-fresh. Task 1 уже завершён (deferred, follow-up issue #162).
...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-obs-scores.log (APPEND):
В начале каждого Task: echo "[START] $(date +%H:%M:%S) Task N: description" >> /home/user/projects/rag-fresh/logs/worker-obs-scores.log
По завершении Task: echo "[DONE] $(date +%H:%M:%S) Task N: result" >> /home/user/projects/rag-fresh/logs/worker-obs-scores.log
После всех задач: echo "[COMPLETE] $(date +%H:%M:%S) Worker finished" >> /home/user/projects/rag-fresh/logs/worker-obs-scores.log
