...
Работай из /repo. Task 1 уже завершён (deferred, follow-up issue ***REMOVED***162).
...
Task 2: Новые scores memory_messages_count + summarization_triggered
  ...
  - Коммит: feat(observability): memory_messages_count + summarization_triggered scores ***REMOVED***159
...
Task 4: checkpointer_overhead_proxy_ms score
  ...
  - Запусти: uv run pytest tests/unit/test_bot_scores.py -v
  - Коммит: feat(observability): add checkpointer_overhead_proxy_ms score ***REMOVED***159
...
Task 5: memory fields в trace metadata
  ...
  - Запусти: uv run pytest tests/unit/test_bot_scores.py -v
  - Коммит: feat(observability): add memory + overhead fields to trace metadata ***REMOVED***159
...
5. Conventional commits: feat(observability): ... ***REMOVED***159
