...
GitHub Issue: ***REMOVED***52 — test: cover Docker services critical test gaps
Работай из /repo
...
check_dependencies retry logic, and PreflightError. Closes ***REMOVED***52 (partial)

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>"
- Тесты ТОЛЬКО свои: tests/unit/test_preflight.py

Логирование в /repo/logs/worker-preflight-tests.log (APPEND):
[START] timestamp
[DONE] timestamp
[COMPLETE] timestamp
