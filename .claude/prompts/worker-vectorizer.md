...
Работай из /repo. GitHub Issue: ***REMOVED***155.
...
Task 3: Fix test guard (tests/unit/test_vectorizers.py)
  ...
  - Добавить ***REMOVED*** pragma: no cover - environment dependent
...
3. Один коммит на всю миграцию: fix(vectorizers): migrate to redisvl 0.14.0 internal API ***REMOVED***155
