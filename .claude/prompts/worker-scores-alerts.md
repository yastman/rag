W-SCORES: Langfuse scores + Loki alerts for BGE-M3 embedding errors (***REMOVED***210)
...
- После секции "Voice transcription scores (***REMOVED***151)" (около строки 155), добавь:
  - Комментарий: ***REMOVED*** --- Embedding resilience (***REMOVED***210) ---
...
Step 6: Коммит Task 3:
  ...
  git commit -m "feat(observability): add Langfuse scores for BGE-M3 embedding errors ***REMOVED***210
...
Step 9: Коммит Task 4:
  ...
  git diff --cached --stat
  git commit -m "feat(alerts): add Loki rules for BGE-M3 embed retries and failures ***REMOVED***210
