W-OBS: Написать планы реализации для issue ***REMOVED***103, ***REMOVED***123, ***REMOVED***91 (Observability stream)
...
=== ISSUE ***REMOVED***103: Cache hit scores + error spans in Langfuse ===
...
=== ISSUE ***REMOVED***123: Orphan traces + propagate_attributes ===
...
=== ISSUE ***REMOVED***91: Audit remediation (CI + smoke tests) ===
