W-CACHE: Graceful embedding error fallback in cache_check_node + route_cache (***REMOVED***210)
...
Step 7: Коммит (ТОЛЬКО эти файлы):
  ...
  git commit -m "fix(cache): explicit embedding error route without false cache-hit metrics ***REMOVED***210
