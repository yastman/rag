...
Работай из /home/user/projects/rag-fresh. Ветка main.
...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-review-fixes.log (APPEND):
echo "[START] $(date +%H:%M:%S) Step N: desc" >> /home/user/projects/rag-fresh/logs/worker-review-fixes.log
echo "[DONE] $(date +%H:%M:%S) Step N: result" >> /home/user/projects/rag-fresh/logs/worker-review-fixes.log
echo "[COMPLETE] $(date +%H:%M:%S) Worker REVIEW finished" >> /home/user/projects/rag-fresh/logs/worker-review-fixes.log
