...
1. Запусти: uv run pytest tests/unit/ -q --tb=short 2>&1 | tee /home/user/projects/rag-fresh/logs/unit-baseline.txt
2. Добавь в конец файла: echo "[COMPLETE]" >> /home/user/projects/rag-fresh/logs/unit-baseline.txt
3. Проанализируй результат и создай файл /home/user/projects/rag-fresh/logs/unit-failures-analysis.txt с:
...
Логирование в /home/user/projects/rag-fresh/logs/worker-test-baseline.log (APPEND):
[START] timestamp
[DONE] timestamp
[COMPLETE] timestamp
