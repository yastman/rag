...
GitHub Issue: ***REMOVED***51 — test: cover critical unified ingestion modules
Работай из /repo
...
Closes ***REMOVED***51 (partial)

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>"
- Тесты ТОЛЬКО свои: tests/unit/ingestion/test_unified_manifest.py

***REMOVED******REMOVED*** Логирование
/repo/logs/worker-test-manifest.log (APPEND):
[START] timestamp
[DONE] timestamp
[COMPLETE] timestamp
