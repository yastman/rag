...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-sdk-research.log (APPEND):
echo "[TAG] $(date +%H:%M:%S) message" >> /home/user/projects/rag-fresh/logs/worker-sdk-research.log
