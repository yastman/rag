W-110: Close issue ***REMOVED***110 — fix bugs + add queries + baseline run
...
git commit (conventional: fix(validation): add gdrive_bge queries + fix Makefile service name (***REMOVED***110))
