...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-fix-run.log (APPEND):
echo "[START] $(date +%H:%M:%S) description" >> /home/user/projects/rag-fresh/logs/worker-fix-run.log
echo "[DONE] $(date +%H:%M:%S) result" >> /home/user/projects/rag-fresh/logs/worker-fix-run.log
echo "[COMPLETE] $(date +%H:%M:%S) Worker finished" >> /home/user/projects/rag-fresh/logs/worker-fix-run.log
