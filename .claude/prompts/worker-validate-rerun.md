...
Работай из /home/user/projects/rag-fresh. Без остановок.
...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-validate-rerun.log (APPEND):
echo "[START] $(date +%H:%M:%S) Task N: description" >> /home/user/projects/rag-fresh/logs/worker-validate-rerun.log
echo "[DONE] $(date +%H:%M:%S) Task N: result" >> /home/user/projects/rag-fresh/logs/worker-validate-rerun.log
echo "[COMPLETE] $(date +%H:%M:%S) Worker finished" >> /home/user/projects/rag-fresh/logs/worker-validate-rerun.log
