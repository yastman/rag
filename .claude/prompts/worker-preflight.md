W-PREFLIGHT: Add dirty-worktree preflight guard to verification scripts ***REMOVED***165
...
Работай из /repo. Ветка: feat/163-semantic-cache-isolation (текущая).
...
5. Сообщение коммита: fix(validation): add dirty-worktree preflight guard ***REMOVED***165

ЛОГИРОВАНИЕ в /repo/logs/worker-preflight.log (APPEND):
