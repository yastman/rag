...
ЛОГИРОВАНИЕ в /home/user/projects/rag-fresh/logs/worker-langfuse.log (APPEND):
Формат: echo "[START/DONE] $(date +%H:%M:%S) Task N: description" >> /home/user/projects/rag-fresh/logs/worker-langfuse.log
В конце: echo "[COMPLETE] $(date +%H:%M:%S) Worker langfuse finished" >> /home/user/projects/rag-fresh/logs/worker-langfuse.log
