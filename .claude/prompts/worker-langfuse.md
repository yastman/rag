W-LANGFUSE: Langfuse dashboard design for latency breakdown (Issue ***REMOVED***147)
...
КОНТЕКСТ:
Issue ***REMOVED***147: track slow-thinking latency breakdown (queue, TTFT, decode).
...
Связанное: ***REMOVED***144 (TTFT gate pending), текущий gate проверяет generate_p50_lt_2s.
