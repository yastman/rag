...
echo "[START] $(date +%H:%M:%S) Latency remediation" >> /home/user/projects/rag-fresh/logs/worker-latency.log
... после каждой правки echo "[DONE] ..." ...
echo "[COMPLETE] $(date +%H:%M:%S) All done" >> /home/user/projects/rag-fresh/logs/worker-latency.log
