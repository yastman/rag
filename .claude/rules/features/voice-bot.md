...
***REMOVED******REMOVED*** Voice Agent Details
...
***REMOVED******REMOVED*** Voice Lifecycle Tracing (***REMOVED***614)
...
***REMOVED******REMOVED*** Transcript Store
...
ELEVENLABS_VOICE_ID=         ***REMOVED*** TTS voice
...
LIFECELL_SIP_NUMBER=         ***REMOVED*** SIP phone number
SIP_TRUNK_ID=                ***REMOVED*** from sip_setup.py output
RAG_API_URL=http://rag-api:8080
DATABASE_URL=                ***REMOVED*** PostgreSQL for transcripts
```
