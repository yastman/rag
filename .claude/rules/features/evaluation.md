...
***REMOVED******REMOVED*** LLM-as-a-Judge — Langfuse Managed Evaluators (***REMOVED***386)
...
***REMOVED******REMOVED******REMOVED*** Gold Set Experiments

```bash
make eval-goldset-sync    ***REMOVED*** Sync ground truth to Langfuse dataset
make eval-experiment      ***REMOVED*** Run RAG experiment on gold set
```

***REMOVED******REMOVED******REMOVED*** Go/No-Go Integration
...
pytest tests/unit/evaluation/ -v              ***REMOVED*** Gold set sync + experiment runner
pytest tests/unit/test_validate_aggregates.py -v  ***REMOVED*** Judge aggregation + Go/No-Go
