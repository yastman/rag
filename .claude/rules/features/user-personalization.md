...
***REMOVED******REMOVED*** ResponseStyleDetector (***REMOVED***129)
...
***REMOVED******REMOVED*** SessionSummary (CRM)
...
class SessionSummary(BaseModel):
    brief: str             ***REMOVED*** 1-2 sentences: topic + outcome
...
***REMOVED******REMOVED*** CESC Configuration (BotConfig)
