...
***REMOVED*** Skills Workflow (2026)

***REMOVED******REMOVED*** Выбор workflow
...
***REMOVED******REMOVED******REMOVED*** Dispatch
...
***REMOVED******REMOVED******REMOVED*** agent-mux trigger criteria (5% задач)
...
***REMOVED******REMOVED*** 5. ПАУЗА / HANDOFF
...
***REMOVED******REMOVED*** Worker Skills (инжектятся в промт tmux worker)

| Порядок | Скилл | Когда |
|---------|-------|-------|
| 1 | /executing-plans | Перед началом работы |
| 2 | /test-driven-development | При написании ЛЮБОГО кода (RED → GREEN → REFACTOR) |
...
***REMOVED******REMOVED*** Железные правила
