...
***REMOVED******REMOVED*** Makefile: Core Targets
...
***REMOVED******REMOVED*** Makefile: Test Targets
...
***REMOVED******REMOVED*** Makefile: Docker Targets
...
```bash
make setup-hooks                          ***REMOVED*** Install (one-time)
uv run pre-commit run --all-files         ***REMOVED*** Run manually
```
...
***REMOVED******REMOVED******REMOVED*** pyproject.toml structure
...
***REMOVED******REMOVED******REMOVED*** Key production deps
...
***REMOVED******REMOVED******REMOVED*** Key dev deps (`[dependency-groups].dev`)
...
***REMOVED******REMOVED*** Service-level pyproject.toml
