...
**Verification:**
```bash
docker compose -f docker-compose.dev.yml config --quiet  ***REMOVED*** Must succeed
grep "import requests" docker-compose.dev.yml            ***REMOVED*** Must return nothing
grep -E "127\.0\.0\.1:(3001|4000)" docker-compose.dev.yml  ***REMOVED*** Must match
```
