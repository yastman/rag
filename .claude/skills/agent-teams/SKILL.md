...
***REMOVED******REMOVED*** Starting a Team
...
***REMOVED******REMOVED*** Controlling the Team
...
***REMOVED******REMOVED******REMOVED*** Delegate Mode
...
***REMOVED******REMOVED******REMOVED*** Plan Approval
...
***REMOVED******REMOVED******REMOVED*** Task Assignment
...
***REMOVED******REMOVED******REMOVED*** Talking to Teammates Directly
...
***REMOVED******REMOVED******REMOVED*** Shutdown and Cleanup
...
***REMOVED******REMOVED******REMOVED*** Context and Communication
...
```python
***REMOVED*** Always specify model explicitly
Task(name="reviewer", model="opus", team_name="my-team", ...)
```

***REMOVED******REMOVED*** Git Worktrees (MANDATORY for parallel branch work)
...
```bash
***REMOVED*** Before spawning teammates
git worktree add /repo-wt-pr280 claude/optimize-test-suite-RBhOe
git worktree add /repo-wt-pr251 feat/docker-cleanup

***REMOVED*** In teammate spawn prompt — specify working directory
"Working directory: /repo-wt-pr280"

***REMOVED*** Cleanup after merge
git worktree remove /repo-wt-pr280
```
...
***REMOVED******REMOVED*** Teammate Skills Workflow
...
- Include "Found during PR ***REMOVED***N review" in description
```

***REMOVED******REMOVED*** Teammate Prompt Template
...
***REMOVED******REMOVED*** SKILLS (invoke in order)
...
***REMOVED******REMOVED******REMOVED*** Wait for Teammates to Finish
...
***REMOVED******REMOVED******REMOVED*** Start with Research and Review
...
***REMOVED******REMOVED******REMOVED*** Avoid File Conflicts
...
***REMOVED******REMOVED******REMOVED*** Monitor and Steer

Check in on progress, redirect failing approaches, synthesize findings. Unattended teams risk wasted effort.

***REMOVED******REMOVED*** Use Case Examples

***REMOVED******REMOVED******REMOVED*** Parallel Code Review
```
Create an agent team to review PR ***REMOVED***142. Spawn three reviewers:
...
***REMOVED******REMOVED******REMOVED*** Competing Hypotheses Debug
```
