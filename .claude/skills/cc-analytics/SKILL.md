...
***REMOVED******REMOVED*** Generation Script
...
***REMOVED*** Filter last N days (default 7)
days = 7
now = datetime.now()
...
***REMOVED******REMOVED*** HTML Template

Use terminal aesthetic with:
- Monospace system fonts: `'SF Mono', 'Monaco', 'Inconsolata', monospace`
- Dark background: `***REMOVED***0d0d0d`
- Muted colors: `***REMOVED***b0b0b0` (text), `***REMOVED***555` (dim), `***REMOVED***4ec9b0` (cyan), `***REMOVED***ce9178` (orange)
...
<head>
  ...
  <style>
    body {
      ...
      background: ***REMOVED***0d0d0d;
      color: ***REMOVED***b0b0b0;
      font-size: 14px;
      line-height: 1.6;
      padding: 24px;
    }
    .container { max-width: 900px; margin: 0 auto; }
    .header { color: ***REMOVED***6a9955; margin-bottom: 24px; }
    .dim { color: ***REMOVED***555; }
    .bright { color: ***REMOVED***e0e0e0; }
    .cyan { color: ***REMOVED***4ec9b0; }
    .orange { color: ***REMOVED***ce9178; }
    .row {
      display: grid;
      grid-template-columns: 24px 200px 1fr 80px 80px 60px;
      gap: 8px;
      padding: 6px 0;
      border-bottom: 1px solid ***REMOVED***1a1a1a;
    }
    .row:hover { background: ***REMOVED***141414; }
    a { color: ***REMOVED***555; text-decoration: none; }
    a:hover { color: ***REMOVED***888; }
    .stat-box { display: inline-block; margin-right: 32px; }
    .stat-value { font-size: 28px; color: ***REMOVED***e0e0e0; }
    .stat-label { color: ***REMOVED***555; font-size: 12px; }
  </style>
</head>
<body>
  <div class="container">
...
***REMOVED******REMOVED*** Bar Chart Generation
