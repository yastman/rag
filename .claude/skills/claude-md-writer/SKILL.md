...
***REMOVED******REMOVED*** Memory Hierarchy
...
***REMOVED******REMOVED*** 3-Tier Documentation System
...
```
.claude/
├── CLAUDE.md                 ***REMOVED*** Tier 1: always loaded
└── rules/
    ├── database.md           ***REMOVED*** Tier 2: SQL, migrations
    ├── api.md                ***REMOVED*** Tier 2: API patterns
    └── frontend/             ***REMOVED*** Tier 2: subdirectory
        ├── components.md     ***REMOVED*** paths: src/**/*.tsx
        ├── layout.md         ***REMOVED*** paths: src/pages/**/*.tsx
        └── tokens.md         ***REMOVED*** paths: **/*.tsx
```

***REMOVED******REMOVED*** Structure Template
...
***REMOVED******REMOVED*** Database (if applicable)

| Table | Key Fields |
|-------|------------|

***REMOVED******REMOVED*** Modular Docs
...
***REMOVED******REMOVED*** Conditional Rules (Path-Specific)
...
***REMOVED******REMOVED******REMOVED*** Glob Patterns
...
***REMOVED******REMOVED******REMOVED*** Combining Patterns

```yaml
***REMOVED*** Multiple extensions
paths: "src/**/*.{ts,tsx}"

***REMOVED*** Multiple directories
...
***REMOVED******REMOVED*** Workflow: New Project
...
***REMOVED******REMOVED*** Workflow: Refactor Existing
...
***REMOVED******REMOVED*** What Goes Where
...
***REMOVED******REMOVED*** CLAUDE.local.md

Personal project settings (auto-gitignored):

```markdown
***REMOVED*** My Local Settings
