***REMOVED*** Worker Templates v5

Reference templates for tmux-swarm-orchestration. Loaded when building prompts.

***REMOVED******REMOVED*** Feasibility Triage (Phase 1, только для 5+ issues)

    Task(
        description="Triage: issues ***REMOVED***{numbers}",
        prompt="""
...
***REMOVED******REMOVED*** Implementation Worker (Phase 4)
