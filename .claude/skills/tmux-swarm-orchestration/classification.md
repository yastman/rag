...
### Шаг 1: Собрать затронутые файлы (3 системы)
    ...
    # 2. LSP — точные references для ключевых символов:
    ...
    # 3. context-mode — собрать всё в один вызов:
...
### Шаг 2: Найти пересечения
    ...
    # context-mode execute для анализа (output в sandbox):
