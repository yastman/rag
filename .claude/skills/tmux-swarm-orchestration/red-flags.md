***REMOVED*** Красные флаги и чеклист

Самопроверка оркестратора. Перечитай при сомнениях.

***REMOVED******REMOVED*** СТОП — красные флаги
...
***REMOVED******REMOVED*** Рационализации
...
| "Haiku правильно определил вне скоупа" | Haiku не знает скоуп. SKIP только с доказательством (PR***REMOVED***, дубль***REMOVED***). Иначе → DO. |
...
***REMOVED******REMOVED*** Чеклист (перед запуском)
...
***REMOVED******REMOVED*** Чеклист (Фаза 5 — при сигнале)
...
***REMOVED******REMOVED*** Чеклист (Фаза 6 — финальный отчёт)
