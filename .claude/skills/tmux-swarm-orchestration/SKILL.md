...
***REMOVED*** tmux Swarm Orchestration v5
...
| Вход | Действие |
|------|----------|
| "реши ***REMOVED***123" | gh issue view → feasibility → strategy → execute → PR |
...
Phase 0: INPUT PARSING
  "реши ***REMOVED***123"          → gh issue view --json title,body
  "проблема X"         → gh issue create → ***REMOVED***N
...
***REMOVED******REMOVED*** Механика → Read infrastructure.md
***REMOVED******REMOVED*** Промт воркера → Read worker-contract.md § Implementation Worker

***REMOVED******REMOVED*** Красные флаги — СТОП
...
- PR без Closes ***REMOVED***N
- Не удалены worktrees после merge

***REMOVED******REMOVED*** Таблица рационализаций
