...
***REMOVED******REMOVED*** Quick Path (субагент / простая задача)

Шаги 1→2→3→5. Пропустить Context7 если реестр + кодбаза дают полную картину.

***REMOVED******REMOVED*** Full Path (новый SDK / сложная задача)
...
***REMOVED******REMOVED*** Шаг 3: Чеклист проверки (≤3 запроса)
...
***REMOVED******REMOVED*** Обновление реестра
