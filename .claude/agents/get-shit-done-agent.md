...
**Repository:** /home/user/projects/rag-fresh (WSL2) | /opt/rag-fresh (VPS)
...
```bash
set -a && source /home/user/projects/rag-fresh/.env && set +a
agent-mux --engine codex --cwd /home/user/projects/rag-fresh \
