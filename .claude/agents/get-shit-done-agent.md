...
***REMOVED******REMOVED*** Dispatch Methods

***REMOVED******REMOVED******REMOVED*** Primary: tmux-swarm (80% inline, 15% parallel)
...
***REMOVED******REMOVED******REMOVED*** Secondary: agent-mux (5% — autonomous pipeline)
...
***REMOVED******REMOVED******REMOVED*** Inline (80% — coordinator does it)
...
***REMOVED******REMOVED*** Worker Contract (tmux-swarm workers)
...
***REMOVED******REMOVED*** Output Contract
...
***REMOVED******REMOVED*** Context Discipline
