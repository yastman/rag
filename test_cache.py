...
class CacheTester:
    ...
    async def test_embeddings_cache(self) -> bool:
        ...
        try:
            ...
            ***REMOVED*** First request - cache miss
            ...
            ***REMOVED*** Second request - cache hit
    ...
    async def test_semantic_cache(self) -> bool:
        ...
        try:
            ...
            query2 = "Покажи ми жилища в град Пловдив"  ***REMOVED*** Похожий запрос
            answer = "В Пловдив има 5 апартамента: 2-стаен на ул. Цариградско шосе..."

            ***REMOVED*** Store first query-answer
    ...
    async def test_analyzer_cache(self) -> bool:
        ...
        try:
            ...
            ***REMOVED*** Different query - cache miss
    ...
    async def test_search_cache(self) -> bool:
        ...
        try:
            ***REMOVED*** Test embedding
            embedding = [0.1] * 1024  ***REMOVED*** Dummy 1024-dim vector
            filters = {"city": "София"}
            results = [
            ...
            ***REMOVED*** Different filters - cache miss
    ...
    async def run_all_tests(self):
        ...
        ***REMOVED*** Test 1: Redis connection
