***REMOVED*** 📋 RAG System Implementation Plan
...
***REMOVED******REMOVED******REMOVED*** ✅ РЕАЛИЗОВАНО (v2.1.0)

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Инфраструктура
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Retrieval & Search
- ✅ **3 Search Engines**:
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. Ingestion & Chunking
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 5. Evaluation & Quality
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 6. Configuration
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 7. Security & Governance
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 8. Observability
- ✅ **OpenTelemetry** - traces, metrics
- ✅ **Langfuse** - LLM observability
- ✅ **MLflow** - experiment tracking

***REMOVED******REMOVED******REMOVED******REMOVED*** 9. LLM Contextualization
- ✅ **3 Providers**: Claude, OpenAI, Groq
- ✅ **Prompt Caching** - Claude (90% cost reduction)
- ✅ **Token Tracking** - cost estimation

***REMOVED******REMOVED******REMOVED******REMOVED*** 10. Documentation
...
***REMOVED******REMOVED*** ❌ НЕ РЕАЛИЗОВАНО

***REMOVED******REMOVED******REMOVED*** 1. Sparse Vectors / BM25 в Qdrant
...
self.client.create_collection(
    ...
    vectors_config=VectorParams(
        size=VectorDimensions.DENSE,  ***REMOVED*** Только dense!
...
self.client.create_collection(
    ...
    vectors_config={
        ...
        "sparse": SparseVectorParams(
            modifier=Modifier.IDF,  ***REMOVED*** BM25-like scoring
        ),
    },
)
```

***REMOVED******REMOVED******REMOVED*** 2. Hybrid Search (Dense + Sparse RRF)
**Текущее состояние**: `HybridRRFSearchEngine` использует только dense vectors
**Файл**: `src/retrieval/search_engines.py:119-121`

```python
***REMOVED*** Комментарий в коде:
***REMOVED*** RRF fusion: score = sum(1/(rank_dense + rank_sparse + 1))
***REMOVED*** For now, using dense only (sparse search requires separate index)
```

**Нужно**: Реализовать настоящий hybrid search с RRF

***REMOVED******REMOVED******REMOVED*** 3. L1 Cache (In-Memory LRU)
**Текущее состояние**: Только L2 (Redis)
**Нужно**: In-process LRU cache для hot queries

***REMOVED******REMOVED******REMOVED*** 4. Query Expansion
...
***REMOVED******REMOVED******REMOVED*** 5. Specialized Retrieval Tools
**Текущее состояние**: Отсутствуют
**Нужно**: BibleTool-like инструменты для специализированного поиска

***REMOVED******REMOVED******REMOVED*** 6. Hydra Configuration Management
...
***REMOVED******REMOVED******REMOVED*** 7. Rate Limiting Enforcement
...
***REMOVED******REMOVED******REMOVED*** 8. Regression Gates
**Текущее состояние**: Отсутствуют
**Нужно**: Automated gates блокирующие релиз при падении метрик

***REMOVED******REMOVED******REMOVED*** 9. Red-Team Testing
**Текущее состояние**: Отсутствуют
**Нужно**: Security/jailbreak tests для LLM

***REMOVED******REMOVED******REMOVED*** 10. Canary Index Deployment
**Текущее состояние**: Отсутствует
**Нужно**: Blue-green deployment для Qdrant collections

***REMOVED******REMOVED******REMOVED*** 11. Disaster Recovery Playbook
...
***REMOVED******REMOVED******REMOVED*** Phase 1: Hybrid Search (Dense + Sparse) - ПРИОРИТЕТ 1
**Цель**: Включить BM25 через sparse vectors в Qdrant
**Время**: 2-3 дня

***REMOVED******REMOVED******REMOVED******REMOVED*** Task 1.1: Добавить Sparse Vectors в Qdrant Collection
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 1.2: Реализовать Hybrid RRF Search
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 1.3: Integration Tests
...
***REMOVED******REMOVED******REMOVED*** Phase 2: Caching & Performance - ПРИОРИТЕТ 2
**Цель**: L1 cache + optimizations
**Время**: 1-2 дня

***REMOVED******REMOVED******REMOVED******REMOVED*** Task 2.1: L1 In-Memory LRU Cache
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 2.2: Query Expansion
...
***REMOVED******REMOVED******REMOVED*** Phase 3: Configuration Management - ПРИОРИТЕТ 3
**Цель**: Hydra для модульных configs
**Время**: 2-3 дня

***REMOVED******REMOVED******REMOVED******REMOVED*** Task 3.1: Hydra Setup
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 3.2: Environment-Specific Configs
...
***REMOVED******REMOVED******REMOVED*** Phase 4: Rate Limiting & Resilience - ПРИОРИТЕТ 4
**Цель**: Rate limiting + error handling
**Время**: 1-2 дня

***REMOVED******REMOVED******REMOVED******REMOVED*** Task 4.1: Rate Limiting Middleware
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 4.2: Resilience Patterns
...
***REMOVED******REMOVED******REMOVED*** Phase 5: Quality Gates & Regression - ПРИОРИТЕТ 5
**Цель**: Automated regression gates
**Время**: 1-2 дня

***REMOVED******REMOVED******REMOVED******REMOVED*** Task 5.1: Regression Gates
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 5.2: Continuous Evaluation
...
***REMOVED******REMOVED******REMOVED*** Phase 6: Specialized Tools (Optional) - ПРИОРИТЕТ 6
**Цель**: Domain-specific retrieval tools
**Время**: 3-5 дней

***REMOVED******REMOVED******REMOVED******REMOVED*** Task 6.1: ArticleTool
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 6.2: ConceptTool
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 6.3: Tool Orchestration
...
***REMOVED******REMOVED******REMOVED*** Phase 7: Security & Red-Team - ПРИОРИТЕТ 7
**Цель**: Security hardening
**Время**: 2-3 дня

***REMOVED******REMOVED******REMOVED******REMOVED*** Task 7.1: Red-Team Tests
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 7.2: Security Hardening
...
***REMOVED******REMOVED******REMOVED*** Phase 8: Disaster Recovery - ПРИОРИТЕТ 8
**Цель**: DR playbook + automation
**Время**: 1 день

***REMOVED******REMOVED******REMOVED******REMOVED*** Task 8.1: DR Playbook
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 8.2: Automated Backups
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Task 8.3: Canary Deployment
...
***REMOVED******REMOVED******REMOVED*** Retrieval Quality
...
***REMOVED******REMOVED******REMOVED*** RAGAS Quality (на golden set)
- **Faithfulness** ≥ 0.85
- **Context Precision** ≥ 0.80
- **Context Recall** ≥ 0.90
- **Answer Relevancy** ≥ 0.80

***REMOVED******REMOVED******REMOVED*** Availability & Reliability
- **Uptime** ≥ 99.5%
- **Error rate** < 0.1%
...
***REMOVED******REMOVED******REMOVED*** Azbyka Plan Concepts Applied
