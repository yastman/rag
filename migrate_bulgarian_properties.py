...
def migrate_payload(old_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    ***REMOVED*** Map Russian fields to English metadata
    metadata = {
...
def main():
    ...
    ***REMOVED*** Check source collection exists
    try:
    ...
    ***REMOVED*** Create target collection
    ...
    try:
        ...
        ***REMOVED*** Create new collection with same vector config
        client.create_collection(
            collection_name=TARGET_COLLECTION,
            vectors_config=VectorParams(
                size=1024,  ***REMOVED*** Same as source (BGE-M3)
    ...
    ***REMOVED*** Migrate points
    ...
    while True:
        ***REMOVED*** Scroll through source collection
        ...
        ***REMOVED*** Transform points
        ...
        for point in points:
            ...
            new_point = PointStruct(
                id=point.id,  ***REMOVED*** Keep same UUID
                vector=point.vector,  ***REMOVED*** Keep same vector
                payload=new_payload,
            )
    ...
    ***REMOVED*** Show sample from target collection
