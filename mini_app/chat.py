...
async def run_mini_app_query(
    ...
    """
    from telegram_bot.agents.rag_pipeline import rag_pipeline  ***REMOVED*** type: ignore[import-untyped]

    return await rag_pipeline(query=message)  ***REMOVED*** type: ignore[no-any-return]
