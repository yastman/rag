...
- [ ] **1.1 Security: Ротация API ключей** `***REMOVED***security` `***REMOVED***critical`
...
- [ ] **1.2 Performance: Заменить requests на httpx** `***REMOVED***performance` `***REMOVED***critical`
...
- [ ] **1.3 Dependencies: Создать полный requirements.txt** `***REMOVED***dependencies` `***REMOVED***critical`
...
- [ ] **1.4 Performance: Исправить blocking calls в pipeline.py** `***REMOVED***performance` `***REMOVED***critical`
